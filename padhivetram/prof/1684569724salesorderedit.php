...
<td style="width:8%"><input type="number" name="qty[]" id="qty<?=$i?>" class="form-control" min="0" onchange="productcalc(<?=$i?>)" style="text-align:right" value="<?=$row['qty']?>"></td>
...
{
?>
<a href="#" class="pop"><embed src="<?php echo $rowselect[0]['attachments']?>" width="200px" height="200px" /></a>
<?php
}
?>
</div>
