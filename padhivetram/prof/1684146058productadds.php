...
if(isset($_POST['submit']))
{
	...
	{		
		...
		{	
			...
			$sqlup = "INSERT INTO jrcproduct( type,sku,code,unit,hsncode,taxpreference,gstpercentage, gst, exemption,stockmaincategory, stocksubcategory, stockitem, typeofproduct, componenttype, componentname, make, capacity, igstpercentage) VALUES ( '$typevalue', '$sku','$code', '$unit', '$hsncode', '$taxpreference', '$gstpercentage', '$gst', '$exemption','$stockmaincategoryvalue', '$stocksubcategoryvalue', '$stockitemvalue', '$typeofproductvalue', '$componenttypevalue', '$componentnamevalue', '$makevalue', '$capacityvalue', '$igstpercentage')";
