 ...
 $sqlserial = "SELECT location  From jrcserials where sourceid='".$rowselect['sourceid']."' order by id asc";
		...
		<?php 
					  ...
					  else
					 {
					  ...
					  <td align="center" width="50%" rowspan="2" class="heading" style="font-size:24px;"><strong>SERVICE CALL REPORT</strong></td>
					  ...
					  {
						?> 
					  <th style="width:80px"><strong>SERVICE TYPE</strong></th>
					  <td align="left" style="width:80px;text-transform: uppercase;" class="font-weight-bold text-primary"><?=$rowselect['servicetype']?></td>
					  <?php 
					  }
					  if(($infolayoutcall['customernature']=='1'))
					  {
						?> 
						<th style="width:80px"><strong>CUSTOMER NATURE</strong></th>
						<td align="left" style="width:80px;text-transform: uppercase;" class="font-weight-bold text-primary"><?=$rowselect['customernature']?></td>
					  <?php 
					  }
					  ?>
					  <?php 
					  ...
					  {
					  ?>
					  <th style="width:80px"><strong>CALL TYPE</strong></th>
					  <td align="left" style="width:80px;text-transform: uppercase;" class="font-weight-bold text-primary"><?=$rowselect['calltype']?></td> 
					  <?php
					  }
					  ?>
					  <?php 
					  ...
					  {
					  ?>
					  <th style="width:80px"><strong>CALL NATURE</strong></th>
					  <td align="left" style="width:80px;text-transform: uppercase;" class="font-weight-bold text-primary"><?=$rowselect['callnature']?></td>
					  <?php 
					  }
					  ?>
					  </tr>
					  ...
					  <tr>
					  <td align="left" colspan="6"><strong>Product Name -</strong> 
					  <?php 
					  ...
					  {
					  ?> 
					  <td width="15%"><strong>Battery Make</strong></td><td width="15%"><?=$infocon4['batterymake']?></td>
					  <?php 
					  $pi++;
					  if(($pi%3)==0)
					  {
					  ...
					  {
					  ?> 
					  <td width="15%"><strong>Battery AH</strong></td><td width="15%"><?=$infocon4['batteryah']?></td>
					  <?php 
					  $pi++;
					  if(($pi%3)==0)
					  {
					  ...
					  {
					  ?> 
					  <td width="15%"><strong>No.of Battery</strong></td><td width="15%"><?=$infocon4['noofbattery']?></td>
					  <?php 
					  $pi++;
					  if(($pi%3)==0)
					  {
					  ...
					  {
					  ?> 
					  <td width="15%"><strong>No.of Set</strong></td><td width="15%"><?=$infocon4['noofset']?></td>
					  <?php 
					  $pi++;
					  if(($pi%3)==0)
					  {
		...
		?>
					 ...
					 /*  if($infocon4['signature']!='')
					  ...
					  for($i=1;$i<=5;$i++)
					  {
						  ...
						  if($material!='')
						  {
							  $sqlspares = "SELECT id, maincategory, subcategory,spareunit  From jrcspares where id='".$material."'";
			...
			$rowspares = mysqli_fetch_array($queryspares)
					  ...
					  <td style="text-align:center; vertical-align:top;"><?=$infocon4['squantity'.$i]?>&nbsp; <?=$rowspares['spareunit']?></td>
