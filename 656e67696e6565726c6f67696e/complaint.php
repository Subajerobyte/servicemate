...
<body id="page-top" onload="customerchange();executeFunctions();">
<div id="wrapper">
...
<h1 class="h4 mb-0 text-gray-800">Call Details</h1>
</div>
<div class="row">
<div class="col-lg-12">
<?php
...
?>
<div class="col-lg-12 col-12 mb-4 items">
...
?>
<?php
if($rowselect['serial']=='Not Available')
{
	$sqlser=mysqli_query($connection,"select upsserial from jrcserials where sourceid='".$rowselect['sourceid']."'");
	$result=mysqli_fetch_array($sqlser);
	if($result['upsserial']!='')
	{
	 $serial=$result['upsserial'];
	}
	else
		
		{
			 $serial=$rowselect['serial'];
...
?> 
<br><b><?=$serial?><?=($rowserial['location']!='')?'-'.$rowserial['location']:''?></b></p>
<hr>
...
?>
<form action="complaintadds.php"  id="myForm" method="post" enctype="multipart/form-data" onsubmit="return checkvalidate()">
...
<div class="row mb-1">
<div class="col-6">
<label for="worktype" class="col-form-label">Work Nature<span class="text-danger"> *</span></label>
</div>
<div class="col-6">
...
<h5 class="mb-2"><label for="problemobserved">Problem Observed <span class="text-danger"> *</span><span href="#" data-toggle="modal" data-target="#problemobservedmodal">&nbsp;<i class="fa fa-plus text-primary"></i> </span></label></h5>
...
<div class="row mb-1">
<div class="col-6">
<label for="stockitem" class="col-form-label">Product Name</label>
</div>
<div class="col-6">
...
{
?>
<option value="<?=$rowrep['stockitem']?>" <?=($rowxl['stockitem']==$rowrep['stockitem'])?"selected":(($infocon4['stockitem']==$rowrep['stockitem'])?"selected":"")?>><?=$rowrep['stockitem']?></option>
<?php
}
}
?>
...
<div class="row mb-1">
<div class="col-6">
<label for="capacity" class="col-form-label">Capacity / DC V</label>
</div>
<div class="col-6">
...
<div class="row mb-1">
<div class="col-6">
<label for="mfgcode" class="col-form-label">MFG Code</label>
</div>
<div class="col-6">
...
<div class="row mb-1">
<div class="col-6">
<label for="pvmake" class="col-form-label">PV Panel Make</label>
</div>
<div class="col-6">
...
<div class="row mb-1">
<div class="col-6">
<label for="pvtype" class="col-form-label">PV Panel Type</label>
</div>
<div class="col-6">
...
<div class="row mb-1">
<div class="col-6">
<label for="pvcapacity" class="col-form-label">PV Panel Capacity</label>
</div>
<div class="col-6">
...
<div class="row mb-1">
<div class="col-6">
<label for="pvqty" class="col-form-label">PV Panel Qty</label>
</div>
<div class="col-6">
...
<div class="row mb-1">
<div class="col-6">
<label for="pvslno" class="col-form-label">PV Panel SL No</label>
</div>
<div class="col-6">
...
<div class="row mb-1">
<div class="col-6">
<label for="ntmake" class="col-form-label">Net Meter Make</label>
</div>
<div class="col-6">
...
<div class="row mb-1">
<div class="col-6">
<label for="nttype" class="col-form-label">Net Meter Type</label>
</div>
<div class="col-6">
...
<div class="row mb-1">
<div class="col-6">
<label for="ntqty" class="col-form-label">Net Meter Qty</label>
</div>
<div class="col-6">
...
<div class="row mb-1">
<div class="col-6">
<label for="ntslno" class="col-form-label">Net Meter SL No</label>
</div>
<div class="col-6">
...
<div class="row">
<div class="col-6">
<label for="voliry" class="col-form-label">Shadow Free Area</label>
</div>
...
<div class="row mb-1">
<div class="col-6">
<label for="noofplstr" class="col-form-label">No of Panel in String</label>
</div>
<div class="col-6">
...
<div class="row mb-1">
<div class="col-6">
<label for="noofstr" class="col-form-label">No of Strings</label>
</div>
<div class="col-6">
...
<div class="row mb-1">
<div class="col-6">
<label for="tilt" class="col-form-label">Tilt Angle</label>
</div>
<div class="col-6">
...
<div class="row mb-1">
<div class="col-6">
<label for="plposter" class="col-form-label">Panel Position</label>
</div>
<div class="col-6">
...
<div class="row">
<div class="col-6">
<label for="voliry" class="col-form-label">Civil Structure</label>
</div>
<div class="col-6 mt-2">
...
<div class="row">
<div class="col-6">
<label for="voliry" class="col-form-label">Mechanical Structure</label>
</div>
<div class="col-6 mt-2">
...
<div class="row">
<div class="col-6">
<label for="voliry" class="col-form-label">Electrical Wiring</label>
</div>
<div class="col-6 mt-2">
...
<div class="row">
<div class="col-6">
<label for="voliry" class="col-form-label">AC Earthing</label>
</div>
<div class="col-6 mt-2">
...
<div class="row">
<div class="col-6">
<label for="voliry" class="col-form-label">DC Earthing</label>
</div>
<div class="col-6 mt-2">
...
<div class="row">
<div class="col-6">
<label for="voliry" class="col-form-label">LA Earthing</label>
</div>
<div class="col-6 mt-2">
...
<div class="row mb-1">
<div class="col-6">
<label for="spvvol" class="col-form-label">SPV Charging Voltage</label>
</div>
<div class="col-6">
...
<div class="row mb-1">
<div class="col-6">
<label for="spvcur" class="col-form-label">SPV Charging Current</label>
</div>
<div class="col-6">
...
<div class="row mb-1">
<div class="col-6">
<label for="plvoc" class="col-form-label">Panel VOC (String)</label>
</div>
<div class="col-6">
...
<div class="row mb-1">
<div class="col-6">
<label for="plcell" class="col-form-label">Panel Cells</label>
</div>
<div class="col-6">
...
<div class="row mb-1">
<div class="col-6">
<label for="plseries" class="col-form-label">Panel String in Series</label>
</div>
<div class="col-6">
...
<div class="row mb-1">
<div class="col-6">
<label for="plparallel" class="col-form-label">Panel String in Parallel</label>
</div>
<div class="col-6">
...
<div class="row mb-1">
<div class="col-6">
<label for="plvol" class="col-form-label">Panel Voltage at SPV Chg. ON</label>
</div>
<div class="col-6">
...
<div class="row mb-1">
<div class="col-6">
<label for="plpower" class="col-form-label">Panel Power</label>
</div>
<div class="col-6">
...
<div class="row mb-1">
<div class="col-6">
<label for="pltime" class="col-form-label">Time</label>
</div>
<div class="col-6">
...
<div class="row mb-1">
<div class="col-6">
<label for="avgloadnight" class="col-form-label">Average Load (night)</label>
</div>
<div class="col-6">
...
<div class="row mb-1">
<div class="col-6">
<label for="avgloadday" class="col-form-label">Average Load (day)</label>
</div>
<div class="col-6">
...
<div class="row mb-1">
<div class="col-6">
<label for="totalload" class="col-form-label">Total Load</label>
</div>
<div class="col-6">
...
<div class="row">
<div class="col-6">
<label for="voliry" class="col-form-label">Input Supply</label>
</div>
<div class="col-6 mt-2">
...
<div class="row">
<div class="col-6">
<label for="voliry" class="col-form-label">Dust Free</label>
</div>
<div class="col-6 mt-2">
...
<div class="row">
<div class="col-6">
<label for="voliry" class="col-form-label">Earthing</label>
</div>
<div class="col-6 mt-2">
...
<div class="row">
<div class="col-6">
<label for="voliry" class="col-form-label">UPS Availability</label>
</div>
<div class="col-6 mt-2">
...
<div class="row">
<div class="col-6">
<label for="voliry" class="col-form-label">Air Conditioned</label>
</div>
<div class="col-6 mt-2">
...
<div class="row mb-1">
<div class="col-6">
<label for="inputvoltage" class="col-form-label">Input Voltage</label>
</div>
<div class="col-6">
...
<div class="row mb-1">
<div class="col-6">
<label for="earthleakage" class="col-form-label">Earth Leakage</label>
</div>
<div class="col-6">
...
<div class="row">
<div class="col-6">
<label for="voliry" class="col-form-label">Cleaning</label>
</div>
<div class="col-6 mt-2">
...
<div class="row">
<div class="col-6">
<label for="voliry" class="col-form-label">Software Check</label>
</div>
<div class="col-6 mt-2">
...
<div class="row">
<div class="col-6">
<label for="voliry" class="col-form-label">Antivirus Check</label>
</div>
<div class="col-6 mt-2">
...
<div class="row">
<div class="col-6">
<label for="voliry" class="col-form-label">Loose Connection</label>
</div>
<div class="col-6 mt-2">
...
<div class="row">
<div class="col-6">
<label for="voliry" class="col-form-label">Speed Check</label>
</div>
<div class="col-6 mt-2">
...
<div class="row">
<div class="col-6">
<label for="voliry" class="col-form-label">Temp File Cleaning</label>
</div>
<div class="col-6 mt-2">
...
<div class="row">
<div class="col-6">
<label for="voliry" class="col-form-label">Hardward Check</label>
</div>
<div class="col-6 mt-2">
...
<div class="row">
<div class="col-6">
<label for="voliry" class="col-form-label">Print Check</label>
</div>
<div class="col-6 mt-2">
...
<div class="row">
<div class="col-6">
<label for="voliry" class="col-form-label">Keyboard</label>
</div>
<div class="col-6 mt-2">
...
<div class="row">
<div class="col-6">
<label for="voliry" class="col-form-label">Mouse</label>
</div>
<div class="col-6 mt-2">
...
<div class="row mb-1">
<div class="col-6">
<label for="batterymake" class="col-form-label">Battery Make</label>
</div>
<div class="col-6">
...
<div class="row mb-1">
<div class="col-6">
<label for="batteryah" class="col-form-label">Battery AH</label>
</div>
<div class="col-6">
...
<div class="row mb-1">
<div class="col-6">
<label for="noofbattery" class="col-form-label">No. of Battery</label>
</div>
<div class="col-6">
...
<div class="row mb-1">
<div class="col-6">
<label for="noofset" class="col-form-label">No. of Set</label>
</div>
<div class="col-6">
...
<div class="row">
<div class="col-4">
<label for="verification" class="col-form-label">Ventilation</label>
</div>
...
<div class="row">
<div class="col-4">
<label for="directsunlight" class="col-form-label">Direct Sunlight</label>
</div>
<div class="col-8 mt-2">
...
<div class="row">
<div class="col-4">
<label for="wiringready" class="col-form-label">Wiring Ready</label>
</div>
<div class="col-8 mt-2">
...
<div class="row">
<div class="col-4">
<label for="modificationwiring" class="col-form-label">Modification on Wiring / Load</label>
</div>
<div class="col-8 mt-2">
...
<div class="row">
<div class="col-4">
<label for="waterdripping" class="col-form-label">Rain/Cleaning Water Dripping</label>
</div>
<div class="col-8 mt-2">
...
<div class="row">
<div class="col-4">
<label for="coastelarea" class="col-form-label">Coastal Area</label>
</div>
<div class="col-8 mt-2">
...
<div class="row">
<div class="col-4">
<label for="pollutionlevel" class="col-form-label">Pollution Level</label>
</div>
<div class="col-8 mt-2">
...
<div class="row">
<div class="col-4">
<label for="moisture" class="col-form-label">Moisture</label>
</div>
<div class="col-8 mt-2">
...
<div class="row">
<div class="col-4">
<label for="voliry" class="col-form-label">Stabilizer</label>
</div>
<div class="col-8 mt-2">
...
<div class="row">
<div class="col-4">
<label for="voliry" class="col-form-label">Phase Reverse</label>
</div>
<div class="col-8 mt-2">
...
<div class="row">
<div class="col-4">
<label for="voliry" class="col-form-label">Overload</label>
</div>
<div class="col-8 mt-2">
...
?>
<div class="form-group">
<h5 class="mb-2"><label for="batterycondition">Battery Condition</label></h5>
...
<div class="col-6">
   ...
   <div class="input-group">
            ...
            <!--div class="input-group-append">
                <span  class="input-group-text" style="height: 1.75rem;"></span>
            </div-->
     </div>
    </div>
  </div>
...
?>
<div class="form-group">
<h5 class="mb-2"><label for="actiontaken">Action Taken <span class="text-danger"> *</span><span href="#" data-toggle="modal" data-target="#actiontakenmodal">&nbsp;<i class="fa fa-plus text-primary"></i> </span></label></h5>
...
?>
<div class="form-group">
<h5 class="mb-2"><label for="gstno">GST No</label></h5>
...
{
?>
<input type="hidden" name="gstno" id="gstno" value="<?=($rowcon4>0)?$infocon4['gstno']:''?>">
<?php
}
...
?>
<div class="form-group">
<h5 class="mb-2"><label for="email">Email ID</label></h5>
...
{
?>
<input type="hidden" name="email" id="email" value="<?=($rowcon4>0)?$infocon4['email']:''?>">
<?php
}
 ...
 <div class="table-responsive">
                <table class="table table-bordered font-13" id="dataTable" width="100%" cellspacing="0">
				  ...
				  <tr>
                    ...
                    <td><?=$i?></td>
                    <td><select class="form-control fav_clr" id="smaterial<?=$i?>" name="smaterial<?=$i?>" onChange="getpromat(<?=$i?>)">
	<option value="">Select</option>
	<?php
	...
	<?php
			...
			?>
                    ...
                    <td><input type="number" min="0" class="form-control" name="sprice<?=$i?>" id="sprice<?=$i?>" value="<?=($rowcon4>0)?$infocon4['sprice'.$i]:''?>"  step="0.01" onChange="executeFunctions()" readonly></td>
					
                    <td> <input type="number" min="0" class="form-control" name="squantity<?=$i?>" id="squantity<?=$i?>" value="<?=($rowcon4>0)?$infocon4['squantity'.$i]:''?>" onChange="executeFunctions()" ></td>
					
                    <td><input type="number" min="0" class="form-control" name="stotal<?=$i?>" id="stotal<?=$i?>" value="<?=($rowcon4>0)?$infocon4['stotal'.$i]:''?>"   readonly  onChange="executeFunctions()" step="0.01"></td>
					
                    <td><input type="number" min="0" class="form-control" name="sgstper<?=$i?>" id="sgstper<?=$i?>" readonly value="<?=($rowcon4>0)?$infocon4['sgstper'.$i]:''?>"  onChange="executeFunctions()"  step="0.01">
					
					</td>
                    <td><input type="number" min="0" class="form-control" name="sgstpervalue<?=$i?>" id="sgstpervalue<?=$i?>" readonly value="<?=($rowcon4>0)?$infocon4['sgstpervalue'.$i]:''?>"  onChange="executeFunctions()"  step="0.01" >
					</td>
                    <td><input type="number" min="0" class="form-control" name="schargepre<?=$i?>" id="schargepre<?=$i?>" value="<?=($rowcon4>0)?$infocon4['schargepre'.$i]:''?>"  onChange="executeFunctions()"  readonly step="0.01"></td>
  ...
  <!-- spares div ended-->
   ...
   <div class="row mb-1">
    ...
    <div class="col-6">
      <input type="number" min="0" class="form-control" name="mchargescharge" id="mchargescharge" value="<?=($rowcon4>0)?$infocon4['mchargescharge']:''?>"  step="0.01" readonly onChange="netamt()">
    </div>
  </div> 
<div class="row mb-1">
     <div class="col-6">
	...
	<div class="col-6">
	<input type="number" min="0" class="form-control" name="mchargegstvalue" id="mchargegstvalue" readonly value="<?=($rowcon4>0)?$infocon4['mchargegstvalue']:''?>"   step="0.01" onChange="netamt()">
    </div>
 </div>   
   <div class="row mb-1">
     <div class="col-6">
    ...
    <div class="col-6">
      <input type="number" min="0" class="form-control" name="schargematerial" id="schargematerial" readonly value="<?=($rowcon4>0)?$infocon4['schargematerial']:''?>"  step="0.01" onChange="netamt()">
    </div>
  </div> 
  <hr>
   <div class="row mb-1">
     <div class="col-6">
      <label for="schargescharge" class="col-form-label">Service / AMC Charges</label>
    </div>
    <div class="col-6">
      <input type="number" min="0" class="form-control" name="schargescharge" id="schargescharge" value="<?=($rowcon4>0)?$infocon4['schargescharge']:''?>"   step="0.01" onChange="totalcalc()">
    </div>
  </div> 
<div class="row mb-1">
     <div class="col-2">
	...
	<div class="col-4">
	<input type="number" min="0" class="form-control" name="schargegst" id="schargegst" readonly value="<?=($rowcon4>0)?'18':'18'?>"  step="0.01" onChange="totalcalc()">
	
    </div>
    <div class="col-6">
      <input type="number" min="0" class="form-control" name="schargegstvalue" id="schargegstvalue" readonly value="<?=($rowcon4>0)?$infocon4['schargegstvalue']:''?>"   step="0.01" onChange="totalcalc()">
    </div>
 </div>   
   <div class="row mb-1">
     <div class="col-6">
    ...
    <div class="col-6">
      <input type="number" min="0" class="form-control" name="sercharge" id="sercharge" readonly value="<?=($rowcon4>0)?$infocon4['sercharge']:''?>" step="0.01" onChange="netamt()">
    </div>
  </div> 
  <hr>
   <div class="row mb-1">
    ...
    <div class="col-6">
      <input type="number" min="0" class="form-control" name="schargepre" id="schargepre" value="<?=($rowcon4>0)?$infocon4['schargepre']:''?>"  step="0.01" readonly onChange="netamt()">
    </div>
  </div> 
<div class="row mb-1">
     <div class="col-6">
	...
	<div class="col-6">
	<input type="number" min="0" class="form-control" name="sgstamt" id="sgstamt" readonly value="<?=($rowcon4>0)?$infocon4['sgstamt']:''?>"   step="0.01" onChange="netamt()">
    </div>
 </div>   
   <div class="row mb-1">
     <div class="col-6">
    ...
    <div class="col-6">
      <input type="number" min="0" class="form-control" name="scharge" id="scharge" readonly value="<?=($rowcon4>0)?$infocon4['scharge']:''?>"  step="0.01" onChange="netamt()">
    </div>
  </div> 
<hr>
<?php
...
?>
<div class="form-group">
<h5 class="mb-2"><label for="engineerreport">Engineer's Report <span class="text-danger"> *</span></label></h5>
...
?>
<div class="form-group">
<h5 class="mb-2"><label for="customerfeedback">Customer's Feedback <span class="text-danger"> *</span></label></h5>
...
?>
<div class="form-group">
<h5 class="mb-2"><label for="engapproach">Engineer's Approach <span class="text-danger"> *</span></label></h5>
...
<div class="row mb-1">
<div class="col-12">
<h5 class="mb-2"><label for="customerfeedback1">Manual Service Call Report</label></h5>
<div id="mulitplefileuploadermanual">Capture Manual Service Call Report</div>
...
?>
<div class="form-group">
<h5 class="mb-2"><label for="callstatus">Call Status <span class="text-danger"> *</span></label></h5>
...
?>
<button id="submit-button" onclick="validateFormAndSubmit()" type="submit" name="submit" value="Submit" class="btn btn-primary">SUBMIT</button>
</form>
</div>
</div>
</div>
...
$("#sparesrequired2").trigger("change");
 ...
 <script>
 //alert for the estimate to incgst or excgst .
 var incgstValue = document.getElementById("oldincgst").value;
	//console.log(incgstValue);
	var previousValue = incgstValue;
$('input[name=incgst]').mouseup(function(){
    previousValue = $('input[name=incgst]:checked').val();
}).change(function(){
    var newValue = $('input[name=incgst]:checked').val();
    if ((previousValue == 2 && newValue == 0) ) {
        alert("Click again Included GST");
    }
	else if ((previousValue == 2 && newValue == 1) ) {
        alert("Click again Excluded GST");
    }
	else
	{
	}
 ...
 { 
	//alert("The type of GST has now been changed.");
		  getpro(1);
		  getpro(2);
		  getpro(3);
		  getpro(4);
...
console.log(parseFloat(dataarray[2]));
getpro(id);
spriceIn(id);
});
}
...
function getpro(id)
{
	if(document.getElementById("smaterial"+id).value!='')
	{
	
if ($("#excgst").is(":checked")) 
{
var smaterial1=$("#smaterial"+id).val();
$.get("sparessearch.php", {smaterial1: smaterial1} , function(data){
var dataarray=data.split("|");
...
var stotal = $("#stotal"+id).val();//price*qty
...
else if ($("#incgst").is(":checked")) 
{

var sprice = document.getElementById("sprice"+id).value;
var squantity = document.getElementById("squantity"+id).value;
document.getElementById("schargepre"+id).value =((parseFloat(squantity)*parseFloat(sprice)).toFixed(2));		
getpromat(id);
var sprice = $("#sprice"+id).val();
var squantity = $("#squantity"+id).val();
var stotal = $("#stotal"+id).val();//price*qty
...
var iNetPrice = (100/(100+igstperv))*ipreamoutv;
var iGSTAmount =ipreamoutv-iNetPrice;
/* var iNetPrice = (ipreamoutv/(100+igstperv))*ipreamoutv;
var iGSTAmount =ipreamoutv-iNetPrice; */
$("#stotal"+id).val(iNetPrice.toFixed(2));
$("#sgstpervalue"+id).val(iGSTAmount.toFixed(2));
//$("#schargepre").val(iNetPrice.toFixed(2));
}
else if ($("#nogst").is(":checked")) 
{
var sprice = document.getElementById("sprice"+id).value;
var squantity = document.getElementById("squantity"+id).value;
document.getElementById("stotal"+id).value =((parseFloat(squantity)*parseFloat(sprice)).toFixed(2));	
...
{
	document.getElementById("smaterial"+id).value=0;
}
}
...
document.getElementById("mchargescharge").value=stot.toFixed(2);
document.getElementById("mchargegstvalue").value=sgstper.toFixed(2);
...
document.getElementById("schargepre").value =(parseFloat(mchargescharge)+parseFloat(schargescharge)).toFixed(2);
...
$("#schargegst").val(18);
var schargepreval=parseFloat(schargescharge);
var original=$("#schargescharge").val();
var ipreamoutv=parseFloat(original);
var igstperv=parseFloat(schargegst);
var iNetPrice = (100/(100+igstperv))*ipreamoutv;
var iGSTAmount =ipreamoutv-iNetPrice;
$("#sercharge").val(schargepreval.toFixed(2));
...
$(".fav_clr").trigger("change");
  ...
  D:\xampp\htdocs\jobwork\404.php (4 hits)