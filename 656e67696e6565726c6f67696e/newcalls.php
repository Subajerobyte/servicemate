...
$infolayoutenginvoicequery=mysqli_query($connection,"select * from jrclayoutenginvoice");
$infolayoutenginvoice=mysqli_fetch_array($infolayoutenginvoicequery);
...
<div class="card-body">
<form action="newcalladds.php" method="post">
<input type="hidden" name="consigneeid" id="consigneeid">
<div class="row">
<?php
if($infolayoutenginvoice['invoiceno']=='1')
{
?>
<div class="col-lg-3">
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="invoiceno" name="invoiceno" <?=($infolayoutenginvoice['invoicenoreq']=='1')?'required':''?>>
  </div>
</div>
<?php
}
...
if($infolayoutenginvoice['invoicedate']=='1')
{
?>
<div class="col-lg-3">
    <div class="form-group">
    <label for="invoicedate">Invoice Date</label>
	<input type="date" class="form-control" id="invoicedate" name="invoicedate" <?=($infolayoutenginvoice['invoicedatereq']=='1')?'required':''?>>
  </div>
  </div>
<?php
}
...
if($infolayoutenginvoice['tenderno']=='1')
{
?>	
<div class="col-lg-3">
  <div class="form-group">
    <label for="tenderno">Tender No</label>
    <input type="text" class="form-control" id="tenderno" name="tenderno" <?=($infolayoutenginvoice['tendernoreq']=='1')?'required':''?>>
  </div>
</div>
<?php
}
...
if($infolayoutenginvoice['pono']=='1')
{
?>
<div class="col-lg-3">
    <div class="form-group">
    <label for="pono">PO No</label>
    <input type="text" class="form-control" id="pono" name="pono" <?=($infolayoutenginvoice['ponoreq']=='1')?'required':''?>>
  </div>
  </div>
 <?php
}
...
if($infolayoutenginvoice['podate']=='1')
{
?> 
  <div class="col-lg-3">
    <div class="form-group">
    <label for="podate">PO Date</label>
    <input type="date" class="form-control" id="podate" name="podate" <?=($infolayoutenginvoice['podatereq']=='1')?'required':''?>>
  </div>
  </div>
<?php
}
...
if($infolayoutenginvoice['dcno']=='1')
{
?>
<div class="col-lg-3">
  <div class="form-group">
    <label for="dcno">DC No</label>
    <input type="text" class="form-control" id="dcno" name="dcno" <?=($infolayoutenginvoice['dcnoreq']=='1')?'required':''?>>
  </div>
</div>
<?php
}
...
if($infolayoutenginvoice['dcdate']=='1')
{
?>
<div class="col-lg-3">
    <div class="form-group">
    <label for="dcdate">DC Date</label>
	<input type="date" class="form-control" id="dcdate" name="dcdate" <?=($infolayoutenginvoice['dcdatereq']=='1')?'required':''?>>
  </div>
  </div>
<?php
}
...
if($infolayoutenginvoice['installedon']=='1')
{
?>
<div class="col-lg-3">
  <div class="form-group">
    <label for="installedon">Installed on</label>
    <input type="date" class="form-control" id="installedon" name="installedon" <?=($infolayoutenginvoice['installedonreq']=='1')?'required':''?>>
  </div>
</div>
<?php
}
...
if($infolayoutenginvoice['installedby']=='1')
{
?>
<div class="col-lg-3">
    <div class="form-group">
    <label for="installedby">Installed by</label>
    <input type="text" class="form-control" id="installedby" name="installedby" <?=($infolayoutenginvoice['installedbyreq']=='1')?'required':''?>>
  </div>
  </div>
<?php
}
...
if($infolayoutenginvoice['maincategory']=='1')
{
...
<div class="col-lg-3">
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="maincategory" name="maincategory" <?=($infolayoutenginvoice['maincategoryreq']=='1')?'required':''?>>
  </div>
</div>
<?php
}
...
if($infolayoutenginvoice['subcategory']=='1')
{
?>
<div class="col-lg-3">
    <div class="form-group">
    <label for="subcategory">Sub Category</label>
    <input type="text" class="form-control" id="subcategory" name="subcategory" <?=($infolayoutenginvoice['subcategoryreq']=='1')?'required':''?>>
  </div>
  </div>
<?php
}
...
if($infolayoutenginvoice['consigneename']=='1')
{
?>
<div class="col-lg-12">
      <div class="form-group">
    <label for="consigneename">Customer Name</label>
    <input type="text" class="form-control" id="consigneename" name="consigneename"  <?=($infolayoutenginvoice['consigneenamereq']=='1')?'required':''?>>
  </div>
  </div>
<?php
}
...
if($infolayoutenginvoice['department']=='1')
{
?>
<div class="col-lg-3">
  <div class="form-group">
    <label for="department">Department</label>
    <input type="text" class="form-control" id="department" name="department" <?=($infolayoutenginvoice['departmentreq']=='1')?'required':''?>>
  </div>
   </div>
<?php
}
...
if($infolayoutenginvoice['address1']=='1')
{
?>
<div class="col-lg-3">
      <div class="form-group">
    <label for="address1">Address 1</label>
    <input type="text" class="form-control" id="address1" name="address1" <?=($infolayoutenginvoice['address1req']=='1')?'required':''?>>
  </div>
  </div>
<?php
}
...
if($infolayoutenginvoice['address2']=='1')
{
?>
<div class="col-lg-3">
  <div class="form-group">
    <label for="address2">Address 2</label>
   <input type="text" class="form-control" id="address2" name="address2" <?=($infolayoutenginvoice['address2req']=='1')?'required':''?>>
  </div>
   </div>
<?php
}
...
if($infolayoutenginvoice['area']=='1')
{
?>
<div class="col-lg-3">
      <div class="form-group">
    <label for="area">Area</label>
    <input type="text" class="form-control" id="area" name="area" <?=($infolayoutenginvoice['areareq']=='1')?'required':''?>>
  </div>
  </div>
<?php
}
...
if($infolayoutenginvoice['district']=='1')
{
?>
<div class="col-lg-3">
  <div class="form-group">
    <label for="district">District</label>
    <input type="text" class="form-control" id="district" name="district" <?=($infolayoutenginvoice['districtreq']=='1')?'required':''?>>
  </div>
   </div>
<?php
}
...
if($infolayoutenginvoice['pincode']=='1')
{
?>
<div class="col-lg-3">
      <div class="form-group">
    <label for="pincode">Pincode</label>
    <input type="text" class="form-control" id="pincode" name="pincode" maxlength="6"  <?=($infolayoutenginvoice['pincodereq']=='1')?'required':''?>>
  </div>
  </div>
<?php
}
...
if($infolayoutenginvoice['contact']=='1')
{
?>
<div class="col-lg-3">
  <div class="form-group">
    <label for="contact">Contact Person</label>
    <input type="text" class="form-control" id="contact" name="contact" <?=($infolayoutenginvoice['contactreq']=='1')?'required':''?>>
  </div>
   </div>
<?php
}
...
if($infolayoutenginvoice['phone']=='1')
{
?>
<div class="col-lg-3">
      <div class="form-group">
    <label for="phone">Phone No</label>
    <input type="text" class="form-control" id="phone" name="phone" maxlength="11" <?=($infolayoutenginvoice['phonereq']=='1')?'required':''?>>
  </div>
  </div>
<?php
}
...
if($infolayoutenginvoice['mobile']=='1')
{
?>
<div class="col-lg-3">
  <div class="form-group">
    <label for="mobile">Mobile No</label>
    <input type="text" class="form-control" id="mobile" name="mobile" required maxlength="10" <?=($infolayoutenginvoice['mobilereq']=='1')?'required':''?>>
  </div>
   </div>
 <?php
}
...
if($infolayoutenginvoice['email']=='1')
{
?> 
<div class="col-lg-3">
  <div class="form-group">
    <label for="email">Email</label>
    <input type="email" class="form-control" id="email" name="email" <?=($infolayoutenginvoice['emailreq']=='1')?'required':''?>>
  </div>
   </div>
<?php
}
...
if($infolayoutenginvoice['invoicedqty']=='1')
{
?>
<div class="col-lg-3">
  <div class="form-group">
    <label for="invoicedqty">Invoiced Qty</label>
    <input type="text" class="form-control" id="invoicedqty" name="invoicedqty" <?=($infolayoutenginvoice['invoicedqtyreq']=='1')?'required':''?>>
  </div>
   </div>
 <?php
}
...
if($infolayoutenginvoice['overallwarranty']=='1')
{
?> 
<div class="col-lg-3">
  <div class="form-group">
    <label for="overallwarranty">Overall Warranty</label>
    <input type="text" class="form-control" id="overallwarranty" name="overallwarranty" <?=($infolayoutenginvoice['overallwarrantyreq']=='1')?'required':''?>>
  </div>
   </div>
   <?php
}
...
<?php
$cco=0;
if($infolayoutenginvoice['stockmaincategory']=='1')
{
?>	
					  <th>Main Category</th>
<?php
...
if($infolayoutenginvoice['stocksubcategory']=='1')
{
?>					  
					  <th>Sub Category</th>
<?php
...
if($infolayoutenginvoice['stockitem']=='1')
{
?>						  
                      <th>Product Name</th>
<?php
...
if($infolayoutenginvoice['typeofproduct']=='1')
{
?>	
...
if($infolayoutenginvoice['componenttype']=='1')
{
?>
...
if($infolayoutenginvoice['componentname']=='1')
{
?>
...
if($infolayoutenginvoice['make']=='1')
{
?>					  
                      <th>Make</th>
<?php
...
if($infolayoutenginvoice['capacity']=='1')
{
?>
					  <th>Capacity</th>
<?php
...
if($infolayoutenginvoice['warranty']=='1')
{
?>
					  <th>Warranty</th>
<?php
...
if($infolayoutenginvoice['serialnumber']=='1')
{
?>
					  <th>Serial Number</th>
<?php
...
if($infolayoutenginvoice['stockmaincategory']=='1')
{
	if($infolayoutenginvoice['proinput']=='1')
	{
?>					
 					  <td style="width:<?=$cco/100?>%">
					  <select class="fav_clr form-control" name="stockmaincategory[]" id="stockmaincategory1" <?=($infolayoutenginvoice['stockmaincategoryreq']=='1')?'required':''?>>
	<?php
...
<?php
	...
	{
		?>
		 <td style="width:<?=$cco/100?>%"><textarea rows="6" name="stockmaincategory[]" id="stockmaincategory1"  class="form-control" <?=($infolayoutenginvoice['stockmaincategoryreq']=='1')?'required':''?>></textarea></td>
		<?php
	}
}
else
...
?>					  
					  <td style="width:<?=$cco/100?>%">
					  <select class="fav_clr form-control" name="stocksubcategory[]" id="stocksubcategory1" <?=($infolayoutenginvoice['stocksubcategoryreq']=='1')?'required':''?>>
	<?php
	if((isset($newexcel_array))&&(is_array($newexcel_array)))
	{
...
<?php
	...
	{
		?>
		<td style="width:<?=$cco/100?>%"><textarea rows="6" name="stocksubcategory[]" id="stocksubcategory1"  class="form-control"  <?=($infolayoutenginvoice['stocksubcategoryreq']=='1')?'required':''?>></textarea></td>
		<?php
	}
}
else
...
?>					  
					  <td style="width:<?=$cco/100?>%">
<select class="fav_clr form-control" name="stockitem[]" id="stockitem1" <?=($infolayoutenginvoice['stockitemreq']=='1')?'required':''?>>
	<?php
	if((isset($newexcel_array))&&(is_array($newexcel_array)))
	{
...
<?php
	...
	{
		?>
		<td style="width:<?=$cco/100?>%"><textarea rows="6" name="stockitem[]" id="stockitem1"  class="form-control"  <?=($infolayoutenginvoice['stockitemreq']=='1')?'required':''?>></textarea></td>
		<?php
	}
}
else
...
?>					  
                      <td style="width:<?=$cco/100?>%">
					   <select class="fav_clr form-control" name="typeofproduct[]" id="typeofproduct1" <?=($infolayoutenginvoice['typeofproductreq']=='1')?'required':''?>>
	<?php
	if((isset($newexcel_array))&&(is_array($newexcel_array)))
	{
...
<?php
	...
	{
		?>
		 <td style="width:<?=$cco/100?>%"><textarea rows="6" name="typeofproduct[]" id="typeofproduct1"  class="form-control" <?=($infolayoutenginvoice['typeofproductreq']=='1')?'required':''?> ></textarea></td>
		<?php
	}
}
else
...
?>					  
					  <td style="width:<?=$cco/100?>%">
					  <select class="fav_clr form-control" name="componenttype[]" id="componenttype1" <?=($infolayoutenginvoice['componenttypereq']=='1')?'required':''?>>
	<?php
	if((isset($newexcel_array))&&(is_array($newexcel_array)))
	{
...
<?php
	...
	{
		?>
		 <td style="width:<?=$cco/100?>%"><textarea rows="6" name="componenttype[]" id="componenttype1"  class="form-control" <?=($infolayoutenginvoice['componenttypereq']=='1')?'required':''?> ></textarea></td>
		<?php
	}
}
else
...
?>					  
					  <td style="width:<?=$cco/100?>%">
					  <select class="fav_clr form-control" name="componentname[]" id="componentname1" <?=($infolayoutenginvoice['componentnamereq']=='1')?'required':''?>>
	<?php
	if((isset($newexcel_array))&&(is_array($newexcel_array)))
	{
...
<?php
	...
	{
		?>
		<td style="width:<?=$cco/100?>%"><textarea rows="6" name="componentname[]" id="componentname1"  class="form-control" <?=($infolayoutenginvoice['componentnamereq']=='1')?'required':''?> ></textarea></td>
...
?>
					  <td style="width:<?=$cco/100?>%">
					  <select class="fav_clr form-control" name="make[]" id="make1" <?=($infolayoutenginvoice['makereq']=='1')?'required':''?>>
	<?php
	if((isset($newexcel_array))&&(is_array($newexcel_array)))
	{
...
<?php
	...
	{
		?>
		<td style="width:<?=$cco/100?>%"><textarea rows="6" name="make[]" id="make1"  class="form-control" <?=($infolayoutenginvoice['makereq']=='1')?'required':''?>></textarea></td>
		<?php
	}
}
else
...
if($infolayoutenginvoice['capacity']=='1')
{
	...
	{
?>					  
					  <td style="width:<?=$cco/100?>%"><select class="fav_clr form-control" name="capacity[]" id="capacity1" <?=($infolayoutenginvoice['capacityreq']=='1')?'required':''?>>
	<?php
	if((isset($newexcel_array))&&(is_array($newexcel_array)))
	{
...
<?php
	...
	{
		?>
		 <td style="width:<?=$cco/100?>%"><textarea rows="6" name="capacity[]" id="capacity1"  class="form-control" <?=($infolayoutenginvoice['capacityreq']=='1')?'required':''?>></textarea></td>
		<?php
	}
}
else
...
?>
					  <td style="width:<?=$cco/100?>%">
					  <select class="fav_clr form-control" name="warranty[]" id="warranty1" <?=($infolayoutenginvoice['warrantyreq']=='1')?'required':''?>>
	<?php
	if((isset($newexcel_array))&&(is_array($newexcel_array)))
	{
...
<?php
	...
	{
		?>
		 <td style="width:<?=$cco/100?>%"><textarea rows="6" name="warranty[]" id="warranty1"  class="form-control" <?=($infolayoutenginvoice['warrantyreq']=='1')?'required':''?>></textarea></td>
		<?php
	}
}
else
...
?>					  <td style="width:<?=$cco/100?>%"><input type="number" name="qty[]" id="qty1"  class="form-control" <?=($infolayoutenginvoice['qtyreq']=='1')?'required':''?>></td>
<?php
}
else
{
...
if($infolayoutenginvoice['serialnumber']=='1')
{
?>					  <td style="width:<?=$cco/100?>%"><input type="text" name="serialnumber[]" id="serialnumber1"  class="form-control" <?=($infolayoutenginvoice['serialnumberreq']=='1')?'required':''?> onchange="addserial(this.value, this.value)"></td>
<?php
}
else
{
...
<label class="mr-2"><input type="radio" name="servicetype" id="servicetypeonsite" <?=((isset($_GET['ts']))&&(($_GET['ts']=='amcmaintenance')||($_GET['ts']=='amcexpire')))?'checked':''?> value="On-Site" <?=($infolayoutcall['servicetypereq']=='1')?'required':''?> checked onchange="checkcarry()"> On-Site </label>
...
<?php
					  ...
					  {
					  ?>
<label class="mr-2"><input type="radio" name="customernature" value="Rental" <?=($infolayoutcall['customernaturereq']=='1')?'required':''?>> Rental</label>
<?php
					  }
...
<?php
					  ...
					  {
					  ?>
<label class="mr-2"><input type="radio" name="customernature" value="None"  <?=($infolayoutcall['customernaturereq']=='1')?'required':''?> checked>  None </label>
<?php
					  }
					  ?>
</div>
...
<div class="col-lg-10 mb-3" <?=($infolayoutcall['calltype']=='1')?'style="display:none"':'style="display:none"'?>>
...
<div class="col-lg-3" >
  <div class="form-group">
	...
	<input  type="text" inputmode="numeric" class="form-control" id="callfrom" name="callfrom" maxlength="11" <?=($infolayoutcall['callfromreq']=='1')?'required':''?>>
  </div>
</div>
<?php
}
...
<label for="diagnosisby" class="text-primary">Diagnosis By</label><br>
<div class="row">
<div class="col-lg-3" style="display:none">
<div class="form-group">
	<label class="mr-2"><input type="radio" name="diagnosisby" id="diagnosisbyengineer" value="engineer" onchange="checkdiagnosis()" checked> Engineer </label>
...
<?php
$sqlrep = "SELECT id, engineername From jrcengineer where enabled='0' and id='".$id."' order by engineername asc";
        $queryrep = mysqli_query($connection, $sqlrep);
        $rowCountrep = mysqli_num_rows($queryrep);
        if(!$queryrep){
           die("SQL query failed: " . mysqli_error($connection));
        ...
        if($rowCountrep > 0) 
		{
			...
			{
				?>
<option value="<?=$rowrep['id']?>" checked><?=$rowrep['engineername']?></option>
<?php
			}
		}
		?>
...
$sqlrep = "SELECT id, engineername From jrcengineer where enabled='0' order by engineername asc";
        ...
        if($rowCountrep > 0) 
		{
			...
			{
				?>
<option value="<?=$rowrep['id']?>" <?=($id==$rowrep['id'])?'selected':''?>><?=$rowrep['engineername']?></option>
<?php
			}
		}
		?>
