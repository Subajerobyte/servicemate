...
$maxproduct=mysqli_real_escape_string($connection,$rowselect['maxproduct']);
$sqls=mysqli_query($connection,"select invoiceno from jrcinvoice");
$infos=mysqli_fetch_array($sqls);
$invoicenofrom=(float)$infos['invoiceno']+1;
$invoicenoto=(float)$infos['invoiceno']+(float)$noofconsignee;
...
<td><input type="text" class="conproduct" name="conproduct[]" id="conproduct<?=$rowselect['consigneeno']?>" value="<?=htmlspecialchars($rowselect['conproduct'], ENT_QUOTES)?>" placeholder="PRODUCT (<?=$rowselect['consigneeno']?>)" tabindex="36"></td>
<td><input type="text" class="conmarketname" name="conmarketname[]" id="conmarketname<?=$rowselect['consigneeno']?>" value="<?=htmlspecialchars($rowselect['conmarketname'], ENT_QUOTES)?>" placeholder="PRODUCT (<?=$rowselect['consigneeno']?>)" tabindex="37"></td>
...
<td><input type="number" step="0.01" min="0" class="conigst" name="conigst[]" id="conigst<?=$rowselect['consigneeno']?>"  value="<?=$rowselect['conigst']?>" placeholder="IGST (<?=$rowselect['consigneeno']?>)" onchange="igstcheckf(this.value); procalc(<?=$rowselect['consigneeno']?>)" tabindex="40"></td>
<td><input type="number" step="0.01" min="0" class="consgst" name="consgst[]" id="consgst<?=$rowselect['consigneeno']?>" value="<?=$rowselect['consgst']?>" placeholder="SGST (<?=$rowselect['consigneeno']?>)" onchange="sgstcheckf(this.value); procalc(<?=$rowselect['consigneeno']?>)" tabindex="41"></td>
...
<td><input type="number" step="0.01" min="0" class="conwarranty" name="conwarranty[]" id="conwarranty<?=$rowselect['consigneeno']?>" value="<?=$rowselect['conwarranty']?>" placeholder="WARRANTY MONTHS (<?=$rowselect['consigneeno']?>)" onchange="warrantycheckf(this.value);" tabindex="47"></td>
</tr>
<?php
$i++;
