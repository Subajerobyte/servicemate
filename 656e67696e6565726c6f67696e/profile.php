...
<h1 class="h4 mb-2 mt-2 text-gray-800">Profile</h1>
</div>
<?php
...
<div class="card bg-danger text-white shadow">
<div class="card-body">
Update your Profile from Your Home Location
</div>
</div>
</div>
</div>
...
<div class="card-body">
<?php
$sqlselect = "SELECT * From jrcengineer where id='".$id."' order by username asc";
...
{
?>
<form action="profiles.php" onsubmit="return checkvalidate()" id="myForm" method="post" enctype="multipart/form-data">
<input type="hidden" name="id" id="id" value="<?=$id?>">
<div class="row">
<div class="col-lg-6">
<div class="form-group">
<label for="engineername">Engineer Name</label>
<input type="text" class="form-control" id="engineername" name="engineername" placeholder="Engineer Name" value="<?=$rowselect['engineername']?>">
</div>
</div>
<div class="col-lg-6">
<div class="form-group">
...
<input type="text" class="form-control" id="username" name="username" placeholder="User Name" readonly value="<?=$rowselect['username']?>">
</div>
</div>
<?php
if($secsystem=='1')
...
<input type="text" class="form-control" id="password" name="password" value="<?=md5($rowselect['password'])?>" required>
</div>
</div>
<?php
}
...
<input type="text" class="form-control" id="password" name="password" value="<?=$rowselect['password']?>" required>
</div>
</div>
<?php
}
...
<input type="text" class="form-control" id="latlong" name="latlong" placeholder="Latlong" value="<?=$rowselect['latlong']?>" onKeyup="cleartext()" >
</div>
</div>
</div>
<div class="row">
...
<h5 class="mb-2"><label for="signname">Profile Photo</label></h5>
<span class="img-div">
