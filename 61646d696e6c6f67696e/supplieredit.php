...
<head>
  ...
  <title><?=$_SESSION['companyname']?> - Jerobyte - Edit Supplier Details</title>
...
<div class="d-sm-flex align-items-center justify-content-between mb-1">
            <h1 class="h4 mb-2 mt-2 text-gray-800">Edit Supplier Details</h1>
...
?>
          ...
          <div class="card shadow mb-4">
           <!-- <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Edit Supplier Details</h6>
            </div>-->
<div class="card-body">
<?php
$id=mysqli_real_escape_string($connection,$_GET['id']);
				  $sqlselect = "SELECT * From jrcsuppliers where id='".$id."' order by suppliername asc";
				...
				if(($infocompany1['encsystem']=='1')||($infocompany1['encsystem']=='2'))
{
	...
	{		
		...
		$rowselect['email']=jbsdecrypt($_SESSION['encpass'], $rowselect['email']);
			...
			?>
<form action="supplieredits.php" method="post">
...
<div class="col-lg-6">
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="maincategory" name="maincategory" <?=($infolayoutsupplier['maincategoryreq']=='1')?'required':''?> value="<?=$rowselect['maincategory']?>">
  </div>
</div>
<?php
}
...
<div class="col-lg-6">
    ...
    <input type="text" class="form-control" id="subcategory" name="subcategory" <?=($infolayoutsupplier['subcategoryreq']=='1')?'required':''?> value="<?=$rowselect['subcategory']?>">
  </div>
  </div>
<?php
}
...
<div class="col-lg-6">
    ...
    <input type="text" class="form-control" id="suppliername" name="suppliername"  <?=($infolayoutsupplier['suppliernamereq']=='1')?'required':''?> value="<?=$rowselect['suppliername']?>">
  </div>
  </div>
<?php
}
...
{
	?>
	<input type="hidden" name="suppliername" id="suppliername" value="<?=$rowselect['suppliername']?>">
	<?php
}
...
<div class="col-lg-6">
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="department" name="department" <?=($infolayoutsupplier['departmentreq']=='1')?'required':''?> value="<?=$rowselect['department']?>">
  </div>
   </div>
<?php
}
...
<div class="col-lg-6">
    ...
    <input type="text" class="form-control" id="address1" name="address1" <?=($infolayoutsupplier['address1req']=='1')?'required':''?> value="<?=$rowselect['address1']?>">
  </div>
  </div>
<?php
}
...
<div class="col-lg-6">
  <div class="form-group">
   ...
   <input type="text" class="form-control" id="address2" name="address2" <?=($infolayoutsupplier['address2req']=='1')?'required':''?> value="<?=$rowselect['address2']?>">
  </div>
   </div>
<?php
}
...
<div class="col-lg-6">
    ...
    <input type="text" class="form-control" id="area" name="area" <?=($infolayoutsupplier['areareq']=='1')?'required':''?> value="<?=$rowselect['area']?>">
  </div>
  </div>
<?php
}
...
<div class="col-lg-6">
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="district" name="district" <?=($infolayoutsupplier['districtreq']=='1')?'required':''?> value="<?=$rowselect['district']?>">
  </div>
   </div>
<?php
}
...
<div class="col-lg-6">
    ...
    <input type="text" class="form-control" id="pincode" name="pincode" maxlength="6"  <?=($infolayoutsupplier['pincodereq']=='1')?'required':''?> value="<?=$rowselect['pincode']?>">
  </div>
  </div>
<?php
}
...
<div class="col-lg-6">
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="latlong" name="latlong" <?=($infolayoutsupplier['latlongreq']=='1')?'required':''?> onKeyup="cleartext()" value="<?=$rowselect['latlong']?>">
  </div>
   </div>
<?php
}
...
<div class="col-lg-6">
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="contact" name="contact" <?=($infolayoutsupplier['contactreq']=='1')?'required':''?> value="<?=$rowselect['contact']?>">
  </div>
   </div>
<?php
}
...
<div class="col-lg-6">
    ...
    <input type="text" class="form-control" id="phone" name="phone" maxlength="11" <?=($infolayoutsupplier['phonereq']=='1')?'required':''?> value="<?=$rowselect['phone']?>">
  </div>
  </div>
<?php
}
...
<div class="col-lg-6">
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="mobile" name="mobile" required maxlength="10" <?=($infolayoutsupplier['mobilereq']=='1')?'required':''?> value="<?=$rowselect['mobile']?>">
  </div>
   </div>
 <?php
}
...
<div class="col-lg-6">
  <div class="form-group">
    ...
    <input type="email" class="form-control" id="email" name="email" <?=($infolayoutsupplier['emailreq']=='1')?'required':''?> value="<?=$rowselect['email']?>">
  </div>
   </div>
<?php
}
...
<div class="col-lg-6">
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="gstno" name="gstno" <?=($infolayoutsupplier['gstnoreq']=='1')?'required':''?> value="<?=$rowselect['gstno']?>">
  </div>
   </div>
<?php
}
