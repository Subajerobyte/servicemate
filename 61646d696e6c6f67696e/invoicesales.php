...
$invoicenoto=(float)$infos['invoiceno'];
?>
<div class="row">
<div class="col-lg-6">
<div class="form-group">
<label for="sono">SO No</label>
<input type="text" class="form-control" id="sono" name="sono" placeholder="SO No" value="<?='SO / '.(date('my')).' /'.(str_pad($invoicenofrom, 4, '0', STR_PAD_LEFT))?>" readonly>
</div>
</div>
<div class="col-lg-6">
<div class="form-group">
...
<input type="text" class="form-control" id="otherreference" name="otherreference">
</div>
</div>
<div class="col-lg-6">
<div class="form-group">
...
{
?>
<option value="<?=$infosai['email']?>"><?=$infosai['name']?></option>
<?php
}
?>
</select>
...
<option value="">Select</option>
<?php
$sqlsai=mysqli_query($connection, "select * from jrcmark where enabled='0' order by productname asc");
while($infosai=mysqli_fetch_array($sqlsai))
{
?>
<option value="<?=$infosai['id']?>"><?=$infosai['productname']?></option>
<?php
}
?>
</select>
...
<td style="width:8%"><input type="number" name="qty[]" id="qty1" class="form-control" min="0" onchange="productcalc(1)" style="text-align:right"></td>
...
<input type="number" name="discount[]" id="discount1" class="form-control" onchange="productcalc(1)" style="text-align:right">
...
<label for="terms">You can Upload max 2 files with 2MB Each</label>
</div>
</div>
<div class="col-lg-8">
<div class="form-group">
<label for="terms">Terms and Conditions</label>
<textarea class="form-control" id="terms" name="terms" style="height: 60px;"></textarea>
...
productresponse1+='<br><label><input type="radio" name="godownname'+ids+'[]" id="godownname'+ids+'" value="'+godownid+'"> '+godownname+' - '+available+'</label>';
}
