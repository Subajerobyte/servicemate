...
<head>
  ...
  <title><?=$_SESSION['companyname']?> - Jerobyte - Add New Spare Name</title>
...
<div class="d-sm-flex align-items-center justify-content-between mb-1">
            <h1 class="h4 mb-2 mt-2 text-gray-800">Add New Spare Name</h1>
...
?>
          ...
          <!--  <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Add New Spare Name</h6>
            </div>-->
<div class="card-body">
<form action="spareadds.php" onsubmit="return checkvalidate()" method="post" enctype="multipart/form-data">
<div class="row">
<div class="col-lg-6">
...
<div class="col-lg-3">
  <div class="form-group">
    <label for="price">GST Percentage</label>
    <input type="number" min="0" step="0.01" class="form-control" id="gstper" name="gstper"  required>
  </div>
</div>
