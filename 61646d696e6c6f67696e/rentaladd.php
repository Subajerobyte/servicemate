...
<title><?=$_SESSION['companyname']?> - Jerobyte - Add New Rental</title>
...
<!-- Page Heading -->
	   ...
	   <div class="row">
  <div class="col">
    <h1 class="h4 mb-2 mt-2 text-black-800 text-center"><b>Add New Rental</b></h1>
  </div>
</div>
<?php
...
<div class="card-body">
<form method="post" method="post" action="rentaladds.php" enctype="multipart/form-data">
<div class="row">
<div class="col-xl-8">
...
{
?>
<option value="<?=$rowgo['id']?>"><?=$rowgo['consigneename']?></option>
<?php
}
}
?>
...
<div class="col-md-12">
<div class="mt-1 text-primary mb-1">Consignee Details <input type="hidden" name="consigneeid" id="consigneeid"> <span href="#" data-toggle="modal" data-target="#consigneemodal" onclick="updateauto()">&nbsp;<i class="fa fa-pen"></i></span></div>
...
<div class="col-xl-4 ">
<?php
$sqls=mysqli_query($connection,"select rono from jrcrono");
$infos=mysqli_fetch_array($sqls);
$ronofrom=(float)$infos['rono']+1;
$ronoto=(float)$infos['rono'];
?>
<div class="row">
<div class="col-lg-6">
<div class="form-group">
<label for="rono">RO No</label>
<input type="text" class="form-control" id="rono" name="rono" placeholder="RO No" value="<?='RO / '.(date('my')).' /'.(str_pad($ronofrom, 4, '0', STR_PAD_LEFT))?>" readonly>
</div>
</div>
<div class="col-lg-6">
<div class="form-group">
<label for="shipment">Rental Date</label>
<input type="date" class="form-control" id="rentaldate" name="rentaldate" value="<?=date('Y-m-d')?>">
</div>
</div>
<div class="col-lg-6">
<div class="form-group">
<label for="shipment">Shipment Date</label>
<input type="date" class="form-control" id="shipment" name="shipment">
</div>
</div>
<div class="col-lg-6">
<div class="form-group">
<label for="deliverymethod">Delivery Method</label>
<input type="text" class="form-control" id="deliverymethod" name="deliverymethod">
</div>
</div>
<div class="col-lg-6">
<div class="form-group">
...
<input type="text" class="form-control" id="vechileno" name="vechileno">
</div>
</div>
<div class="col-lg-6">
<div class="form-group">
...
<option value="">Select</option>
<?php
$sqlgo = "SELECT id, stockitem From jrcproduct where stockitem!='' order by stockitem asc limit 10";
$querygo = mysqli_query($connection, $sqlgo);
$rowCountgo = mysqli_num_rows($querygo);
if(!$querygo){
die("SQL query failed: " . mysqli_error($connection));
...
<td style="width:8%"><input type="datetime-local" class="form-control" id="datefrom1" name="datefrom[]" style="text-align:left" value="<?=date('d-m-Y h:i a');?>" required><span href="#" class="text-danger text-right">From Date</span></br>
<input type="datetime-local" class="form-control" id="dateto1" name="dateto[]" style="text-align:left" value="<?=date('d-m-Y h:i a');?>" required><span href="#" class="text-danger text-right">To Date</span></td>

<td style="width:8%"><input type="number" name="qty[]" id="qty1" class="form-control" min="0" onchange="productcalc(1)" style="text-align:right"> <span href="#" data-toggle="modal" data-target="#serialmodal" onclick="updateauto()"></span>  <span href="#" data-toggle="modal" data-target="#serialchangemodal" onclick=" serialnumbers(1)" class="text-danger text-right">Update Serial</span>
...
<td style="width:8%"><input type="number" class="form-control" id="penaltyperday1" name="penaltyperday[]" style="text-align:left"></td>
...
<input type="hidden" name="rentper[]" id="rentper1">

<input type="hidden" name="rentperamount[]" id="rentperamount1">
<input type="hidden" name="gstamount[]" id="gstamount1">
</td>
<td style="width:10%"><input type="text" name="totalamount[]" id="totalamount1" readonly class="form-control" style="text-align:right"><div id="totalamountresponse1"></div>
</td>
...
<input type="text" class="form-control" id="totalitems" name="totalitems" readonly>
</div>
<div class="form-group">
...
<textarea class="form-control" id="notes" name="notes" style="height: 78px;"></textarea>
</div>
</div>
</div>
<div class="row">
...
<input type="file" class="form-control" id="beforeimage" name="beforeimage[]" style="padding:10px; height:auto" accept="image/*" multiple>
...
<input type="file" class="form-control" id="afterimage" name="afterimage[]" style="padding:10px; height:auto" accept="image/*" multiple>
<label for="terms">You can upload a maximum of two files, Each with a size limit of 2MB</label>
</div>
</div>
<div class="col-lg-4">
...
<textarea class="form-control" id="terms" name="terms" style="height: 90px;"></textarea>
...
<div class="form-group row">
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-8">
      <input type="text"  class="form-control" id="advanceamount" name="advanceamount" style="text-align:right" >
    </div>
  </div>
...
$clone.find('#rentper'+oldcurid).attr("id", "rentper"+curid);
$clone.find('#rentperamount'+oldcurid).attr("id", "rentperamount"+curid);
...
var rentalvalue= response[i]['rentalvalue'];
...
$("#rentalvalue"+ids).val(rentalvalue); 
...
$("#prrentalvalue").val($("#rentalvalue"+ids).val());
	...
	if(qty!="")
	{
		...
		if(nos>0)
		{
			...
			for(var i=1; i<=nos; i++)
			{
				...
				output+='<div class="row"><div class="col-lg-12"><div class="form-group"><label for="kserialnumber">'+i+')&nbsp;Serial Number</label><input type="text" class="form-control" id="kserialnumber'+i+'" name="kserialnumber[]" value="'+svalue+'"></div></div></div></div>';
			}
