...
if(isset($_POST['submit']))
{
	...
	{		
		...
		{	
			...
			$sqlup = "update jrcbranch set branchname='$branchname',branchdes='$branchdes',address1='$address1',address2='$address2',area='$area',district='$district',pincode='$pincode',caretaker='$caretaker',caretakerphone='$caretakerphone',geolocation='$geolocation' where id='$id'";
			...
			{
				mysqli_query($connection, "INSERT INTO jrchistory (user, ipaddress, times, remarks, tid, tablename) VALUES ('{$useremail}', '{$ip}', '{$times}', 'Updated Branch Information', '{$id}', 'jrcbranch')");
				header("Location: branches.php?remarks=Updated Successfully");
			} 
	    }
		else
			{
				header("Location: branches.php?error=This record is Not Found! Kindly check in All Holidays List");
			}
	}
	else
			{
...
<head>
  ...
  <title><?=$_SESSION['companyname']?> - Jerobyte - Edit Branch Details</title>
...
<div class="d-sm-flex align-items-center justify-content-between mb-1">
            <h1 class="h4 mb-2 mt-2 text-gray-800">Edit Branch Details</h1>
...
?>
          ...
          <div class="card shadow mb-4">
            <!--<div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Edit Branch Details</h6>
            </div>-->
<div class="card-body">
<?php
if(isset($_GET['id']))
...
$id=mysqli_real_escape_string($connection,$_GET['id']);
				  $sqlselect = "SELECT * From jrcbranch where id='".$id."' order by branchname asc";
...
<div class="col-lg-4">
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="branchname" name="branchname" value="<?=$rowselect['branchname']?>" required>
  </div>
</div>
 <div class="col-lg-4">
  <div class="form-group">
...
<div class="col-lg-4">
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="branchdes" name="branchdes" value="<?=$rowselect['branchdes']?>">
  </div>
</div>
<div class="col-lg-4">
  <div class="form-group">
