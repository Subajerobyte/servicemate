...
?>
  ...
  <div class="row mb-1">
    ...
    <div class="col-6">
	  ...
	  <input type="hidden" name="previous" id="previous"   onClick="return executeFunctions()">
    </div>
  </div>  
  <hr>
  <!-- spares div started-->
 ...
 <div class="table-responsive">
	...
	<?php
			...
			?>
                    ...
                    <td> <input type="number" min="0" class="form-control" name="squantity<?=$i?>" id="squantity<?=$i?>" value="<?=($rowcon4>0)?$infocon4['squantity'.$i]:''?>" step="any" onChange="executeFunctions()" ></td>
					
                    <td><input type="number" min="0" class="form-control" name="stotal<?=$i?>" id="stotal<?=$i?>" value="<?=($rowcon4>0)?$infocon4['stotal'.$i]:''?>"   readonly   step="0.01"></td>
					
                    <td><input type="number" min="0" class="form-control" name="sgstper<?=$i?>" id="sgstper<?=$i?>" readonly value="<?=($rowcon4>0)?$infocon4['sgstper'.$i]:''?>"   step="0.01">
					
					</td>
                    <td><input type="number" min="0" class="form-control" name="sgstpervalue<?=$i?>" id="sgstpervalue<?=$i?>" readonly value="<?=($rowcon4>0)?$infocon4['sgstpervalue'.$i]:''?>"   step="0.01" >
					</td>
                    <td><input type="number" min="0" class="form-control" name="schargepre<?=$i?>" id="schargepre<?=$i?>" value="<?=($rowcon4>0)?$infocon4['schargepre'.$i]:''?>" readonly step="0.01"></td>
