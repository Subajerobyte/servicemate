...
<head>
  ...
  <title><?=$_SESSION['companyname']?> - Jerobyte - Rental Agreement</title>
...
<!--<div class="d-sm-flex align-items-center justify-content-between mb-2">
            <h1 class="h4 mb-0 text-gray-800"> Rental Agreement</h1>
                      </div>-->
					  
					   <div class="row">
  <div class="col">
    <h1 class="h4 mb-2 mt-2 text-black-800 text-center" ><b>Rental Agreement</b></h1>
  </div>
  </div>
		  <?php
...
<div class="card-body">
<?php
$sqlselect = "SELECT documenttype, subject, contentmessage, terms, aterms, stockitem  From jrcrentalagree where id='".$id."' order by documenttype asc";
        ...
        if($rowCountselect > 0) 
		{
			...
			{
			?>
<form action="rentalagreeedits.php" onsubmit="return checkvalidate()" method="post" enctype="multipart/form-data">
...
<div class="col-lg-6">
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="documenttype" name="documenttype" required value="<?=$rowselect['documenttype']?>" readonly>
  </div>
</div>
<div class="col-lg-6">
  <div class="form-group">
...
<div class="col-lg-6">
  <div class="form-group">
    <label for="stockitem">Product Types to be available for Rental</label>
