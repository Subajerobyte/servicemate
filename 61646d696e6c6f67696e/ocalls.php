...
<head>
  ...
  <title><?=$_SESSION['companyname']?> - Jerobyte - Observation Calls</title>
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          <!-- Page Heading -->
		   <div class="row">
  <div class="col">
    <h1 class="h4 mb-2 mt-2 text-black-800 text-center" style="padding-left:300px;"><b>Observation Calls</b></h1>
  </div>
        ...
        <div class="input-group">
            ...
            <div class="input-group-append">
                ...
                <button class="btn btn-navb" type="submit">
                    <a href="ocalls.php"><i class="fas fa-undo fa-sm" style="color:#3d8eb9;"></i></a>
                </button>
            </div>
        </div>
    </form>
...
if($staqu!="")
{
	$staqu.=" and (actiontaken='OBSERVATION') ";
}
else
{
	$staqu.=" where (actiontaken='OBSERVATION')";
}		
if(isset($_GET['prob']))
{
...
<?php
		  if(isset($_POST['submit']))
		  {
			  ...
			  $dashfromdate=date('Y-m-d',strtotime($dashfromdate));
			  $dashtodate=date('Y-m-d',strtotime($dashtodate));
					  ...
					  else
					 {
					  ...
					  if($calledit=='1')
					  {
						 if($rowselect['compstatus']!='2')
						  ...
						  if($rowselect['compstatus']=='2' && $rowselect['actiontaken']=='OBSERVATION')
						  {
							  ?>
							  <td><a href="callsedit.php?id=<?=$rowselect['id']?>">Edit</a></td>
							  <?php
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Observation Calls</h5>
