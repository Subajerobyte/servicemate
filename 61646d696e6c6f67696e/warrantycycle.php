...
<head>
  ...
  <title><?=$_SESSION['companyname']?> - Jerobyte - Warranty Cycle Missing Products</title>
...
<!--<div class="d-sm-flex align-items-center justify-content-between mb-1">
            <h1 class="h4 mb-2 mt-2 text-gray-800">Warranty Cycle Missing Products</h1>
          </div>-->
		   <div class="row">
  <div class="col">
    <h1 class="h4 mb-2 mt-2 text-black-800 text-center" ><b>Warranty Cycle Missing Products</b></h1>
  </div>
...
?>
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
			<?php
	$sqlselect = "SELECT * From jrcxl where warranty='' order by id desc";
...
$staqu="where stockitem!='' and (warrantycycle IS NULl or warrantycycle='') ";
...
<div class="card shadow mb-4">
            <div class="card-body">
<form action="warrantycyclemissing.php" method="post">
...
<th>Warranty Maintance Cycle(In Months)</th>
                    </tr>
                  </thead>
                  <tbody>
		<?php
		$sqlselect = "SELECT stockmaincategory, stocksubcategory, stockitem, typeofproduct, componenttype, componentname, make, capacity, id, invoiced,code,marketname,warrantycycle from jrcproduct ".$staqu." order by stockitem asc";
	    $queryselect = mysqli_query($connection, $sqlselect);
        $rowCountselect = mysqli_num_rows($queryselect);
...
<td><?=$count?><input type="hidden" name="ids[]" value="<?=$rowselect['id']?>"></td>
				  ...
				  <td><input type="number" max="12" name="warrantycycle[]" id="warrantycycle" value="<?=trim($rowselect['warrantycycle'])?>" class="form-control"></td>
                    </tr>
					<?php
					$count++;
			}
