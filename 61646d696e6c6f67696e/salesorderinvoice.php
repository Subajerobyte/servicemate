		...
		?>
            <button id="printButton" style="background-color: #00B3BC; float: right;" class="btn btn-lg shadow-sm text-white">Print</button>
					 ...
					 <table style="border:1px solid #8c8c8c">
						  ...
						  <tr>
						  <td colspan="5" align="center"><p class="heading" style="font-size:28px; padding:1px;">TAX INVOICE</p></td>
						  </tr>
						  </table>
						  <table border="1" style="border:1px solid #8c8c8c">
						  <tr>
						 ...
						 <p style="margin-left:20px;"><strong><?=$rowselect[0]['consigneename']?></strong><br><?php if($rowselect[0]['conaddress1']!='') { echo $rowselect[0]['conaddress1'];}?> <?php if($rowselect[0]['conaddress2']!=''){ echo $rowselect[0]['conaddress2'];}?> <?php if($rowselect[0]['conaddress3']!=''){echo $rowselect[0]['conaddress3'];}?><?if($rowselect[0]['contaluk']!=''){echo $rowselect[0]['contaluk'].'&nbsp;';}?><?php if($rowselect[0]['condistrict']!=''){ echo $rowselect[0]['condistrict'].' - ';}?><?php if($rowselect[0]['conpincode']!=''){ echo $rowselect[0]['conpincode'];}?><?php ?><br>
						   <b><?php if($rowselect[0]['congstno']!=''){?>GSTIN:</b> <?php echo $rowselect[0]['congstno']; if($rowselect[0]['conmobile']!=''){ echo ', Mobile : ' .$rowselect[0]['conmobile'];}} else {echo 'Unregistered '; if($rowselect[0]['constatecode']!=''){?>Code / State Name:</b> <?=$rowselect[0]['constatecode']?> &nbsp;<?php if($rowselect[0]['conmobile']!=''){ echo ', Mobile : ' .$rowselect[0]['conmobile'];} }}  ?>
						  </p></td>
						  ...
						  <b><?php if($rowselect[0]['bgst']!=''){?>GSTIN:</b> <?php echo $rowselect[0]['bgst']; if($rowselect[0]['buyermobile']!=''){ echo ', Mobile : ' . $rowselect[0]['buyermobile'];}} else {echo 'Unregistered ';  if($rowselect[0]['buyerstate']!=''){?>Code / State Name:</b> <?=$rowselect[0]['buyerstate']?> &nbsp;<?php  if($rowselect[0]['buyermobile']!=''){ echo ', Mobile : ' . $rowselect[0]['buyermobile'];} }} ?>
						  </p></b></td>
						  </tr>
