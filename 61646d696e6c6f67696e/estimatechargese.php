...
if(isset($_POST['id']))
{
	...
	$sqli=mysqli_query($connection, "update jrccalldetails set cashstatus='1', schargereceivedmode='$schargereceivedmode', schargereceivedon='$schargereceivedon', schargeremarks='$schargeremarks' where id='$id'");
	if($sqli)
	{
		header("Location: estimatecharges.php?remarks=Changed Successfully!");
	}
	else
	{
		header("Location: estimatecharges.php?error=".mysqli_error($connection));
	}
}
?>
<!DOCTYPE html>
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-1">
            <h1 class="h4 mb-2 mt-2 text-gray-800">Estimate Charges</h1>
          </div>
...
<input type="hidden" name="id" id="id" value="<?=$id?>">
 ...
 <th colspan="8" class="text-center">Estimate Charges</th>
 </tr>
 <tr>
 <th>SC NO</th>
 <th>DATE</th>
 <th>MATERIAL CHARGES</th>
 <th>Estimate Charges</th>
 <th>TOTAL</th>
 <th>GST</th>
 <th>GST VALUE</th>
 <th>GRAND TOTAL</th>
