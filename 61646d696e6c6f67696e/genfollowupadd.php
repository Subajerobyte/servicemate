...
<div class="d-sm-flex align-items-center justify-content-between mb-1">
            <h1 class="h4 mb-2 mt-2 text-gray-800"> Add New Followup</h1>
          </div>
		  <?php
...
<div class="row" id="myItems">
 ...
 if(isset($_GET['id']))
 {
	...
	$sqlcons = "SELECT * From jrcconsignee where id='".$id."'";
				$querycons = mysqli_query($connection, $sqlcons);
				$rowselect=mysqli_fetch_array($querycons);
		?>
		
<div class="col-lg-12 mb-4 items">					
<form action="genfollowupadds.php" onsubmit="return checkvalidate()" method="post">
	<input type="hidden" name="consigneeid" value="<?=$rowselect['id']?>">
...
<div class="col-lg-4">
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="followuptype" name="followuptype" required>
  </div>
</div>
<div class="col-lg-4">
  <div class="form-group">
