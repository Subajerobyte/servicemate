...
{
$upload="Invoice_Details.csv";
}
else
{
header("location: dashboard.php?s=s");
}
...
$uploadDir = "../padhivetram/";
	...
	$oldfile="../tallyexport/invoice/".$upload;
...
if($rowCountselect > 0) 
{
	...
	$fl=str_replace("../tallyexport/invoice/","../del/".(date('Y-m-d'))."-",$oldfile);
	rename($oldfile, $fl);
