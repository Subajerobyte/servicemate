                                ...
                                <div class="card-statistic-3 p-3">
                                    <div class="row align-items-center  d-flex" style="font-size:14px;">
                                        <div class="col-12 text-center">
                                            ...
                                            <h5 class="card-title mb-0" style="font-size:0.9rem; line-height:1.1; font-weight:bold">AMC -
                                ...
                                <div class="card-statistic-3 p-3">
                                    <div class="row align-items-center  d-flex" style="font-size:14px;">
                                        <div class="col-12 text-center">
                                            ...
                                            <h5 class="card-title mb-0" style="font-size:0.9rem; font-weight:bold; line-height:1.1">WTY -
...
<div class="col-lg-12">
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Call Status <a class="float-right" href="callstatus.php">View All Status</a></h6>
                                </div>
								<?php
						$result=mysqli_query($connection, "SELECT calltype, compstatus, callon, changeon From jrccalls order by id asc");
						while($array = mysqli_fetch_assoc($result)){
							...
							foreach($row as $d)
							{
								if(date('Y-m-d')>date('Y-m-d',strtotime($d['callon'])))
								{
									$oldcalls++;
								...
								if(date('Y-m-d')>date('Y-m-d',strtotime($d['changeon'])))
								{
									if($d['compstatus']=='1')
									{
										$oldpending++;
							...
							$oldbalance=($oldcalls)-($oldpending+$oldcompleted);
							$oldsbalance=($oldscalls)-($oldspending+$oldscompleted);
							$oldobalance=($oldocalls)-($oldopending+$oldocompleted);
							...
							$todaybalance=($todaycalls+$oldbalance)-($todaypending+$todaycompleted);
							$todaysbalance=($todayscalls+$oldsbalance)-($todayspending+$todayscompleted);
							$todayobalance=($todayocalls+$oldobalance)-($todayopending+$todayocompleted);
						?>
                                <div class="card-body" style="padding-top:0; padding-bottom:12px;">
									...
									<tr>
									<td>Yesterday Balance Calls</td>
									<th><?=$oldsbalance?></th>
									<th><?=$oldobalance?></th>
									<th><?=$oldbalance?></th>
									</tr>
									<tr>
									<td>Today Assigned Calls</td>
									<th><?=$todayscalls?></th>
									<th><?=$todayocalls?></th>
									<th><?=$todaycalls?></th>
									</tr>
									<tr>
									<td>Today Pending Calls</td>
									<th><?=$todayspending?></th>
									<th><?=$todayopending?></th>
									<th><?=$todaypending?></th>
									</tr>
									<tr>
									<td>Today Completed Calls</td>
									<th><?=$todayscompleted?></th>
									<th><?=$todayocompleted?></th>
									<th><?=$todaycompleted?></th>
									</tr>
									<tr>
									<td>Balance Opening Calls</td>
									<th><?=$todaysbalance?></th>
									<th><?=$todayobalance?></th>
									<th><?=$todaybalance?></th>
									</tr>
