...
class push {
    ...
    private $user = 'jerouser_jrc';
    private $password = '#]M@?E9VcG{S';
    private $database = 'jero_jrc';    
    private $notifTable = 'jrcnotification';
	...
	public function listNotificationUser($user){
		$sqlQuery = "SELECT * FROM ".$this->notifTable." WHERE notif_loop > 0 AND notif_time <= CURRENT_TIMESTAMP()";
		return  $this->getData($sqlQuery);
	}	
