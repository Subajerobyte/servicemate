...
<head>
  ...
  <title><?=$_SESSION['companyname']?> - Jerobyte - Service Engineer Details</title>
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
		   ...
		   <div class="row">
  <div class="col">
    <h1 class="h4 mb-2 mt-2 text-black-800 text-center"><b>Service Engineer Details</b></h1>
  </div>
  <div class="col-auto">
    <a href="engineeradd.php" class="m-2 btn btn-sm btn-primary shadow-sm"><i class="fas fa-plus fa-sm text-white-50"></i> Add New Service Engineer</a>
  </div>
</div>
		  <?php 
			...
			<?php 
              ...
              <div class="table-responsive scroll">
                <table class="table table-bordered font-13" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <tbody>
				  <?php 
				  $sqlselect = "SELECT id, engineername, designation, engineergrade, compprefix, compno, targetpoint, sincentiveper, incentiveper, username, password, address1, address2, area, district, pincode, latlong, contact, phone, mobile, email From jrcengineer order by username asc";
...
<td><a href="engineeredit.php?id=<?=$rowselect['id']?>">Edit</a></td>                    
			...
			<td><?=$rowselect['incentiveper']?></td>
					  ...
					  {
						?>
                      <td><a href="mapengineerview.php?id=<?=$rowselect['id']?>&attdate=<?=date('Y-m-d')?>"><?=$rowselect['username']?></a></td>
					  <?php 
					  }
					  else
					  {
					  ?>
					  <td><a href="mapengineerview.php?id=<?=$rowselect['id']?>&attdate=<?=date('Y-m-d')?>">View</a></td>
					  <?php 
					  }
					  ?>
					  <?php 
