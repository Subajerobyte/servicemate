...
if(isset($_POST['submit']))
{
  ...
  $supcompstatus=mysqli_real_escape_string($connection, $_POST['supcompstatus']);
	...
	{
		$sqlise=mysqli_query($connection, "update jrccalls set suprcourierdate='$suprcourierdate', suprcourierpaytype='$suprcourierpaytype', suprcouriercharges='$suprcouriercharges', suprcourierdetails='$suprcourierdetails', suprcourierimg='$suprcourierimg', supcompstatus='$supcompstatus' where id='$id'");
		if($sqlise)
		{
			$tid=$id;
			mysqli_query($connection, "update jrcgodownproduct set type='OEM Received' where callid='$id'");
			mysqli_query($connection, "INSERT INTO jrchistory (user, ipaddress, times, remarks, tid, tablename) VALUES ('{$useremail}', '{$ip}', '{$times}', 'Insert A OEM Received Details', '{$tid}', 'jrccalls')");
...
<head>
  ...
  <title><?=$_SESSION['companyname']?> - Jerobyte - OEM Received Details</title>
...
<div class="d-sm-flex align-items-center justify-content-between mb-1">
            <h1 class="h4 mb-2 mt-2 text-gray-800">OEM Received Details</h1>
	...
	{		
		...
		?>
            ...
            if($rowselect['servicetype']!='')
            {
              ...
              if($rowselect['dcno']!='')
              {
                $sqlrep2 = "SELECT * From jrcsuppliers where id='".$rowselect['suppliername']."' order by suppliername asc";
...
<div class="col-lg-3">
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="dcdate" name="dcdate"  value="<?=$rowselect['dcdate']?>" readonly>
  </div>
</div>	
<div class="col-lg-3">
  <div class="form-group">
    <label for="suppliername">Supplier Name</label>
    <input type="text" class="form-control" id="suppliername" name="suppliername"  value="
<?php
...
<?=($rowselect['suppliername']==$rowrep['id'])?$rowrep['suppliername']:''?>
<?php
			}
		}
		?>" readonly>
...
<div class="col-lg-3">
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="supwarrantytype" name="supwarrantytype"  value="<?=$rowselect['supwarrantytype']?>" readonly>
  </div>
</div>
<div class="col-lg-3">
  <div class="form-group">
    <label for="supcomplaintno">Complaint No</label>
    <input type="text" class="form-control" id="supcomplaintno" name="supcomplaintno" value="<?=$rowselect['supcomplaintno']?>" readonly>
  </div>
</div>
<div class="col-lg-3">
  <div class="form-group">
    <label for="supcomplaintremarks">Product Remarks</label>
    <input type="text" class="form-control" id="supcomplaintremarks" name="supcomplaintremarks"  value="<?=$rowselect['supcomplaintremarks']?>" readonly> 
  </div>
</div>
<div class="col-lg-3">
  <div class="form-group">
    <label for="supestimatedcost">Estimated Cost</label>
    <input type="number" min="0" step="0.01" class="form-control" id="supestimatedcost" name="supestimatedcost" value="<?=$rowselect['supestimatedcost']?>" readonly>
  </div>
</div>
<div class="col-lg-3">
  <div class="form-group">
    <label for="supcomplaintremarks">Estimated Delivery</label>
    <input type="date" class="form-control" id="supestdelivery" name="supestdelivery"  value="<?=$rowselect['supestdelivery']?>" readonly>
  </div>
</div>
<?php
$status='';
...
<div class="col-lg-3">
  <div class="form-group">
	...
	<input type="text" class="form-control" id="supapprovalstatus" name="supapprovalstatus"  value="<?=$status?>" readonly>
  </div>
</div>
<div class="col-lg-3">
  <div class="form-group">
    <label for="supcustomerremarks">Customer Remarks</label>
    <input type="text" class="form-control" id="supcustomerremarks" name="supcustomerremarks"  value="<?=$rowselect['supcustomerremarks']?>" readonly>
  </div>
</div>
	</div>
	<hr>
	<h5 class="mb-3 text-primary">Received from OEM</h5>
	<div class="row">
<div class="col-lg-3">
  <div class="form-group">
    <label for="suprcourierdate">Courier Date</label>
    <input type="date" class="form-control" id="suprcourierdate" name="suprcourierdate"  value="<?=$rowselect['suprcourierdate']?>">
  </div>
</div>
<div class="col-lg-3">
  <div class="form-group">
    <label for="suprcourierpaytype">Courier Pay Type</label>
	<select class="form-control" id="suprcourierpaytype" name="suprcourierpaytype">
...
<div class="col-lg-3">
  <div class="form-group">
    <label for="suprcouriercharges">Courier Charges</label>
    <input type="number" min="0" step="0.01" class="form-control" id="suprcouriercharges" name="suprcouriercharges"  value="<?=$rowselect['suprcouriercharges']?>">
  </div>
</div>
<div class="col-lg-3">
  <div class="form-group">
    <label for="suprcourierdetails">Courier Remarks</label>
...
<div class="col-lg-3">
<div id="mulitplefileuploader" style="width:100%">Courier Images</div>
<div id="status"></div>
