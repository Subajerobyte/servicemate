...
if(($id!="")&&($val!=""))
	{		
		...
		{	
			...
			$sqlup = "update jrcsubcompany set enabled='$val' where id='$id'";
			...
			{
				mysqli_query($connection, "INSERT INTO jrchistory (user, ipaddress, times, remarks, tid, tablename) VALUES ('{$useremail}', '{$ip}', '{$times}', 'Changed Sub Company Status', '{$id}', 'jrcsubcompany')");
