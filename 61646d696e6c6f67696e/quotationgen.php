...
<div class="d-sm-flex align-items-center justify-content-between mb-1">
            <h1 class="h4 mb-2 mt-2 text-gray-800">Add New Quotation</h1>
          </div>
...
?>
          ...
          <div class="card shadow mb-4">
            <!--div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary"> Add New Quotation</h6>
            </div-->
<div class="card-body">
<div class="row" id="myItems">
 ...
 if(isset($_GET['id']))
 {
	...
	$_SESSION['consigneeid']=$consigneeid;
		$sqlcons = "SELECT address1, phone, mobile, email From jrcconsignee where id='".$consigneeid."' order by consigneename asc";
		...
		{
			$count=1;
			while($rowcons = mysqli_fetch_array($querycons)) 
			{
...
if(!isset($_GET['noofproduts']))
{
	...
	<input type="hidden" name="id" value="<?=$consigneeid?>">
...
else
{
	...
	?>		
<form action="quotationgens.php" method="post" enctype="multipart/form-data">
...
salestotal.value=parseFloat(total).toFixed(2);
		...
		var gstvalue=((total*parseFloat(gst.value))/100).toFixed(2);
