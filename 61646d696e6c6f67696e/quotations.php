...
<div class="row">
  <div class="col">
    <h1 class="h4 mb-2 mt-2 text-black-800 text-center"><b>Quotations <?=$statitle?></b></h1>
  </div>
</div>	
...
<?php 
		...
		$sqlselect = "SELECT engineerid, createdby, qdate, qno, consigneeid, prototal, scrtotal, gratotal, compstatus, changeon, sono, sodate, id,  createdon From jrcquotation ".$staqu." group by qno, qdate order by id desc";
		$queryselect = mysqli_query($connection, $sqlselect);
        $rowCountselect = mysqli_num_rows($queryselect);
