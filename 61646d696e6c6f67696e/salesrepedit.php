...
<head>
  ...
  <title><?=$_SESSION['companyname']?> - Jerobyte - Edit Sales Representative Details</title>
...
<div class="d-sm-flex align-items-center justify-content-between mb-1">
            <h1 class="h4 mb-2 mt-2 text-gray-800">Edit Sales Representative Details</h1>
...
?>
          ...
          <div class="card shadow mb-4">
            <!--<div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Edit Sales Representative Details</h6>
            </div>-->
<div class="card-body">
<?php
if(isset($_GET['id']))
...
$id=mysqli_real_escape_string($connection,$_GET['id']);
				  $sqlselect = "SELECT * From jrcsalesrep where id='".$id."' order by username asc";
        ...
        if($rowCountselect > 0) 
		{
			...
			{
			?>
<form action="salesrepedits.php" onsubmit="return checkvalidate()" method="post" enctype="multipart/form-data">
<input type="hidden" name="id" id="id" value="<?=$id?>">
<div class="row">
<div class="col-lg-3">
  <div class="form-group">
    <label for="salesrepname">Engineer Name</label>
    <input type="text" class="form-control" id="salesrepname" name="salesrepname" value="<?=$rowselect['salesrepname']?>">
  </div>
</div>
<div class="col-lg-3">
    <div class="form-group">
	...
	<option value="SALES REPRESENTATIVE" <?=($rowselect['designation']=='SALES REPRESENTATIVE')?'selected':''?>>SALES REPRESENTATIVE</option>
...
<div class="col-lg-3">
    <div class="form-group">
    <label for="compno">Sales Report No</label>
...
<div class="col-lg-3">
    ...
    <input type="email" class="form-control" id="username" name="username" value="<?=$rowselect['username']?>" readonly>
  </div>
  </div>
   <?php
	if($secsystem=='1')
...
<div class="col-lg-3">
  ...
  <div class="form-group">
	...
	<input type="hidden" id="incentiveper" name="incentiveper" value="<?=$rowselect['incentiveper']?>">
