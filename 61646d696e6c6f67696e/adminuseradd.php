...
<head>
  ...
  <title><?=$_SESSION['companyname']?> - Jerobyte - Add New Administrator</title>
...
<div class="d-sm-flex align-items-center justify-content-between mb-1">
            <h1 class="h4 mb-2 mt-2 text-gray-800">Add New Administrator</h1>
...
?>
          ...
          <div class="card shadow mb-4">
           <!-- <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Add New Administrator</h6>
            </div>-->
<div class="card-body">
<form action="adminuseradds.php" onsubmit="return checkvalidate()" method="post" enctype="multipart/form-data">
<div class="row">
<div class="col-lg-3">
...
<div class="col-lg-3">
	...
	<option value="CALL HANDLING AGENT">CALL HANDLING AGENT</option>
	<option value="CALL CO-ORDINATOR">CALL CO-ORDINATOR</option>
