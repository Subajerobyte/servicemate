...
while($row = mysqli_fetch_array($result)) 
{
	...
	else
	{
		...
		<div class="col-lg-4">
			<div class="card bg-white text-primary shadow-lg" role="button" >
				<div class="card-header py-3">
				  <h6 class="m-0 font-weight-bold text-primary text-center">Call Reports</h6>
				</div>
					...
					<div class="row">
						<div class="col-xl-6 col-md-6 mb-4">
                            <div class="card bg-primary text-white shadow1 card1" role="button"
                                onClick="window.location.href= 'calls.php'" style="height:145px;">
                                <div class="card-statistic-3 p-3">
                                    <div class="row align-items-center  d-flex" style="font-size:14px;">
                                        <div class="col-12 text-center" style="line-height:1.2">
                                            ...
                                            <h5 class="card-title mb-0" style="font-size:0.9rem; font-weight:bold">Received<br>
											<?php
											if(isset($_POST['submit']))
											{
												?>
                                    ...
                                    <div class="row align-items-center  d-flex" style="font-size:14px;">
                                        <div class="col-12 text-center" style="line-height:1.2" >
                                            ...
                                            <h5 class="card-title mb-0" style="font-size:0.9rem; font-weight:bold">Open
                                                Calls - <?=$totalopen?><br>
                                                <span style="font-size:1em;">Total - SC : <?=$totalaopen?> | OC :
                                                    <?=$totaloopen?></span><br> 
                                            </h5>
											
											<span style="font-size:0.75em;">( Today
                                                    - SC : <?=$todayaopen?> | OC : <?=$todayoopen?> )</span>
													<br>
											<span style="font-size:0.75em;">( Old
                                    ...
                                    <div class="row align-items-center  d-flex" style="font-size:14px;">
                                        <div class="col-12 text-center" style="line-height:1.2">
                                            ...
                                            <h5 class="card-title mb-0" style="font-size:0.9rem; font-weight:bold">
                                                Pending Calls - <?=$totaltodaypending?><br>
                                                <span style="font-size:1em;">Total - SC : <?=$totaltodayapending?> | OC :
                                                    <?=$totaltodayopending?></span> <br> 
                                            </h5>
...
<?php
			...
			<div class="card bg-white text-primary shadow-lg" role="button" >
				...
				<div class="card-statistic-3 p-3" style="padding-bottom:0px !important">
					...
					<?php						
						...
						<div class="col-xl-6 col-md-6 mb-4">
                            <div class="card bg-primary text-white shadow1 card1" role="button"
                                onClick="window.location.href= 'callstatus.php?dashfromdate=<?=$dashfromdate?>&dashtodate=<?=$dashtodate?>&submit=submit'" style="height:145px;">
                                <div class="card-statistic-3 p-3">
                                    <div class="row align-items-center  d-flex" style="font-size:14px;">
                                        <div class="col-12 text-center" style="line-height:1.2">
                                            <div class="card-icon card-icon-large mb-2"><i
                                                    class="fas fa-phone fa-2x"></i></div>
                                            <h5 class="card-title mb-0" style="font-size:0.9rem; font-weight:bold">Opening Status<br>
											
												 <span style="font-size:0.8em;">( on <?=date('d/m/Y',strtotime($dashfromdate))?> )</span><br>
                                                <span style="font-size:1em;">Open : <?=$originaloldbalance?> | Pending :
                                                    <?=$originaloldpendingbalance?><br></span>
						...
						<div class="col-xl-6 col-md-6">
							<div class="row">
								<div class="col-xl-12 col-md-12 mb-4">
									<div class="card bg-primary text-white shadow1 card1" role="button"
										onClick="window.location.href= 'callstatus.php?dashfromdate=<?=$dashfromdate?>&dashtodate=<?=$dashtodate?>&submit=submit'" style="height:60px;">
										<div class="card-statistic-3 p-2">
											<div class="row align-items-center  d-flex" style="font-size:14px;">
												<div class="col-12 text-center" style="line-height:1.2">
													<h5 class="card-title mb-0" style="font-size:0.9rem; font-weight:bold">Received Calls<br>
													<span style="font-size:1.3em;"><?=$sumtodaycalls?><br></span>
													</h5>
												</div>
											</div>
										</div>
								...
								<div class="col-xl-12 col-md-12 mb-4">
									<div class="card bg-primary text-white shadow1 card1" role="button"
										...
										<div class="card-statistic-3 p-2">
											<div class="row align-items-center  d-flex" style="font-size:14px;">
												<div class="col-12 text-center" style="line-height:1.2">
													<h5 class="card-title mb-0" style="font-size:0.9rem; font-weight:bold">Pending Calls<br>
													<span style="font-size:1.3em;"><?=$sumtodaypending?><br></span>
													</h5>
												</div>
											</div>
										</div>
						...
						<div class="col-xl-6 col-md-6 mb-4">
                            <div class="card bg-primary text-white shadow1 card1" role="button"
                                ...
                                <div class="card-statistic-3 p-2">
                                    <div class="row align-items-center  d-flex" style="font-size:14px;">
                                        <div class="col-12 text-center" style="line-height:1.2">
                                            <h5 class="card-title mb-0" style="font-size:0.9rem; font-weight:bold">Completed Calls<br>
												<span style="font-size:1.3em;"><?=$sumtodaycompleted?><br></span>
											</h5>
											
											<h5 class="card-title mb-0" style="font-size:0.8rem; font-weight:bold">
											...
											From New Pending - <?=$sumtodaypendingcompleted-$sumtodayveryoldpending?><br>
											</h5>
						...
						<div class="col-xl-6 col-md-6 mb-4">
                            <div class="card bg-primary text-white shadow1 card1" role="button"
                                onClick="window.location.href= 'callstatus.php'" style="height:145px;">
                                <div class="card-statistic-3 p-3">
                                    <div class="row align-items-center  d-flex" style="font-size:14px;">
                                        <div class="col-12 text-center" style="line-height:1.2">
                                            <div class="card-icon card-icon-large mb-2"><i
                                                    class="fas fa-phone fa-2x"></i></div>
                                            <h5 class="card-title mb-0" style="font-size:0.9rem; font-weight:bold">Closing Status<br>
											
												 <span style="font-size:0.8em;">( As on <?=date('d/m/Y',strtotime($dashtodate))?> )</span><br>
                                                <span style="font-size:1em;">Open : <?=$oldbalance?> | Pending :
                                                    <?=$oldpendingbalance?><br></span>
		...
		<div class="card bg-white text-primary shadow-lg" role="button" >
		<div class="card-header py-3">
				  <h6 class="m-0 font-weight-bold text-primary text-center">AMC & WTY</h6>
				</div>
				<div class="card-statistic-3 p-3" style="padding-bottom:0px !important">
				<div class="row">
                        <?php
...
$monthamc++;
	...
	$a=array_unique($a);
		?>
                        ...
                        <div class="col-xl-12 col-md-12 mb-4">
                            <div class="card bg-primary text-white shadow1 card1" role="button"
                                onClick="window.location.href= 'amccustomers.php'" style="height:145px">
                                <div class="card-statistic-3 p-3">
                                    <div class="row align-items-center  d-flex" style="font-size:14px;">
                                        <div class="col-12 text-center">
                                            <div class="card-icon card-icon-large mb-2"><i
                                                    class="fas fa-redo fa-2x"></i></div>
                                            <h5 class="card-title mb-0" style="font-size:0.9rem; line-height:1.5; font-weight:bold">AMC -
                                                <?=count($a)?> <br><span style="font-weight:normal; font-size:0.7rem;">( Products : <?=$totalamc?> )<br> ( Alert 30 :
                                                <?=$monthamc?> )</span></h5>
                                        </div>
                                    </div>
                                </div>
...
$monthwarranty++;
		...
		?>
                        ...
                        <div class="col-xl-12 col-md-12 mb-4">
                            <div class="card bg-primary text-white shadow1 card1" role="button"
                                onClick="window.location.href= 'warrantycustomers.php'" style="height:145px">
                                <div class="card-statistic-3 p-3">
                                    <div class="row align-items-center  d-flex" style="font-size:14px;">
                                        <div class="col-12 text-center">
                                            <div class="card-icon card-icon-large mb-2"><i
                                                    class="fas fa-car-battery fa-2x"></i></div>
                                            <h5 class="card-title mb-0" style="font-size:0.9rem; font-weight:bold; line-height:1.5">WTY -
                                                <?=count($a)?> <br><span style="font-weight:normal; font-size:0.7rem;">( Products : <?=$totalwarranty?> )<br> ( Alert 30 :
                                                <?=$monthwarranty?> )</span></h5>
                                        </div>
                                    </div>
                                </div>
                                <div class="go-corner" href="#">
...
<!--col 2-->
		<div class="col-lg-6">
			<div class="card bg-white text-primary shadow-lg" role="button" >
				<div class="card-header py-3">
				  <h6 class="m-0 font-weight-bold text-primary text-center">Business Alerts</h6>
				</div>
				<div class="card-statistic-3 p-3" style="padding-bottom:0px !important">
					<div class="row">
					<?php
				...
				?>
						...
						<div class="col-xl-4 col-md-4 mb-4" >
                            <div class="card bg-primary text-white shadow1 card1" role="button"
                                onClick="window.location.href= 'alertamcmaintenance.php'">
                                <div class="card-statistic-3 p-3">
                                    <div class="row align-items-center  d-flex" style="font-size:14px;">
                                        <div class="col-12 text-center">
                                            <div class="card-icon card-icon-large mb-2"><i
                                                    class="fas fa-history fa-2x"></i></div>
                                            <h5 class="card-title mb-0" style="font-size:0.9rem; font-weight:bold">AMC<br>Maintanence</h5>
											<h4 style="font-size: 1.3rem; font-weight:bold"><?=$amcmaintenance?></h4>
                                        </div>
                                    </div>
                                </div>
                                <div class="go-corner" href="#">
						...
						<div class="col-xl-4 col-md-4 mb-4" >
                            <div class="card bg-primary text-white shadow1 card1" role="button"
                                onClick="window.location.href= 'alertpreventive.php'">
                                <div class="card-statistic-3 p-3">
                                    <div class="row align-items-center  d-flex" style="font-size:14px;">
                                        <div class="col-12 text-center">
                                            <div class="card-icon card-icon-large mb-2"><i
                                                    class="fas fa-handshake fa-2x"></i> </div>
                                            <h5 class="card-title mb-0" style="font-size:0.9rem; font-weight:bold">Warranty<br>Maintanence</h5>
											<h4 style="font-size: 1.3rem; font-weight:bold"><?=$preventive?></h4>
                                        </div>
                                    </div>
                                </div>
                                <div class="go-corner" href="#">
	  ...
	  $sqlw = "SELECT count(id) as count From jrccalls where actiontaken='WAITING FOR APPROVAL'";
		...
		?>
						<div class="col-xl-4 col-md-4 mb-4" >
                            <div class="card bg-primary text-white shadow1 card1" role="button"
                                onClick="window.location.href= 'wcalls.php'">
                                <div class="card-statistic-3 p-3">
                                    <div class="row align-items-center  d-flex" style="font-size:14px;">
                                        <div class="col-12 text-center">
                                            <div class="card-icon card-icon-large mb-2"><i
                                                    class="fas fa-pause-circle fa-2x"></i> </div>
                                            <h5 class="card-title mb-0" style="font-size:0.9rem; font-weight:bold">Waiting for<br>Approval</h5>
											<h4 style="font-size: 1.3rem; font-weight:bold"><?=$wcount?></h4>
                                        </div>
                                    </div>
                                </div>
                                <div class="go-corner" href="#">
						...
						<div class="col-xl-4 col-md-4 mb-4" >
                            <div class="card bg-primary text-white shadow1 card1" role="button"
                                onClick="window.location.href= 'alertamcexpire.php'">
                                <div class="card-statistic-3 p-3">
                                    <div class="row align-items-center  d-flex" style="font-size:14px;">
                                        <div class="col-12 text-center">
                                            <div class="card-icon card-icon-large mb-2"><i
                                                    class="fas fa-hourglass-end fa-2x"></i> </div>
                                            <h5 class="card-title mb-0" style="font-size:0.9rem; font-weight:bold">AMC<br>Expiry</h5>
											<h4 style="font-size: 1.3rem; font-weight:bold"><?=$amcexpire?></h4>
                                        </div>
                                    </div>
                                </div>
                                <div class="go-corner" href="#">
						...
						<div class="col-xl-4 col-md-4 mb-4" >
                            <div class="card bg-primary text-white shadow1 card1" role="button"
                                onClick="window.location.href= 'alertwarrantyexpire.php'">
                                <div class="card-statistic-3 p-3">
                                    <div class="row align-items-center  d-flex" style="font-size:14px;">
                                        <div class="col-12 text-center">
                                            <div class="card-icon card-icon-large mb-2"><i
                                                    class="fas fa-battery-empty  fa-2x"></i> </div>
                                            <h5 class="card-title mb-0" style="font-size:0.9rem; font-weight:bold">Warranty<br>Expiry</h5>
											<h4 style="font-size: 1.3rem; font-weight:bold"><?=$warrantyexpire?></h4>
                                        </div>
                                    </div>
                                </div>
                                <div class="go-corner" href="#">
						...
						<div class="col-xl-4 col-md-4 mb-4" >
                            <div class="card bg-primary text-white shadow1 card1" role="button"
                                onClick="window.location.href= 'ocalls.php'">
                                <div class="card-statistic-3 p-3">
                                    <div class="row align-items-center  d-flex" style="font-size:14px;">
                                        <div class="col-12 text-center">
                                            <div class="card-icon card-icon-large mb-2"><i
                                                    class="fas fa-stopwatch-20 fa-2x"></i> </div>
                                            <h5 class="card-title mb-0" style="font-size:0.9rem; font-weight:bold">Observation<br>Calls</h5>
											<h4 style="font-size: 1.3rem; font-weight:bold"><?=$ocount?></h4>
                                        </div>
                                    </div>
                                </div>
                                <div class="go-corner" href="#">
...
$monthsparray=array();
$montharray=array();
 $sqli=mysqli_query($connection, "select sum(scharge) as scharge, schargedate, cashstatus from jrccalldetails where srno!='' and scharge!='' and scharge!='0' and scharge!='0.00' and incgst!='2' ".$dashschargesearch." group by schargedate, cashstatus order by cast(schargedate as date) asc");
...
?>
    ...
    var barColors=[<?php foreach ($result1 as $sa){ echo "'#3d8eb9',"; echo "'#cccccc',";}?>];
