...
<head>
  ...
  <title><?=$_SESSION['companyname']?> - Jerobyte - Add New District</title>
...
<div class="d-sm-flex align-items-center justify-content-between mb-1">
            <h1 class="h4 mb-2 mt-2 text-gray-800">Add New District</h1>
...
<div class="card-body">
<form action="districtadds.php" onsubmit="return checkvalidate()" method="post" enctype="multipart/form-data">
<div class="row">
<div class="col-lg-6">
...
<div class="col-lg-6">
  <div class="form-group">
    <label for="district">State</label><span class="text-danger">*</span>
