	...
	<div class="card">
	 ...
	 <div class="row gutters-sm">
		...
		<p class="text-secondary text-center mb-1"><?php
			...
			<span class="badge badge-success" id="amccustomer" style="display:none">AMC Customer</span><br>
			<?php
...
<?php	
			...
			<tr>
			<th rowspan="4" style="width:40px; background-color:#3d8eb9!important; color:#ffffff; text-align:center"><?=$coset?></th>
			<?php 
...
{	
?>
Warranty: <?=$infoselect2['warranty']?> Months <br>
<?php
		...
		?>
                    <tr>
					 ...
					 <?php
					  ...
					  <b>Narration:</b> <span class="text-primary"><?=$rowselect['narration']?>
					  		  </span>
					  <?php
