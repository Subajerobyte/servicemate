...
<head>
  ...
  <title><?=$_SESSION['companyname']?> - Jerobyte - Add New Complaint and Suggestion</title>
...
<div class="d-sm-flex align-items-center justify-content-between mb-1">
            <h1 class="h4 mb-2 mt-2 text-gray-800">Add New Complaint and Suggestion</h1>
...
?>
          ...
          <div class="card shadow mb-4">
            <!--<div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Add New Complaint and Suggestion</h6>
            </div>-->
<div class="card-body">
<form action="helpdeskadds.php" onsubmit="return checkvalidate()" method="post" enctype="multipart/form-data">
<div class="row">
<div class="col-lg-12">
...
$( "#topsearch1" ).autocomplete({
     ...
     $( "#helpdesk" ).autocomplete({
       source: 'helpdesksearch.php?type=helpdesk',
     });
	 $( "#designation" ).autocomplete({
       source: 'helpdesksearch.php?type=designation',
     });
	 $( "#helpdesk" ).autocomplete({
       source: 'Complaint and Suggestionearch.php?type=helpdesk',
     });
  });
</script>
