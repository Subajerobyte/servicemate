...
<head>
  ...
  <title>Warranty Expired Customers | Jerobyte - Warranty Expired Customers</title>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
           <!-- <a href="warrantycustomersall.php" class="m-2 d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-list fa-sm text-white-50"></i> View All Warranty Customers</a>
			<a href="warrantycustomersexpired.php" class="m-2 d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-list fa-sm text-white-50"></i> View Warranty Expired Customers</a>-->
        
		  
		  
		  <div class="row">
  <div class="col">
    <h1 class="h4 mb-2 mt-2 text-black-800 text-center"><b>Warranty Expired Customers</b></h1>
  </div>
</div>
		  <?php
