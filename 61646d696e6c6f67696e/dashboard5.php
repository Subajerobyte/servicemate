          ...
          <div class="card-content">
            <div class="card-body">
              <div class="media d-flex">
				...
				<a href="calls.php?status=0"><span  class="font-weight-bold" style="color:<?=$jerobytecolors[$ad];?>; font-size:1.0rem; line-height:1; text-decoration:underline;">Received Calls</span></a>
                  <?php
											if(isset($_POST['submit']))
											{
												?><h3><?=$totalcalls?></h3>
              ...
              <div class="media d-flex">
                ...
                <div class="media-body text-center">
                   <a href="calls.php?status=2"><span  class="font-weight-bold" style="color:<?=$jerobytecolors[$ad];?>; font-size:1.0rem; line-height:1; text-decoration:underline;">Completed Calls</span></a>
                                            ...
                                            <span style="font-size:1em;">SC : <?=$totaltodayacomplete?> | OC : <?=$totaltodayocomplete?></span><br>
          ...
          <div class="card-content">
            <div class="card-body">
              <div class="media d-flex">
                ...
                <div class="media-body text-center">
				<a href="wcalls.php"><span class="font-weight-bold" style="color:<?=$jerobytecolors[$ad];?>; font-size:1.0rem; line-height:1; text-decoration:underline;">Waiting for Approval</span></a>
                  <h3><?=$wcount?></h3>                  
                </div>
              </div>
            </div>
