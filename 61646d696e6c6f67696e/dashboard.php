         ...
         <div class="card cardnew2 shadow radius-10 border-start border-0 border-3 border-color1">
            <div class="card-body" style="padding-right:0.2rem">
			   <div class="d-flex1 align-items-center text-center">
				...
				<p style="text-align: center; line-height:normal;"><a href="report.php"><span  class="mb-0 text-dark"><b>Analytical Reports</b></span></a></p>
         ...
         <div class="card cardnew2 shadow radius-10 border-start border-0 border-3 border-color2">
            <div class="card-body" style="padding-right:0.2rem">
			   <div class="d-flex1 align-items-center text-center">
				...
				<p style="text-align: center;line-height:normal;"><a href="quotationnew3.php"><span  class="mb-0 text-dark"><b>New Quotation</b></span></a></p>
            ...
            <div class="card-body" style="padding-right:0.2rem">
			   <div class="d-flex align-items-center">
				...
				if(($liveplan=='DIAMOND'))
				{
                  ...
                  <h4 class="mb-2 text-pink1"><?=$preventive?></h4> 
            ...
            <div class="card-body" style="padding-right:0.2rem">
			   <div class="d-flex align-items-center">
				...
				if(($liveplan=='DIAMOND'))
				{
					...
					<h4 class="my-1 text-green2"><?=$amcmaintenance?></h4>
                  <?php
				}
				else
				{
...
<div class="col-lg-3 mb-4">
			<div class="card shadow cardb" role="button" >
				...
				<?php
				$today=date('Y-m-d');
				$next90day=date('Y-m-d',strtotime('+2 months'));
				//date('Y-m-t', strtotime('+2 months'));
				$tobewarrantyexpire=0;
			
				$tobeamcexpire=0;
	$sqlselect = "SELECT count(id) as count, remindertype From jrcreminder where enabled='0'  and (enddate between '$today' and '$next90day') group by remindertype order by remindertype asc";
				$queryselect = mysqli_query($connection, $sqlselect);
				$rowCountselect = mysqli_num_rows($queryselect);
				if(!$queryselect){
				   die("SQL query failed: " . mysqli_error($connection));
				...
				if($rowCountselect > 0) 
				{
					...
					while($rowselect = mysqli_fetch_array($queryselect)) 
					{
						...
						if($rowselect['remindertype']=='WARRANTY EXPIRE')
						{
							$tobewarrantyexpire=(float)$rowselect['count'];
						}
						
						if($rowselect['remindertype']=='AMC EXPIRE')
						{
							$tobeamcexpire=(float)$rowselect['count'];
						}
					}
				}
				?>
         ...
         <div class="card cardnew1 shadow radius-10 border-start border-0 border-3 border-danger1">
            <div class="card-body" style="padding-right:0.2rem">
			   <div class="d-flex align-items-center" id="myDiv1">
				...
				<h4 class="my-1 text-danger1"><?=$tobewarrantyexpire?></h4>
				</div>
				<div class="widgets-icons-danger1 ms-auto" >
            ...
            <div class="card-body" style="padding-right:0.2rem">
			   <div class="d-flex align-items-center" id="myDiv4">
				<div>
				  ...
				  <h4 class="my-1 text-danger2"><?=$tobeamcexpire?></h4>
				</div>
				<div class="widgets-icons-danger2 ms-auto" >
		<i class="bx bxs-layer-minus"></i>
		</div>
...
?>
	<?php  ?>	
	  ...
	  <?php
		//  $sqlw1 = "SELECT count(enddate) as count From jrcreminder where remindertype='PRODUCT LIFETIME EXPIRE '".$sour."  order by DATE(enddate) asc";
		
		$dateFrom = date('Y-m-01');
$dateTo = date('Y-m-t', strtotime('+2 months'));
   $sqlw1 = "SELECT count(enddate) as count FROM jrcreminder WHERE remindertype='PRODUCT LIFETIME EXPIRE' and (enddate between '$dateFrom' and '$dateTo') ORDER BY DATE(enddate) ASC";

	 
	  $queryw1 = mysqli_query($connection, $sqlw1);
$rowCountw1 = mysqli_fetch_array($queryw1);
$wcount1=(float)$rowCountw1['count'];
	  ...
	  <div class="col-xl-6 col-sm-6 mb-4 col-6"> 
		...
		<div>
				...
				<h4 class="my-1 text-warning2"><?=$wcount1?></h4>
...
<!--- customer and engineer -->
		...
		$sqlcall = "SELECT engineerid,engineersid,calltype, compstatus, callon, changeon, servicetype,diagnosisby From jrccalls ".$dashcallonsearch." order by id desc";
		$querycall = mysqli_query($connection, $sqlcall);
        $rowCountcall = mysqli_num_rows($querycall);
        ...
        if($rowCountcall > 0) 
		{
			...
			while($rowcall = mysqli_fetch_array($querycall)) 
			{
				...
				if($rowcall['servicetype']=='Carry-In')
				{
					...
					if($rowcall['diagnosisby']=='awaiting')
					{
						$iatotalcalls++;
					}
				}
...
<div class="card shadow cardb" role="button">
				<div class="card-header py-2">
				  <h6 style="color:#04121f" class="m-0 text-center"><b>Carry-In Call Progress</b></h6>
				</div>
				<div class="card-statistic-3 p-3" style="padding-bottom:0px !important">		
				<div class="row">
   ...
   <div class="col-xl-3 col-sm-6 mb-3 col-6"> 
         <div class="card cardnew1 shadow radius-10 border-start border-0 border-3 border-info1">
            <div class="card-body" style="padding-right:0.2rem">
			   <div class="d-flex align-items-center">
                ...
                <?php if(isset($_POST['submit'])) {  ?>
				<h4 class="my-1 text-info1 text-center" style="font-size:1.5em;"><?=$itotalcalls?></h4>
                                                <!--span style="font-size:1.1em;">SC : <?//=$itotalacalls?> <br> OC :
                                                    <?//=$itotalocalls?><br></span-->
				<?php } else { ?>
				<h4 class="my-1 text-info1 text-center" style="font-size:1.5em;"><?=$itodaycalls?></h4>
	  ...
	  <div class="col-xl-3 col-sm-6 mb-3 col-6"> 
         <div class="card cardnew1 shadow radius-10 border-start border-0 border-3 border-info1">
            <div class="card-body" style="padding-right:0.2rem">
			   <div class="d-flex align-items-center">
				<div>
				<a href="inhousecalls.php?call=received"><span  class="mb-0 text-dark"><b>Awaiting Calls</b></span></a>
                <?php if(isset($_POST['submit'])) {  ?>
				<h4 class="my-1 text-info1 text-center" style="font-size:1.5em;"><?=$iatotalcalls?></h4>
                                                <!--span style="font-size:1.1em;">SC : <?//=$itotalacalls?> <br> OC :
                                                    <?//=$itotalocalls?><br></span-->
				<?php } else { ?>
				<h4 class="my-1 text-info1 text-center" style="font-size:1.5em;"><?=$iatodaycalls?></h4>
                </div>  
				<!--<div class="widgets-icons-info1 ms-auto" >
				<i class="bx bxs-phone-incoming"></i>
				</div>	-->			
            ...
            <div class="card-body" style="padding-right:0.2rem">
			   <div class="d-flex align-items-center">
				...
				<a href="inhousecalls.php?call=assinged"><span  class="mb-0 text-dark"><b>Assigned Calls</b></span></a>
                  <?php if(isset($_POST['submit'])) { ?>
				  <h4 class="my-1 text-danger1 text-center" style="font-size:1.5em;"><?=$itotalassigned?></h4>
                                                 <!--span style="font-size:1.1em;">SC : <?//=$itotalaassigned?> <br> OC :
                                                    <?//=$itotaloassigned?><br></span-->
					<?php } else { 	?>
					<h4 class="my-1 text-danger1 text-center" style="font-size:1.5em;"><?=$itodayassigned?></h4>
												<?php
												if(($liveplan=='GOLD')||($liveplan=='DIAMOND'))
												{
													?>												
      ...
      <div class="col-xl-3 col-sm-6 mb-3 col-6"> 
         <div class="card cardnew1 shadow radius-10 border-start border-0 border-3 border-warning1">
            <div class="card-body" style="padding-right:0.2rem">
			   <div class="d-flex align-items-center" id="myDivopen">
				<div>
                  <a href="inhousecalls.php?status=0"><span  class="mb-0 text-dark"><b>Open Calls</b></span></a>
				   <h4 class="my-1 text-warning1 text-center" style="font-size:1.5em;"><?=$itotalopen?></h4>
				   
				   
				   <div class="row">
				<div class="col-12 text-center">
				<span  class="mb-0 text-dark "><b>Inhouse</b></span>-<span  class="mb-0 text-warning1"><?=$carryingodownopen?></span>
				</div>
				<div class="col-12 text-center">
				<span  class="mb-0 text-dark "><b>OEM</b></span>-<span  class="mb-0 text-warning1"><?=$carryinoemopen?></span>
				</div>
				</div>
				  </div> 
				 <!-- <div class="widgets-icons-warning1 ms-auto" >
		<i class="bx bxs-phone"></i>
					...
					<?php
					 ...
					 <span class="tooltipopen callouts--top">				
					...
					<div class="row">
												<div class="col-6">
													<h6 class="text-warning1 mt-3 mb-1">Inhouse</h6>
													<?php 
										echo $carryingodownopen;  ?> </div>
													<div class="col-6">
													<h6 class="text-warning1 mt-3 mb-1">OEM</h6>
													<span style="font-size:1em;"><?=$carryinoemopen?> </span>
													</div>
													</div>
													</span>
												<?php
     ...
     <div class="col-xl-3 col-sm-6 mb-3 col-6"> 
         <div class="card cardnew1 shadow radius-10 border-start border-0 border-3 border-info2">
            <div class="card-body" style="padding-right:0.2rem">
			   <div class="d-flex align-items-center" id="myDivpend">
			  <div>
                  <a href="inhousecalls.php?status=1"><span  class="mb-0 text-dark"><b>Pending Calls</b></span></a>
				  <h4 class="my-1 text-info2 text-center" style="font-size:1.5em;"><?=$itotaltodaypending?></h4>   
				 
				 
				 <div class="row">
				<div class="col-12 text-center">
				<span  class="mb-0 text-dark "><b>Inhouse</b></span>-<span  class="mb-0 text-info2"><?=$carryingodownpend?></span>
				</div>
				<div class="col-12 text-center">
				<span  class="mb-0 text-dark "><b>OEM</b></span>-<span  class="mb-0 text-info2"><?=$carryinoempend?></span>
				</div>
				</div>
				</div>
				 <!--<div class="widgets-icons-info2 ms-auto" >
		<i class="bx bxs-file-find"></i>
					...
					<!--span style="font-size:1em;">SC : <?//=$itotaltodayapending?> <br> OC : <?//=$itotaltodayopending?></span> <br--> 
					 <span class="tooltippend callouts--top">
					<span style="font-size:1em;"><b>Today :</b>  <?php echo $today=$itodayapending+$itodayopending; ?> </span><br>
					<span style="font-size:1em;"><b>Old :</b> <?php echo $old=$ioldapending+$ioldopending; ?> </span><br>
					
					<div class="row">
												<div class="col-6">
													<h6 class="text-info2 mt-3 mb-1">Inhouse</h6>
													<?php 
										echo $carryingodownpend;  ?> </div>
													<div class="col-6">
													<h6 class="text-info2 mt-3 mb-1">OEM</h6>
													<span style="font-size:1em;"><?=$carryinoempend?> </span>
													</div>
													</div></span>
					<?php
												}
     ...
     <div class="col-xl-3 col-sm-6 mb-3 col-6"> 
         <div class="card cardnew1 shadow radius-10 border-start border-0 border-3 border-danger2">
            <div class="card-body" style="padding-right:0.2rem">
			   <div class="d-flex align-items-center" id="myDivcomp">
			<div>
                   <a href="inhousecalls.php?status=2&lform=dashboard"><span class="mb-0 text-dark"><b>Completed Calls</b></span></a>
				   <?php if(isset($_POST['submit'])) { ?>	
					<h4 class="my-1 text-danger2 text-center" style="font-size:1.5em;""><?=$itotalcomplete?></h4>
                                                <!--span style="font-size:1.1em;">SC : <?//=$itotalacomplete?> <br> OC : <?//=$itotalocomplete?></span-->
                    <?php } else { ?> 
					<h4 class="my-1 text-danger2 text-center" style="font-size:1.5em;"><?=$itotaltodaycomplete?></h4>
					<?php } ?>
					
					
					<div class="row">
				<div class="col-12 text-center">
				<span  class="mb-0 text-dark "><b>Inhouse</b></span>-<span  class="mb-0 text-danger2" ><?=$carryingodowncomp?></span>
				</div>
				<div class="col-12 text-center">
				<span  class="mb-0 text-dark "><b>OEM</b></span>-<span  class="mb-0 text-danger2" ><?=$carryinoemcomp?></span>
				</div>
				</div>
            </div>
			<!--<div class="widgets-icons-danger2 ms-auto" >
		<i class="bx bxs-badge-check"></i>
												...
												if(($liveplan=='GOLD')||($liveplan=='DIAMOND'))
												{
													?>
											<!--span style="font-size:1em;">SC : <?//=$itotaltodayacomplete?> <br>OC : <?//=$itotaltodayocomplete?></span><br-->
											<span class="tooltipcomp callouts--top">
											<span style="font-size:1em;"><b>Today :</b> <?php echo $today=$itodayacomplete+$itodayocomplete; ?> </span><br>
											<span style="font-size:1em;"><b>Old :</b> <?php echo $old=$ioldacomplete+$ioldocomplete; ?> </span> <br>
					
					<div class="row">
												<div class="col-6">
													<h6 class="text-danger2 mt-3 mb-1">Inhouse</h6>
													<?=$carryingodowncomp;  ?> </div>
													<div class="col-6">
													<h6 class="text-danger2 mt-3 mb-1">OEM</h6>
													<span style="font-size:1em;"><?=$carryinoemcomp?> </span>
													</div>
													</div></span>
											<?php
												}
         ...
         <div class="card cardnew1 shadow radius-10 border-start border-0 border-3 border-warning2">
            <div class="card-body" style="padding-right:0.2rem">
			   <div class="d-flex align-items-center" id="myDivdeli">
				<div>
                   <a href="inhousecalls.php?status=2&lform=dashboard"><span  class="mb-0 text-dark"><b>Delivered Calls</b></span></a>
				 <?php if(isset($_POST['submit'])) { ?>	
												 <h4 class="my-1 text-warning2 text-center" style="font-size:1.5em;"><?=$itotalcomplete?></h3>
                                                <!--span style="font-size:1.1em;">SC : <?//=$itotalacancel?> <br> OC : <?//=$itotalocancel?></span><br-->
                                          	<?php } else { ?> 
											 <h4 class="my-1 text-warning2 text-center" style="font-size:1.5em;"><?=$itotaltodaycomplete?></h4>
                                            <?php } ?>
				...
				<div class="col-12 text-center">
				<?php $reconsite=$otodayacalls+$otodayocalls; ?>
				<span  class="mb-0 text-dark "><b>Inhouse</b></span>-<span  class="mb-0 text-warning2"><?=$carryingodowncomp?></span>
				</div>
				<div class="col-12 text-center">
				<?php $reccarryin=$itodayacalls+$itodayocalls; ?>
				<span  class="mb-0 text-dark "><b>OEM</b></span>-<span  class="mb-0 text-warning2"><?=$carryinoemcomp?></span>
				</div>
				</div>
		...
		<?php
												if(($liveplan=='GOLD')||($liveplan=='DIAMOND'))
												{
													?>
											<!--span style="font-size:1em;">SC : <?//=$itotaltodayacancel?> <br> OC : <?//=$itotaltodayocancel?></span><br-->
											<span class="tooltipdeli callouts--top">
											<span style="font-size:1em;"><b>Today :</b> <?php echo $today=$itodayacancel+$itodayocancel; ?> </span><br>
											<span style="font-size:1em;"><b>Old :</b> <?php echo $old=$ioldacancel+$ioldocancel; ?></span><br>
					
					<div class="row">
												<div class="col-6">
													<h6 class="text-warning2 mt-3 mb-1">Inhouse</h6>
													<?php 
										echo $carryingodowncomp;  ?> </div>
													<div class="col-6">
													<h6 class="text-warning2 mt-3 mb-1">OEM</h6>
													<span style="font-size:1em;"><?=$carryinoemcomp?> </span>
													</div>
													</div></span>
											<?php
		 ...
		 <div class="col-xl-3 col-sm-6 mb-3 col-6"> 
         <div class="card cardnew1 shadow radius-10 border-start border-0 border-3 border-warning2">
			   <div class="d-flex align-items-center" id="myDivawait">
            <div class="card-body" style="padding-right:0.2rem">
				<div>
                   <a href="#"><span  class="mb-0 text-dark"><b>Awaiting Confirmation</b></span></a>
				 <?php if(isset($_POST['submit'])) { ?>	
												 <h4 class="my-1 text-warning2 text-center" style="font-size:1.5em;"><?=$itotalcancel?></h3>
                                                <!--span style="font-size:1.1em;">SC : <?//=$itotalacancel?> <br> OC : <?//=$itotalocancel?></span><br-->
                                          	<?php } else { ?> 
											 <h4 class="my-1 text-warning2 text-center" style="font-size:1.5em;"><?=$itotaltodaycancel?></h4>
                                            <?php } ?>
				...
				<div class="col-12 text-center">
				<?php $reconsite=$otodayacalls+$otodayocalls; ?>
				<span  class="mb-0 text-dark "><b>Inhouse</b></span>-<span  class="mb-0 text-info1"><?=$reconsite?></span>
				</div>
				<div class="col-12 text-center">
				<?php $reccarryin=$itodayacalls+$itodayocalls; ?>
				<span  class="mb-0 text-dark "><b>OEM</b></span>-<span  class="mb-0 text-info1"><?=$reccarryin?></span>
				</div>
				</div>-->
		...
		<?php
												if(($liveplan=='GOLD')||($liveplan=='DIAMOND'))
												{
													?>
											<!--span style="font-size:1em;">SC : <?//=$itotaltodayacancel?> <br> OC : <?//=$itotaltodayocancel?></span><br-->
											<!--<span class="tooltipawait callouts--top">
											<span style="font-size:1em;"><b>Today :</b> <?php echo $today=$itodayacancel+$itodayocancel; ?> </span><br>
											<span style="font-size:1em;"><b>Old :</b> <?php echo $old=$ioldacancel+$ioldocancel; ?></span><br>
					
					<div class="row">
												<div class="col-6">
													<h6 class="text-info1 mt-3 mb-1">Inhouse</h6>
													<?php 
										echo $carryingodownopen;  ?> </div>
													<div class="col-6">
													<h6 class="text-info1 mt-3 mb-1">OEM</h6>
													<span style="font-size:1em;"><?=$carryinoemopen?> </span>
													</div>
													</div></span>-->
											<?php
...
<div class="col-lg-6 mb-3">
	...
	<div class="col-xl-6 col-sm-6 mb-3 col-6"> 
         <div class="card cardnew1 shadow radius-10 border-start border-0 border-3 border-info1">
            <div class="card-body" style="padding-right:0.2rem">
			   <div class="d-flex align-items-center" id="myDivopsts">
				<div>
				...
				<span class="mb-0 text-dark"><b>Opening<br>Status</b></span></a>
                                               ...
                                               <h4 class="my-1 text-info1" style="font-size:1.5em;"><?=$originaloldbalance?></h4>
													</div>
				<div class="widgets-icons-info1 ms-auto" >
		<i class="bx bxs-lock-open-alt"></i>
				...
				<span class="tooltipopsts callouts--top">
      ...
      <div class="col-xl-6 col-sm-6 mb-3 col-6"> 
         <div class="card cardnew1 shadow radius-10 border-start border-0 border-3 border-danger1">
            <div class="card-body" style="padding-right:0.2rem">
			   <div class="d-flex align-items-center" id="myDivdp">
				<div>
		...
		<span class="tooltipdp callouts--top"><h6 class="mb-2 text-danger1">Received : <?=$sumtodaycalls?><br> Pending : <?=$sumtodaypending?>
     ...
     <div class="col-xl-6 col-sm-6 mb-3 col-6"> 
         <div class="card cardnew1 shadow radius-10 border-start border-0 border-3 border-info2">
            <div class="card-body" style="padding-right:0.2rem">
			   <div class="d-flex align-items-center" id="myDivcc">
				<div>
		...
		<i class="bx bxs-badge-check"></i>
                    ...
                    <span class="tooltipcc callouts--top"><span style="font-size:1em;">
                    From Old Open - <?=$sumtodayveryoldcompleted?><br>
					From New Open - <?=($sumtodayoldcompleted+$sumtodaynewcompleted)-$sumtodayveryoldcompleted?><br>
					From Old Pending - <?=$sumtodayveryoldpending?><br>
      ...
      <div class="col-xl-6 col-sm-6 mb-3 col-6"> 
         <div class="card cardnew1 shadow radius-10 border-start border-0 border-3 border-danger2">
            <div class="card-body" style="padding-right:0.2rem">
			   <div class="d-flex align-items-center" id="myDivclsts">
				<div>
		...
		<i class="bx bxs-lock-alt"></i>
				...
				<span class="tooltipclsts callouts--top"> <h6 class="mb-2 text-danger2">Open : <?=$oldbalance?> <br> Pending : <?=$oldpendingbalance?></h6><span style="font-size:1em;">( As on <?=date('d/m/Y',strtotime($dashtodate))?> )</span></span>
      </div>
         ...
         <div class="card cardnew1 shadow radius-10 border-start border-0 border-3 border-info1">
            <div class="card-body" style="padding-right:0.2rem">
			   <div class="d-flex align-items-center" id="myDiv">
				...
				<h4 class="mb-2 text-info1"><?=count($a)?></h4>
...
$monthamc++;
            ...
            <div class="card-body" style="padding-right:0.2rem">
			   ...
			   <div>
                   <a href="amccustomers.php"><span  class="mb-0 text-dark"><b>AMC Customers</b></span></a>
				    <h4 class="mb-2 text-info2"><?=count($a)?></h4>
				   </div>
				<div class="widgets-icons-info2 ms-auto" >
		<i class="bx bx-check"></i>
		</div>
            ...
            <div class="card-body" style="padding-right:0.2rem">
			   ...
			   <div>
                  <a href="warrantycustomersexpired.php"><span  class="mb-0 text-dark"><b>Warrranty Expired Customers</b></span></a>
				   <h4 class="mb-2 text-success1"><?=$warrantyexpire?></h4> 
				   </div>
   ...
   <div class="col-xl-4 col-sm-6 mb-4 col-6"> 
            ...
            <div class="card-body" style="padding-right:0.2rem">
			   <div class="d-flex align-items-center" id="myDiv5">
				<div>
				  ...
				  <h4 class="mb-2 text-success2"><?=$amcexpire?></h4> 
				</div>
				<div class="widgets-icons-success2 ms-auto" >
		<i class="bx bx-notification"></i>
		</div>
	   ...
	   <?php
		 $sqlselect = "SELECT count(id) as id From jrcconsignee order by id desc";
            ...
            <div class="card-body" style="padding-right:0.2rem">
			   <div class="d-flex align-items-center" id="myDiv5">
				<div>
				  ...
				  <h4 class="mb-2 text-danger1"><?=$customer?></h4> 
				</div>
				<div class="widgets-icons-danger1 ms-auto" >
		<i class="bx bx-notification"></i>
		</div>
...
<div class="col-lg-4 mb-4">
 ...
 </div><div class="widgets-icons-info2 ms-auto" >
     ...
     $totalWithCalltidPerEngineer = number_format(($rowEngineer['total_with_calltid_per_engineer']/$rowEngineer['total_per_engineer'])*100,2);
		...
		<div class="col-lg-2">
            ...
            <div class="card shadow cardb mb-4">
				...
				{
					?>
					    <marquee width="100%" direction="up" height="178px" scrollamount="3" onmouseover="this.stop();"
                        onMouseOut="this.start();">
                        <ul class="todo-list ui-sortable drag-me">
                            <?php
...
<script>
    const combinedData = {
        labels: ['Service', 'AMC', 'Carry-In'],
        datasets: [{
            label: 'Total Amount',
		    data: [<?= $totalServiceRevenue ?>, <?= $totalAMCRevenue ?>, <?= $totalCarryInRevenue ?>],
            backgroundColor: '<?=$_SESSION['bgcolor']?>',
            borderColor: '<?=$_SESSION['bgcolor']?>',
            borderWidth: 1
        }, {
            label: 'Collected Amount',
            data: [<?= $collectedServiceRevenue ?>, <?= $collectedAMCRevenue ?>,  <?= $collectedCarryInRevenue ?>],
            backgroundColor: '<?=$_SESSION['lightbgcolor']?>',
            borderColor: '<?=$_SESSION['lightbgcolor']?>',
            borderWidth: 1
        }, {
            label: 'To be Collected Amount',
            data: [<?= $toBeCollectedServiceRevenue ?>, <?= $toBeCollectedAMCRevenue ?>, <?= $toBeCollectedCarryInRevenue ?>],
