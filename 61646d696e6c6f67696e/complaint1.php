...
<body id="page-top" onload="customerchange();modechange();mmodechange(1);gstamount(1);totalcalc();totalamount(1)">
  <div id="wrapper">
...
?>
  ...
  <div class="row mb-1">
    ...
    <div class="col-6">
      <label><input type="radio" name="incgst" id="incgst" value="0" <?=($rowcon4>0)?(($infocon4['incgst']=='0')?'checked':''):''?> onClick="return modechange();mmodechange(1);gstamount(1);totalcalc();totalamount(1)"> Included GST</label> <label><input type="radio" name="incgst" id="excgst" value="1" <?=($rowcon4>0)?(($infocon4['incgst']=='1')?'checked':''):'checked'?> onClick="return modechange();mmodechange(1);gstamount(1);totalcalc();totalamount(1)"> Excluded GST</label> <label><input type="radio" name="incgst" id="nogst" value="2" <?=($rowcon4>0)?(($infocon4['incgst']=='2')?'checked':''):''?> onClick="return modechange();mmodechange(1);gstamount(1);totalcalc();totalamount(1)"> Estimation</label>
    </div>
  </div>  
  <hr>
  <!-- spares div started-->
  <div id="materialdiv">
 <h6><b>Material 1</b></h6>
  <div class="row mb-1">
		 <div class="col-6">
		  <label for="smaterial1" class="col-form-label">Material</label>
		</div>
		<div class="col-6">
		<select class="form-control fav_clr" id="smaterial1" name="smaterial1" onChange="getpro(1)">
	<option value="">Select</option>
	<?php
	$sqlspares = "SELECT id, maincategory, subcategory  From jrcspares order by maincategory asc";
			...
			if($rowCountspares > 0) 
			{
				...
				{
					?>
	<option value="<?=$rowspares['id']?>" <?=($rowcon4>0)?(($infocon4['smaterial1']==$rowspares['id'])?"selected":""):""?>><?=preg_replace("/'/","",$rowspares['maincategory'])?> - <?=preg_replace("/'/","",$rowspares['subcategory'])?></option>
	<?php
				}
			}
			?>
	  ...
	  <div class="row mb-1">
		 <div class="col-6">
		  <label for="sprice1" class="col-form-label">Price</label>
		</div>
		<div class="col-6">
		  <input type="number" min="0" class="form-control" name="sprice1" id="sprice1" value="<?=($rowcon4>0)?$infocon4['sprice1']:''?>" onchange="totalamount(1)" step="0.01" readonly>
	  ...
	  <div class="row mb-1">
		 ...
		 <div class="col-6">
		  <label for="squantity1" class="col-form-label">Quantity</label>
		</div>
		<div class="col-6">
		  <input type="number" min="0" class="form-control" name="squantity1" id="squantity1" value="<?=($rowcon4>0)?$infocon4['squantity1']:''?>" onChange="totalamount(1)" step="0.01">
		</div>
	  </div>
	  <div class="row mb-1">
		 <div class="col-6">
		  <label for="stotal1" class="col-form-label">Total</label>
		</div>
		<div class="col-6">
		  <input type="number" min="0" class="form-control" name="stotal1" id="stotal1" value="<?=($rowcon4>0)?$infocon4['stotal1']:''?>" onChange="totalamount(1);netamt()"  readonly step="0.01">
		</div>
	  </div>  
	  <div class="row mb-1">
     <div class="col-2">
      <label for="sgstper1" class="col-form-label">GST</label>
    </div>
	<div class="col-4">
	<input type="number" min="0" class="form-control" name="sgstper1" id="sgstper1" readonly value="<?=($rowcon4>0)?$infocon4['sgstper1']:''?>" onChange="totalamount(1)"  step="0.01">
    </div>
    <div class="col-6">
      <input type="number" min="0" class="form-control" name="sgstpervalue1" id="sgstpervalue1" readonly value="<?=($rowcon4>0)?$infocon4['sgstpervalue1']:''?>" onChange="netamt()"    step="0.01" >
    </div>
 </div>  
 <div class="row mb-1">
		 <div class="col-6">
		  <label for="schargepre1" class="col-form-label">Total Amount</label>
		</div>
		<div class="col-6">
		  <input type="number" min="0" class="form-control" name="schargepre1" id="schargepre1" value="<?=($rowcon4>0)?$infocon4['schargepre1']:''?>" onChange="gstamount(1)"  readonly step="0.01">
		</div>
</div>
  <?php $loading=1;?>
  <?php
if($rowcon4>0)
{
  for($i=2;$i<=5;$i++)
  {
	 if($infocon4['smaterial'.$i]!='' && $infocon4['smaterial'.$i]!='NULL')
	{  
  ?>
 <h6><b>Material <?=$i?></b></h6>
  <div class="row mb-1">
		 <div class="col-6">
		  <label for="smaterial<?=$i?>" class="col-form-label">Material</label>
		</div>
		<div class="col-6">
		<select class="form-control fav_clr" id="smaterial<?=$i?>" name="smaterial<?=$i?>" onChange="getpro(<?=$i?>);gstamount(<?=$i?>)">
	<option value="">Select</option>
	<?php
	$sqlspares = "SELECT id, maincategory, subcategory  From jrcspares order by maincategory asc";
			$queryspares = mysqli_query($connection, $sqlspares);
	...
	<?php
		  ...
		  <input type="hidden" name="spareid<?=$i?>" id="spareid<?=$i?>" value="<?=$rowspares['id']?>">
		</div>
	  </div> 
	  <div class="row mb-1">
		 <div class="col-6">
		  <label for="sprice<?=$i?>" class="col-form-label">Price</label>
		</div>
		<div class="col-6">
		  <input type="number" min="0" class="form-control" name="sprice<?=$i?>" id="sprice<?=$i?>" value="<?=($rowcon4>0)?$infocon4['sprice'.$i]:''?>"  onChange="totalamount(<?=$i?>)"  step="0.01" readonly>
		</div>
	  </div>
	  <div class="row mb-1">
		 <div class="col-6">
		  <label for="squantity<?=$i?>" class="col-form-label">Quantity</label>
		</div>
		<div class="col-6">
		  <input type="number" min="0" class="form-control" name="squantity<?=$i?>" id="squantity<?=$i?>" value="<?=($rowcon4>0)?$infocon4['squantity'.$i]:''?>" onChange="totalamount(<?=$i?>)" step="0.01">
		</div>
	  </div>
	  <div class="row mb-1">
		 <div class="col-6">
		  <label for="stotal<?=$i?>" class="col-form-label">Total</label>
		</div>
		<div class="col-6">
		  <input type="number" min="0" class="form-control" name="stotal<?=$i?>" id="stotal<?=$i?>" value="<?=($rowcon4>0)?$infocon4['stotal'.$i]:''?>" onChange="totalamount(<?=$i?>);netamt(<?=$i?>)"  readonly step="0.01">
		</div>
	  </div>  
	  <div class="row mb-1">
     <div class="col-2">
      <label for="sgstper<?=$i?>" class="col-form-label">GST</label>
    </div>
	<div class="col-4">
	<input type="number" min="0" class="form-control" name="sgstper<?=$i?>" id="sgstper<?=$i?>" readonly value="<?=($rowcon4>0)?$infocon4['sgstper'.$i]:''?>" onChange="totalamount(<?=$i?>)"  step="0.01">
    </div>
    <div class="col-6">
      <input type="number" min="0" class="form-control" name="sgstpervalue<?=$i?>" id="sgstpervalue<?=$i?>" readonly value="<?=($rowcon4>0)?$infocon4['sgstpervalue'.$i]:''?>" onChange="gstamount(<?=$i?>);netamt()"  onClick="gstamount(<?=$i?>)"  step="0.01" >
    </div>
 </div>  
 <div class="row mb-1">
		 <div class="col-6">
		  <label for="schargepre<?=$i?>" class="col-form-label">Total Amount</label>
		</div>
		<div class="col-6">
		  <input type="number" min="0" class="form-control" name="schargepre<?=$i?>" id="schargepre<?=$i?>" value="<?=($rowcon4>0)?$infocon4['schargepre'.$i]:''?>" onChange="gstamount(<?=$i?>)"  readonly step="0.01">
		</div>
</div>
<?php
    $loading=$i;
...
<div class="form-group">
<a id="btn2" class="btn btn-primary">Add New</a>
</div>
</div>
</div>
  <!-- spares div ended-->
...
$("#sparesrequired2").trigger("change");
 ...
 <script>
$(document).ready(function(){
$("#smaterial1").change(function(){
var smaterial1=$("#smaterial1").val();
if(smaterial1=="")
{
$("#sprice1").val('');
$("#sgstper1").val('');
...
$("#spareid1").val(dataarray[0].trim());
$("#sprice1").val(dataarray[1]);
$("#sgstper1").val(dataarray[2]);
spriceIn(1);
netamt();
});
}
...
if(inc <= 5)
{
var htm="<h6><b>Material "+inc+"</b></h6> <div class='row mb-1'> <div class='col-6'> <label for='smaterial"+inc+"' class='col-form-label'>Material</label> </div> <div class='col-6'> <select class='form-control fav_clr' id='smaterial"+inc+"' name='smaterial"+inc+"' onChange='getpro("+inc+")'> <option value=''>Select</option>"; <?php $sqlspares = 'SELECT * From jrcspares  order by maincategory asc'; $queryspares = mysqli_query($connection, $sqlspares); $rowCountselect = mysqli_num_rows($queryspares); while($rowspares = mysqli_fetch_array($queryspares)) { ?>
htm+='<option value="<?=$rowspares['id']?>" ><?=preg_replace("/'/","",$rowspares['maincategory'])?> - <?=preg_replace("/'/","",$rowspares['subcategory'])?></option>';
<?php  } ?>
htm+="</select>  <input type='hidden' name='spareid"+inc+"' id='spareid"+inc+"' > </div> </div> <div class='row mb-1'> <div class='col-6'> <label for='sprice"+inc+"' class='col-form-label'>Price</label> </div> <div class='col-6'> <input type='number' min='0' class='form-control' name='sprice"+inc+"' id='sprice"+inc+"'   onChange='totalamount("+inc+");gstamount("+inc+")'  step='0.01' value='' readonly> </div> </div>  <div class='row mb-1'> <div class='col-6'> <label for='squantity"+inc+"' class='col-form-label'>Quantity</label> </div> <div class='col-6'> <input type='number' min='0' class='form-control' name='squantity"+inc+"' id='squantity"+inc+"' value='' onChange='totalamount("+inc+");gstamount("+inc+")' step='0.01'> </div> </div> <div class='row mb-1'> <div class='col-6'> <label for='stotal"+inc+"' class='col-form-label'>Total</label> </div> <div class='col-6'> <input type='number' min='0' class='form-control' name='stotal"+inc+"' id='stotal"+inc+"' value='' onChange='totalamount("+inc+");netamt();gstamount("+inc+")'  readonly step='0.01'> </div> </div> <div class='row mb-1'> <div class='col-2'> <label for='sgstper"+inc+"' class='col-form-label'>GST</label> </div> <div class='col-4'> <input type='number' min='0' class='form-control' name='sgstper"+inc+"' id='sgstper"+inc+"' readonly value='' onChange='gstamount("+inc+");totalamount("+inc+")'  step='0.01'> </div> <div class='col-6'> <input type='number' min='0' class='form-control' name='sgstpervalue"+inc+"' id='sgstpervalue"+inc+"' readonly value='' onChange='gstamount("+inc+");netamt()'   step='0.01' > </div> </div> <div class='row mb-1'> <div class='col-6'> <label for='schargepre"+inc+"' class='col-form-label'>Total Amount</label> </div> <div class='col-6'> <input type='number' min='0' class='form-control' name='schargepre"+inc+"' id='schargepre"+inc+"' value='' onChange='gstamount("+inc+")'  readonly step='0.01'> </div> </div> ";
$("#materialdiv").append(htm);
}
