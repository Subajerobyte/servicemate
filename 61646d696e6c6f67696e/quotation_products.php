...
if(isset($_POST['proid']))
{
	...
	$sqlselect2 = "SELECT id, stockmaincategory, stocksubcategory, stockitem, typeofproduct, componenttype, componentname, make, capacity, warranty, description, price, minprice, gst, scrapvalue, amcvalue, amcgst, installvalue,gsttype From jrcproduct where id='$id' order by stockitem asc";
	$queryselect2 = mysqli_query($connection, $sqlselect2);
	$infoselect2=mysqli_fetch_array($queryselect2);
