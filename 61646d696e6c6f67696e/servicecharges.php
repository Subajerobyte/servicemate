      ...
      <div id="content">
        ...
        <div class="container-fluid">
          <!-- Page Heading -->
		    ...
		    <div class="row">
  <div class="col">
    <h1 class="h4 mb-2 mt-2 text-black-800 text-center"><b>Service Charges</b></h1>
  </div>
</div>
...
?> <?php
	...
	?>
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
<form action="servicecharges.php" method="post">
<div class="row">
...
<div class="col-lg-3">
  <div class="form-group">
	...
	<option value=" " <?=(isset($_POST['cashstatus'])&&($_POST['cashstatus']==''))?'selected':' '?>>Select</option>
				<option value="0" <?=((isset($_POST['cashstatus'])&&($_POST['cashstatus']=='0'))||(  isset($_GET['ty']) && $_GET['ty']=='0') )?'selected':''?>>Pending</option>
				<option value="2" <?=((isset($_POST['cashstatus'])&&($_POST['cashstatus']=='2'))||( isset($_GET['ty']) && $_GET['ty']=='2'))?'selected':''?>>Cancelled</option>
				<option value="1"<?=((isset($_POST['cashstatus'])&&($_POST['cashstatus']=='1'))||( isset($_GET['ty']) && $_GET['ty']=='1'))?'selected':''?> >Received</option>
...
<div class="col-lg-3">
  <div class="form-group">
    <label for="tallystatus">Tally Status</label>
	<select class="fav_clr form-control" name="tallystatus" id="tallystatus">
	<option value=" " <?=(isset($_POST['tallystatus'])&&($_POST['tallystatus']==''))?'selected':' '?>>Select</option>
				<option value="0" <?=(isset($_POST['tallystatus'])&&($_POST['tallystatus']=='0'))?'selected':' '?>>Pending</option>
				<option value="1"<?=(isset($_POST['tallystatus'])&&($_POST['tallystatus']=='1'))?'selected':' '?> >Updated</option>
	...
	if(($_GET['datefrom'])&&($_GET['dateto']))
				{
					if($staqu!="")
					{
						$staqu.=" and t1.schargedate BETWEEN '".$_GET['datefrom']."' AND '".$_GET['dateto']."'";
					}
					else
					{
						$staqu.=" and t1.schargedate BETWEEN '".$_GET['datefrom']."' AND '".$_GET['dateto']."'";
				...
				if(isset($_GET['ty']))
			{
				$subquer="";
					...
					if($subquer=="")
					{
						$subquer.=" (t1.cashstatus='".$_GET['ty']."' )";
					}
					else
						{
						$subquer.=" or (t1.cashstatus='".$_GET['ty']."')";
					}
			...
			if(isset($_POST['cashstatus']))
			{
				$subquer="";
					...
					if($subquer=="")
					{
						$subquer.=" (t1.cashstatus='".$_POST['cashstatus']."' )";
					}
					else
						{
						$subquer.=" or (t1.cashstatus='".$_POST['cashstatus']."')";
					}
			...
			if(isset($_POST['tallystatus']))
			{
				$subquer="";
			
					if($subquer=="")
					{
						$subquer.=" (t1.tallystatus='".$_POST['tallystatus']."' )";
					}
					else
						{
						$subquer.=" or (t1.tallystatus='".$_POST['tallystatus']."')";
					}
...
$monthsarray=array();
$montharray=array();
 $sqli=mysqli_query($connection,  "select t1.scharge, t1.schargedate from jrccalldetails t1, jrccalls t2 where t1.calltid=t2.calltid and t1.scharge!='0.00' and t1.scharge!='0' and t1.scharge!='' and t1.scharge is not null ".$staqu." group by t1.schargedate order by cast(t1.schargedate as date) asc, t1.cashstatus asc");
 while($infoi=mysqli_fetch_array($sqli))
 {
