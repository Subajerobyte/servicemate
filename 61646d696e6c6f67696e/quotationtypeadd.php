...
<head>
  ...
  <title><?=$_SESSION['companyname']?> - Jerobyte - Add New Quotation Type</title>
...
<div class="d-sm-flex align-items-center justify-content-between mb-1">
            <h1 class="h4 mb-2 mt-2 text-gray-800">Add New Quotation Type</h1>
...
<div class="card-body">
<form action="quotationtypeadds.php" onsubmit="return checkvalidate()" method="post" enctype="multipart/form-data">
<div class="row">
<div class="col-lg-12">
  <div class="form-group">
    <label for="quotationtype">Quotation Name</label>
    <input type="text" class="form-control" id="quotationtype" name="quotationtype"  required>
  </div>
</div>
<div class="col-lg-12">
	<div class="form-group">
	...
	<option value="">Select</option>
	 <?php
        ...
        if($rowCountprotype > 0) 
		{
			...
			{
			?>
			<option value="<?=$rowprotype['id']?>"><?=$rowprotype['stockitem']?></option>
			<?php
			}
		}
			?>
