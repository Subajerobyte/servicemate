...
<body id="page-top">
  ...
  <?php include('consigneenavbar.php');?>
        ...
        <div class="container-fluid">
		   ...
		   <div class="row">
  <div class="col">
    <h1 class="h4 mb-2 mt-2 text-black-800 text-center" ><b>Customer Details</b></h1>
  </div>
            ...
            <div class="card-body">
              ...
              <div class="table-responsive">
                <table class="table table-bordered font-13" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <tbody>
				  <?php
				  $sqlselect = "SELECT id, consigneename, phone, district, totalbalanceamount From jrcconsignee order by id desc";
