            ...
            <div class="card-body">
			  <div class="table-responsive">
                <table class="table table-bordered font-13" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <tbody>
				  <?php
	 $sqlcomp = "SELECT calltid, srno From jrccalldetails where reassign='0' and (srno!='' and srno is not null) order by id desc";
		...
		{
			$count=1;
			while($rowcomp = mysqli_fetch_array($querycomp)) 
			{
			
				
				  $sqlselect = "SELECT sourceid, callon, calltid, compstatus, changeon, callhandlingid, callhandlingname, coordinatorid, coordinatorname, engineerid, engineername, businesstype, servicetype, customernature, callnature, id From jrccalls where calltid='{$rowcomp['calltid']}' order by id desc";
        ...
        if($rowCountselect > 0) 
		{
			...
			{
					echo '<br>'.$rowcomp['calltid'].'-'.$rowselect['sourceid'];
				/* 
