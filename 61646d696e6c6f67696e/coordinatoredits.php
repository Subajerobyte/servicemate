...
if(isset($_POST['submit']))
{
  ...
  if (isset($_POST['submit'])) {
	...
	if(($coordinatornamevalue!="")||($designationvalue!="")||($usernamevalue!=""))
	{		
		...
		{	
			...
			{
				mysqli_query($connection, "INSERT INTO jrchistory (user, ipaddress, times, remarks, tid) VALUES ('{$useremail}', '{$ip}', '{$times}', 'Updated Call Co-ordinator Details', '{$id}')");
