...
<input type="text" class="form-control" id="buyername" name="buyername" maxlength="100" required onchange="triggerSameass()">
...
<input type="text" class="form-control" id="maincategory" name="maincategory" onchange="triggerSameass()">
</div>
</div>
...
<input type="text" class="form-control" id="tender" name="tender" onchange="triggerSameass()">
</div>
</div>
...
<input type="text" class="form-control" id="subcategory" name="subcategory" onchange="triggerSameass()">
</div>
</div>
...
<input type="text" class="form-control" id="department" name="department" onchange="triggerSameass()">
</div>
</div>
...
<input type="text" class="form-control" id="buyeraddress1" name="buyeraddress1" required maxlength="100" onchange="triggerSameass()">
</div>
</div>
...
<input type="text" class="form-control" id="buyeraddress2" name="buyeraddress2" onchange="triggerSameass()">
</div>
</div>
...
<input type="text" class="form-control" id="buyeraddress3" name="buyeraddress3" onchange="triggerSameass()">
</div>
</div>
...
<input type="text" class="form-control" id="buyertaluk" name="buyertaluk" onchange="triggerSameass()">
</div>
</div>
</div>
<div class="col-lg-6">
...
<input type="text" class="form-control" id="buyerdistrict" name="buyerdistrict" required maxlength="50" onchange="triggerSameass()">
</div>
</div>
...
<input type="text" class="form-control" id="buyerpincode" name="buyerpincode" maxlength="6" inputmode="numeric" required onchange="triggerSameass()">
</div>
</div>
...
<div class="form-group" id="gstinField">
  <div class="input-container">
    ...
    <input type="text" class="form-control" id="bgst" name="bgst" maxlength="15" required onchange="triggerSameass()">
  </div>
</div>
...
<input type="text" class="form-control" id="buyerstate" name="buyerstate" value="33 - TN - Tamil Nadu"  required onchange="triggerSameass()">
...
<input type="text" class="form-control" id="buyermobile" name="buyermobile" maxlength="10" inputmode="numeric" onchange="triggerSameass()">
</div>
</div>
...
<input type="text" class="form-control" id="buyerphone" name="buyerphone" maxlength="11" inputmode="numeric" onchange="triggerSameass()">
</div>
</div>
...
<input type="text" class="form-control" id="buyercontact" name="buyercontact" onchange="triggerSameass()">
</div>
</div>
...
<input type="text" class="form-control" id="buyermail" name="buyermail" maxlength="320" required onchange="triggerSameass()">
</div>
</div>
...
<select class="form-control fav_clr" id="rtype" name="rtype" onchange="triggerSameass()">
...
<label for="sameas" class="text-danger text-center"><input type="checkbox" id="sameas" name="sameas" onchange="sameass()" checked> Customer Address Same as Buyer Address</label>
</div>
  </div>
  </div>
  </div>
...
<div class="col-lg-4" id="consignment_<?php echo $i; ?>_consignee_<?php echo $j; ?>" style="display:none">
...
<script>
function triggerSameass() {
    var sameAsCheckbox = document.getElementById('sameas');
