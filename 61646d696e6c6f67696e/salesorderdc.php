...
.footer21::before  {
   ...
   <style>
        ...
        button {
            display: block; /* Ensures the button is displayed on its own line */
        }

        /* Define the media query for printing */
        @media print {
            button {
                display: inline-block; /* Ensures the button is displayed when printing */
            }
        }
    </style>
</head>
	  ...
	  function getIndianCurrency($number)
{
    ...
    <div class="header">
					 <table style="border:1px solid #8c8c8c">
						  ...
						  <tr>
						  <td colspan="5" align="center"><p class="heading" style="font-size:28px; padding:1px;">DELIVERY CHALLAN</p></td>
						  </tr>
						  </table>
						  <table border="1" style="border:1px solid #8c8c8c">
						  <tr>
						  <th style="text-align:center; padding:2px;">Delivery Challan No.</th>
						  <th style="text-align:center; padding:2px;">Dated</th>
						  <th style="text-align:center; padding:2px;">Reference No. & Date</th>
						  <th style="text-align:center; padding:2px;" colspan="2">Buyer’s Order No. & Dated</th>
						  </tr>
						  <tr>
						  ...
						  <td style="text-align:center; vertical-align:top; padding:2px;" colspan="2"><?=$rowselect[0]['pono']?> & <?=date('d-m-Y',strtotime($rowselect[0]['podate']))?></td>
						  </tr>
						  ...
						  <td style="text-align:center; vertical-align:top; padding:2px;">Con :-<b><?=$rowselect[0]['consigneeno']?></b></td>
						  </tr>
						  </table>
						  <table border="1" style="border:1px solid #8c8c8c">
						  <tr>
						 ...
						 <p style="margin-left:20px;"><strong><?=$rowselect[0]['consigneename']?></strong><br><?php if($rowselect[0]['conaddress1']!='') { echo $rowselect[0]['conaddress1'];}?> <?php if($rowselect[0]['conaddress2']!=''){ echo $rowselect[0]['conaddress2'];}?> <?php if($rowselect[0]['conaddress3']!=''){echo $rowselect[0]['conaddress3'];}?><?if($rowselect[0]['contaluk']!=''){echo $rowselect[0]['contaluk'].'&nbsp;';}?><?php if($rowselect[0]['condistrict']!=''){ echo $rowselect[0]['condistrict'].' - ';}?><?php if($rowselect[0]['conpincode']!=''){ echo $rowselect[0]['conpincode'];}?>
						  <b><br><?php if($rowselect[0]['congstno']!=''){?>GSTIN:</b> <?php  if($rowselect[0]['congstno']!='') {echo $rowselect[0]['congstno']; if($rowselect[0]['conmobile']!=''){ echo ', Mobile : ' .$rowselect[0]['conmobile'];}} else {echo 'Unregistered';  if($rowselect[0]['constatecode']!=''){?>Code / State Name:</b> <?=$rowselect[0]['constatecode']?> &nbsp;<?php if($rowselect[0]['conmobile']!=''){ echo ', Mobile : ' .$rowselect[0]['conmobile'];}}} } ?>
						  </p></td>
						 
						  <td align="left"> <b>Buyer (Bill to)</b>
						  <p style="margin-left:20px;"><strong><?=$rowselect[0]['buyername']?></strong><br><?php if($rowselect[0]['buyeraddress1']!=''){ echo $rowselect[0]['buyeraddress1'];}?> <?php if($rowselect[0]['buyeraddress2']!=''){ echo $rowselect[0]['buyeraddress2'];}?> <?php if($rowselect[0]['buyeraddress3']!=''){ echo $rowselect[0]['buyeraddress3'];}?><?php if($rowselect[0]['buyertaluk']!=''){echo $rowselect[0]['buyertaluk'].'<br>';}?><?php if($rowselect[0]['buyerdistrict']!=''){ echo $rowselect[0]['buyerdistrict'].' - ';}?><?php if($rowselect[0]['buyerpincode']!=''){ echo $rowselect[0]['buyerpincode'];}?><br>
  ...
  <div class="body-content">
						  ...
						  <b><?=$row1['conproductcode']?> -&nbsp;<?=$row1['conproduct']?> &nbsp; ( <?php 
							if($row1['conmake']!='' && $row1['conpromodel']==''){ 
							?> 
								Make:<?= $row1['conmake']; } 
							if($row1['conpromodel']=='' && $row1['conpromodel']!=''){ 
							?> 
						  ...
						  if($row1['componenttype']!='' && $row1['componentname']!=''){	 
						  echo $row1['componenttype'];?> : <?=$row1['componentname']; ?>&nbsp;<?php } ?> </b>
						  <i><font size="-1">Make:<?=$row1['conmake']?> &nbsp; Capacity:<?=$row1['concapacity']?> &nbsp;Warranty:<?=$row1['conwarranty']?>M &nbsp; Qty:<?=$row1['conunitqty']?></font></i>
						  <?php
						  $qty = $row1['conqty'] * $row1['conunitqty'];
						if ($qty < 16) {
							echo '<br>';
							echo 'Sl No:</font></i>';
							if ($row1['conserialno'] != '') {
						...
						?></td>
						  ...
						  <tr>
						  <td></td>
						  <td style="text-align:right; vertical-align:top; font-size:15px;"><?php if($row1['conigst']!='') {?><b>TOTAL OUTPUT IGST</b><?php } else {?> <b>TOTAL OUTPUT CGST</b> <br> <b>TOTAL OUTPUT SGST</b><?php }?></td>
						  <?php
						  if(!$allZero) 
						  {
						  ?>
						  ...
						  ?>
						  <td style="text-align:right; vertical-align:top;"><?php if($row1['conigst']!='') { echo number_format(((float)$totaligst),2,'.',','); ?><br><?php }else { echo number_format(((float)$totalcgst),2,'.',','); ?><br><?php echo number_format(((float)$totalsgst),2,'.',','); ?><?php }?></td>
						  </tr>
						  <tr>
						  <td></td>
						  <td style="text-align:right; vertical-align:top;"><?php if($row1['conigst']!='') {?><?php  if($rowselect[0]['buyback']!=''){  ?> <br><b>Buyback</b><?php } if($rowselect[0]['lessamount']!=''){ ?><br><b>Rounded Off</b><?php }}else {?> <?php if($rowselect[0]['lessamount']!=''){ ?> <b>Rounded Off</b><?php } if($rowselect[0]['buyback']!=''){ ?> <b>Buyback</b> (<?php echo $rowselect[0]['buyremark']; ?>) <?php  }}?></td>
						  <?php
						  if(!$allZero) 
						  {
						  ?>
						  ...
						  <td></td>
						  <td></td>
						  <td style="text-align:right; vertical-align:top;"><?php if($row1['conigst']!='') { ?><?php if($rowselect[0]['lessamount']!=''){ ?> <br><?php echo '(-)' . number_format(((float)$rowselect[0]['lessamount']), 2, '.', ',') ; ?><?php }}else { ?><?php  if($rowselect[0]['lessamount']!=''){ ?><?php echo '(-)' . number_format(((float)$rowselect[0]['lessamount']), 2, '.', ',').'<br>' ; }?><?php  if($rowselect[0]['buyback']!=''){ ?><?php echo '(-)' . number_format(((float)$rowselect[0]['buyback']), 2, '.', ',') ; }}?></td>
						  </tr>
						  ...
						  ?>
						   ...
						   <td></td>
						   <?php
						   if($rowselect[0]['lessamount']=='')
						   {
							   $rowselect[0]['lessamount']='0';
						   }
						   ...
						   if($row1['conigst']!='') 
						   {
							   $gtotal=$total+$totaligst-$rowselect[0]['lessamount']-$rowselect[0]['buyback'];
						   }
						   else
						   {
							   $gtotal=$total+$totalcgst+$totalsgst-$rowselect[0]['lessamount']-$rowselect[0]['buyback'];
						   }
						   ?>
						  ...
						  <tr>
						  <td>
						  <span class="float-left"><i>Amount Chargeable (in words) : </i>  <b><?=ucwords(getIndianCurrency((float)$gtotal))?> Only</b></span>
						   </td>
						   <td colspan="5">
...
<tr>
    ...
    <td style="text-align:right;"><b><?php echo number_format($taxgstamount, 2, '.', ','); ?></b></td>
						  ...
						  <tr>
						  <td align="left">
						  <b>Remarks:</b> I/We certify that to the best of my / our knowladge the particular are true,correct and complete. ("PLS ASK FOR VALID DATED ID CARDS OF JRC ENGINEERS BEFORE TAKING THE MATERIALS FOR SERVICE & FOR NEW SALES")
						  </td>
						 </tr>
						 </table>
						  <table border="1" style="border:1px solid #8c8c8c">
						  ...
						  <font size="3px">
							<table width="100%">
							  <tr>
								 <td align="left" width="60%" style="vertical-align:bottom">
								  <b>
								  Company's Bank Details</b><br>
						  ...
						  <tr>
						  <td colspan="3" align="center"><font size="-1">SUBJECT TO TRICHY JURISDICTION.(This is a Computer Generated Document.)</font></td>
						  </tr>
						  </table>	
					  	</div>  
...
<!-- serialnumber-->
						  ...
						  <table border="1" style="border:1px solid #8c8c8c">
						  <tr>
						  <td colspan="5" align="center"><p class="heading" style="font-size:28px; padding:1px;">DELIVERY CHALLAN</p><span style="font-size:15px; padding:15px;">(FORMJJDeliveryNote(SeeRule15(3),15(18),15(19),15(20),15(21)ForSales/StockTransfer/WorkContract/Labour)</span></td>
						  </tr>
						  </table>
						  <table border="1" style="border:1px solid #8c8c8c">
						  <tr>
						  ...
						  <td style="text-align:center; vertical-align:top; padding:2px;"></td>
						  <td style="text-align:center; vertical-align:top; padding:2px;">Con :-<?=$rowselect[0]['consigneeno']?></td>
						  <td style="text-align:center; vertical-align:top; padding:2px; font-size:17px;"><?=(($rowselect[0]['pono']!='') && ($rowselect[0]['podate']!=''))?$rowselect[0]['pono'].'&'.(date('d-m-Y',strtotime($rowselect[0]['podate']))):(($rowselect[0]['pono']!='')?$rowselect[0]['pono']:(date('d-m-Y',strtotime($rowselect[0]['podate']))))?></td>
						  </tr>
						  </table>	  
 <?php
