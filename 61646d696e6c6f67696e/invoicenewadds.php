...
if(($infocompany1['encsystem']=='1')||($infocompany1['encsystem']=='2'))
{
	...
	{	
				...
				$sqlup = "INSERT INTO jrcxl(encstatus, file_name, upload_time, invoiceno, invoicedate, tenderno,claimsubon,claimper,claimamt,invoiceamt,installrefno,suprefno, pono, podate, dcno, dcdate, installedon, installedby, maincategory, subcategory, consigneename, department, address1, address2, area, district, pincode, contact, phone, mobile, email, stockmaincategory, stocksubcategory, stockitem, invoicedqty, overallwarranty, typeofproduct, componenttype, componentname, make, capacity, warranty, qty, serialnumber) VALUES ('$encstatus', '$fileName', '$upload_time', '$invoiceno', '$invoicedate', '$tenderno','$claimsubon','$claimper','$claimamt','$invoiceamt','$installrefno','$suprefno' ,'$pono', '$podate', '$dcno', '$dcdate', '$installedon', '$installedby', '$maincategory', '$subcategory', '$consigneename', '$department', '$address1', '$address2', '$area', '$district', '$pincode', '$contact', '$phone', '$mobile', '$email', '$stockmaincategory', '$stocksubcategory', '$stockitem', '$invoicedqty', '$overallwarranty', '$typeofproduct', '$componenttype', '$componentname', '$make', '$capacity', '$warranty', '$qty', '$serialnumber')";
        ...
        mysqli_query($connection, "INSERT INTO jrchistory (user, ipaddress, times, remarks, tid, tablename) VALUES ('{$useremail}', '{$ip}', '{$times}', 'Invoice Added', '{$sourceid}', 'jrcxl') ");
       header("Location: invoicenewadd.php?id={$mainid}&remarks=Added Successfully");
    } else {
