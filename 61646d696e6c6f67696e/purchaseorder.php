...
<head>
  ...
  <title><?=$_SESSION['companyname']?> - Jerobyte - Purchase Order Details</title>
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
		   ...
		   <div class="row">
  <div class="col">
    <h1 class="h4 mb-2 mt-2 text-black-800 text-center"><b>Purchase Order Details</b></h1>
  </div>
  <div class="col-auto">
    <a href="purchaseadd.php" class="m-2 btn btn-sm btn-primary shadow-sm"><i class="fas fa-plus fa-sm text-white-50"></i> Add New Purchase Order</a>
  </div>
</div>
...
?>
			...
			<?php 
              ...
              <div class="table-responsive">
                <table class="table table-bordered font-13" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <tbody>
				  <?php 
				  $sqlselect = "SELECT * From jrcpurchase group by sono order by sodate desc ";
        ...
        if($rowCountselect > 0) 
		{
            ...
            <tr>
            <td><?=$count?></td>
            <td><b>PO Number :</b> <?=$rowselect['sono']?> <br> <b>PO Date :</b> <?=date('d/m/Y',strtotime($rowselect['sodate']))?></td></td>
