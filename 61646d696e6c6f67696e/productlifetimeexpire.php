...
<title><?=$_SESSION['companyname']?> - Jerobyte - Product Lifetime Expiry Alert</title>
...
<div class="row">
<div class="col">
<h1 class="h4 mb-2 mt-2 text-black-800 text-center"><b>Product Lifetime Expiry Alert</b></h1>
</div>
</div>
<?php
...
<th>S.No</th>
<th>Generated On</th>
<th>Product Lifetime Expire Alert</th>
...
<tbody>
<?php
$sqlselect = "SELECT sourceid, createdon, reminder, enddate, status, id, enabled From jrcreminder where remindertype='PRODUCT LIFETIME EXPIRE '".$sour." ".$staqu1." order by DATE(enddate) asc";
$queryselect = mysqli_query($connection, $sqlselect);
$rowCountselect = mysqli_num_rows($queryselect);
if(!$queryselect){
die("SQL query failed: " . mysqli_error($connection));
