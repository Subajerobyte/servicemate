...
<head>
  ...
  <title><?=$_SESSION['companyname']?> - Jerobyte - Add New Stock</title>
...
<div class="d-sm-flex align-items-center justify-content-between mb-1">
            <h1 class="h4 mb-2 mt-2 text-gray-800">Add New Stock</h1>
...
<div class="card-body">
<form action="stockadds.php" method="post">
<div class="row">
<div class="col-lg-6">
  <div class="form-group">
    <label for="stockmaincategory">Main Category</label>
    <input type="text" class="form-control" id="stockmaincategory" name="stockmaincategory" placeholder="Main Category">
  </div>
</div>
<div class="col-lg-6">
    <div class="form-group">
    <label for="stocksubcategory">Sub Category</label>
    <input type="text" class="form-control" id="stocksubcategory" name="stocksubcategory" placeholder="Sub Category">
  </div>
  </div>
  </div>
  <div class="row">
<div class="col-lg-12">
    ...
    <input type="text" class="form-control" id="stockitem" name="stockitem" placeholder="Product Name">
  </div>
  </div>
    </div>
...
<?php include('additionaljs.php');   ?>s
</body>
