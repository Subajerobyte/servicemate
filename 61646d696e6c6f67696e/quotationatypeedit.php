...
<head>
  ...
  <title><?=$_SESSION['companyname']?> - Jerobyte - Edit AMC & CAMC Quotation Settings</title>
...
<!--<div class="d-sm-flex align-items-center justify-content-between mb-2">
            <h1 class="h4 mb-0 text-gray-800"> Edit AMC & CAMC Quotation Settings</h1>
                      </div>-->
					  
					  
					   <div class="row">
  <div class="col">
    <h1 class="h4 mb-2 mt-2 text-black-800 text-center" ><b>Edit AMC & CAMC Quotation Settings</b></h1>
  </div>
<div class="col-auto" style=" text-align: right;">
    <a href="quotationatype.php" class="m-2 d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-list fa-sm text-white-50"></i> View All AMC & CAMC Quotation Type Details</a>
</div>
</div>	
...
$id=mysqli_real_escape_string($connection,$_GET['id']);
				  $sqlselect = "SELECT quotationtype, subject, contentmessage, terms, aterms, stockitem  From jrcamcquotationtype where id='".$id."' order by quotationtype asc";
        ...
        if($rowCountselect > 0) 
		{
			...
			{
			?>
<form action="quotationatypeedits.php" onsubmit="return checkvalidate()" method="post" enctype="multipart/form-data">
...
<div class="col-lg-6">
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="quotationtype" name="quotationtype" required value="<?=$rowselect['quotationtype']?>" readonly>
  </div>
</div>
<div class="col-lg-6">
  <div class="form-group">
...
<div class="col-lg-6">
	<div class="form-group">
		<label for="aterms">Additional Terms and Conditions</label>
			<textarea id="aterms" name="aterms" rows="6"><?php if($rowCountselect > 0) { echo $rowselect['aterms']; } ?></textarea>
	</div>	
</div>
