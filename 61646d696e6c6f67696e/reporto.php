...
<body id="page-top">
  ...
  <div class="row">
  <div class="col">
    <h1 class="h4 mb-2 mt-2 text-black-800 text-center"><b>Calls Report</b></h1>
  </div>
</div>
		  <?php
...
<div class="col-lg-3">
  <div class="form-group">
	...
	<select class="form-control js_select2" name="compstatus[]" id="compstatus" multiple="multiple">
	<?php
	...
	sort($uniquereportedproblem);
			foreach($uniquereportedproblem as $urep) 
			{
				...
				{
					?>
				<option value="<?=$urep?>"  <?=((isset($_POST['compstatus']))&&(in_array($urep, $_POST['compstatus'])))?'selected':''?> data-badge="">Open</option>
				<?php
				}
				if($urep=='1')
				{
					?>
				<option value="<?=$urep?>" <?=((isset($_POST['compstatus']))&&(in_array($urep, $_POST['compstatus'])))?'selected':''?> data-badge="">Pending</option>
				<?php
				}
				if($urep=='2')
				{
					?>
				<option value="<?=$urep?>" <?=((isset($_POST['compstatus']))&&(in_array($urep, $_POST['compstatus'])))?'selected':''?> data-badge="">Completed</option>
				<?php
				}
...
<div class="col-lg-3">
  <div class="form-group">
	...
	<select class="form-control js_select2" name="businesstype[]" id="businesstype" multiple="multiple">
	<?php
	if((isset($new_array))&&(is_array($new_array)))
	{
	...
	sort($uniquecalltype);
			foreach($uniquecalltype as $urep) 
			{
				...
				?>
				<option value="<?=$urep?>" <?=((isset($_POST['businesstype']))&&(in_array($urep, $_POST['businesstype'])))?'selected':''?>><?=$urep?></option>
				<?php
			}
	}
	?>
...
<div class="col-lg-3">
  <div class="form-group">
	...
	<select class="js_select2 form-control" name="servicetype[]" id="servicetype" multiple="multiple">
	<?php
	if((isset($new_array))&&(is_array($new_array)))
	{
		
	$uniquecalltype = array_unique(array_map(function ($i) { return $i['servicetype']; }, $new_array));
	sort($uniquecalltype);
			foreach($uniquecalltype as $urep) 
			{
				
				?>
				<option value="<?=$urep?>" <?=((isset($_POST['servicetype']))&&(in_array($urep, $_POST['servicetype'])))?'selected':''?>><?=$urep?></option>
				<?php
			}
	}
	?>
...
<div class="col-lg-3">
  <div class="form-group">
	...
	<select class="js_select2 form-control" name="callnature[]" id="callnature" multiple="multiple">
	<?php
	if((isset($new_array))&&(is_array($new_array)))
	{
...
<div class="col-lg-3">
  <div class="form-group">
	...
	<select class="js_select2 form-control" name="customernature[]" id="customernature" multiple="multiple">
	<?php
	if((isset($new_array))&&(is_array($new_array)))
	{
	...
	sort($uniquecalltype);
			foreach($uniquecalltype as $urep) 
			{
				...
				?>
				<option value="<?=$urep?>" <?=((isset($_POST['customernature']))&&(in_array($urep, $_POST['customernature'])))?'selected':''?>><?=$urep?></option>
				<?php
			}
	}
	?>
...
<div class="col-lg-3">
  <div class="form-group">
	...
	<select class="js_select2 form-control" name="calltype[]" id="calltype" multiple="multiple">
	<?php
	if((isset($new_array))&&(is_array($new_array)))
	{
	...
	sort($uniquecalltype);
			foreach($uniquecalltype as $urep) 
			{
				...
				?>
				<option value="<?=$urep?>" <?=((isset($_POST['calltype']))&&(in_array($urep, $_POST['calltype'])))?'selected':''?>><?=$urep?></option>
				<?php
			}
	}
	?>
...
<div class="col-lg-3">
  <div class="form-group">
	...
	<select class="js_select2 form-control" name="calltid[]" id="calltid" multiple="multiple">
	<?php
	if((isset($new_array))&&(is_array($new_array)))
	{
	...
	sort($uniquecalltid);
			foreach($uniquecalltid as $urep) 
			{
				...
				?>
				<option value="<?=$urep?>" <?=((isset($_POST['calltid']))&&(in_array($urep, $_POST['calltid'])))?'selected':''?>><?=$urep?></option>
				<?php
			}
	}
	?>
...
<div class="col-lg-3">
  <div class="form-group">
	...
	<select class="js_select2 form-control" name="callhandlingname[]" id="callhandlingname" multiple="multiple">
	<?php
	if((isset($new_array))&&(is_array($new_array)))
	{
...
<div class="col-lg-3">
  <div class="form-group">
	...
	<select class="js_select2 form-control" name="coordinatorname[]" id="coordinatorname" multiple="multiple">
	<?php
	if((isset($new_array))&&(is_array($new_array)))
	{
...
<div class="col-lg-3">
  <div class="form-group">
	...
	<select class="js_select2 form-control" name="engineername[]" id="engineername" multiple="multiple">
	<?php
	if((isset($new_array))&&(is_array($new_array)))
	{
	...
	sort($uniqueengineername);
			foreach($uniqueengineername as $urep) 
			{
				...
				?>
				<option value="<?=$urep?>" <?=((isset($_POST['engineername']))&&(in_array($urep, $_POST['engineername'])))?'selected':''?>><?=$urep?></option>
				<?php
			}
	}
	?>
...
<div class="col-lg-3">
  <div class="form-group">
	...
	<select class="js_select2 form-control" name="reportedproblem[]" id="reportedproblem" multiple="multiple">
	<?php
	if((isset($new_array))&&(is_array($new_array)))
	{
	...
	sort($uniquereportedproblem);
			foreach($uniquereportedproblem as $urep) 
			{
				...
				?>
				<option value="<?=$urep?>" <?=((isset($_POST['reportedproblem']))&&(in_array($urep, $_POST['reportedproblem'])))?'selected':''?>><?=$urep?></option>
				<?php
			}
	}
	?>
...
<div class="col-lg-3">
  <div class="form-group">
    ...
    <select class="js_select2 form-control" name="problemobserved[]" id="problemobserved" multiple="multiple">
	<?php
	if((isset($new_array))&&(is_array($new_array)))
	{
	...
	sort($uniquereportedproblem);
			...
			{
				?>
				<option value="<?=$urep?>" <?=((isset($_POST['problemobserved']))&&(in_array($urep, $_POST['problemobserved'])))?'selected':''?>><?=$urep?></option>
				<?php
			}
	}
	?>
...
<div class="col-lg-3">
  <div class="form-group">
    ...
    <select class="js_select2 form-control" name="actiontaken[]" id="actiontaken" multiple="multiple">
	<?php
	if((isset($new_array))&&(is_array($new_array)))
	{
	...
	sort($uniquereportedproblem);
			...
			{
				?>
				<option value="<?=$urep?>" <?=((isset($_POST['actiontaken']))&&(in_array($urep, $_POST['actiontaken'])))?'selected':''?>><?=$urep?></option>
				<?php
			}
	}
	?>
...
<div class="col-lg-3">
  <div class="form-group">
	...
	<select class="js_select2 form-control" name="maincategory[]" id="maincategory" multiple="multiple">
	<?php
...
<div class="col-lg-3">
  <div class="form-group">
	...
	<select class="js_select2 form-control" name="subcategory[]" id="subcategory" multiple="multiple">
	<?php
	if((isset($newexcel_array))&&(is_array($newexcel_array)))
	{
...
<div class="col-lg-3">
  <div class="form-group">
	...
	<select class="js_select2 form-control" name="consigneename[]" id="consigneename" multiple="multiple">
	<?php
	if((isset($newexcel_array))&&(is_array($newexcel_array)))
	{
...
<div class="col-lg-3">
  <div class="form-group">
	...
	<select class="js_select2 form-control" name="department[]" id="department" multiple="multiple">
	<?php
	if((isset($newexcel_array))&&(is_array($newexcel_array)))
	{
...
<div class="col-lg-3">
  <div class="form-group">
	...
	<select class="js_select2 form-control" name="address1[]" id="address1" multiple="multiple">
	<?php
	if((isset($newexcel_array))&&(is_array($newexcel_array)))
	{
...
<div class="col-lg-3">
  <div class="form-group">
	...
	<select class="js_select2 form-control" name="area[]" id="area" multiple="multiple">
	<?php
	if((isset($newexcel_array))&&(is_array($newexcel_array)))
	{
...
<div class="col-lg-3">
  <div class="form-group">
	...
	<select class="js_select2 form-control" name="district[]" id="district" multiple="multiple">
	<?php
	if((isset($newexcel_array))&&(is_array($newexcel_array)))
	{
...
<div class="col-lg-3">
  <div class="form-group">
	...
	<select class="js_select2 form-control" name="pincode[]" id="pincode" multiple="multiple">
	<?php
	if((isset($newexcel_array))&&(is_array($newexcel_array)))
	{
...
<div class="col-lg-3">
  <div class="form-group">
	...
	<select class="js_select2 form-control" name="stockmaincategory[]" id="stockmaincategory" multiple="multiple">
	<?php
	if((isset($newexcel_array))&&(is_array($newexcel_array)))
	{
...
<div class="col-lg-3">
  <div class="form-group">
	...
	<select class="js_select2 form-control" name="stocksubcategory[]" id="stocksubcategory" multiple="multiple">
	<?php
	if((isset($newexcel_array))&&(is_array($newexcel_array)))
	{
...
<div class="col-lg-3">
  <div class="form-group">
	...
	<select class="js_select2 form-control" name="stockitem[]" id="stockitem" multiple="multiple">
	<?php
	if((isset($newexcel_array))&&(is_array($newexcel_array)))
	{
...
<div class="col-lg-3">
  <div class="form-group">
	...
	<select class="js_select2 form-control" name="typeofproduct[]" id="typeofproduct" multiple="multiple">
	<?php
	if((isset($newexcel_array))&&(is_array($newexcel_array)))
	{
...
<div class="col-lg-3">
  <div class="form-group">
	...
	<input type="text" class="form-control" id="serialnumber" name="serialnumber" value="<?=(isset($_POST['serialnumber']))?$_POST['serialnumber']:''?>" >
  </div>
</div>
...
<div class="tab-pane fade" id="analytics" role="tabpanel" aria-labelledby="analytics-tab">
 ...
 $sqlselect = "SELECT count(jc.id) as count, jc.actiontaken From jrccalls jc, jrcxl jx ".$coustaqu." group by jc.actiontaken order by count desc";
		...
		?>	
						 ...
						 <div class="tab-pane fade show active" id="report" role="tabpanel" aria-labelledby="report-tab"><br>	
