...
<head>
  ...
  <title><?=$_SESSION['companyname']?> - Jerobyte - Add New Customer Support Executive</title>
...
<div class="d-sm-flex align-items-center justify-content-between mb-1">
            <h1 class="h4 mb-2 mt-2 text-gray-800">Add New Customer Support Executive</h1>
...
?>
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Add New Customer Support Executive</h6>
            </div>
<div class="card-body">
<form action="callhandlingadds.php" onsubmit="return checkvalidate()" method="post" enctype="multipart/form-data">
<div class="row">
<div class="col-lg-6">
  <div class="form-group">
    <label for="callhandlingname">Customer Support Executive Name</label>
    <input type="text" class="form-control" id="callhandlingname" name="callhandlingname" placeholder="Customer Support Executive Name" required>
  </div>
</div>
<div class="col-lg-6">
    <div class="form-group">
