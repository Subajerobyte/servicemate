...
if(isset($_POST['submit']))
{
  ...
  $msg_class = "";
        ...
        $sqlcon = "SELECT id From jrcquotsettings";
		...
		{	
			...
			$sqlup = "update jrcquotsettings set subject='$subject', contentmessage='$contentmessage', terms='$terms'";
			...
			{
				mysqli_query($connection, "INSERT INTO jrchistory (user, ipaddress, times, remarks, tid, tablename) VALUES ('{$useremail}', '{$ip}', '{$times}', 'Updated Quotation Settings', '{$id}', 'jrcquotsettings')");
				header("Location: quotationsettings.php?remarks=Updated Successfully");
			} 
	    }
		else
			{
				
				$sqlup = "INSERT INTO jrcquotsettings(subject, contentmessage, terms) VALUES ('$subject', '$contentmessage', '$terms')";
			$queryup = mysqli_query($connection, $sqlup);
			...
			else
			{
				...
				mysqli_query($connection, "INSERT INTO jrchistory (user, ipaddress, times, remarks, tid) VALUES ('{$useremail}', '{$ip}', '{$times}', 'Insert Quotation Settings', '{$tid}')");
				header("Location: quotationsettings.php?remarks=Added Successfully");
			} 
...
<head>
  ...
  <title><?=$_SESSION['companyname']?> - Jerobyte - Quotation Settings</title>
...
<!--<div class="d-sm-flex align-items-center justify-content-between mb-1">
            <h1 class="h4 mb-2 mt-2 text-gray-800">Quotation Settings</h1>
		  ...
		  <div class="row">
  <div class="col">
    <h1 class="h4 mb-2 mt-2 text-black-800 text-center" ><b>Quotation Settings</b></h1>
  </div>
<div class="col-auto" style=" text-align: right;">
    <a href="quotationtype.php" class="m-2 d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-plus fa-sm text-white-50"></i> View All Quotation Type Details</a>
</div>
</div>
		  <?php 
...
<div class="card-body">
<?php 
				  $sqlselect = "SELECT subject,contentmessage,terms From jrcquotsettings";
