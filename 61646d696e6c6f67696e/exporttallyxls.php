...
$query = "SELECT * FROM jrctallys where dname='$id' ORDER BY id ASC";  
...
$query = "update jrctallys set exp='1' where dname='$id'";  
$result = mysqli_query($connection,$query) or die(mysqli_error($connection));
header('location:exporttallys.php?remarks=Exported Successfully');
}
?>