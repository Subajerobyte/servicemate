            ...
            <div class="card-body">
              <div class="media d-flex">
                <div class="align-self-top">
                  <i class="fas fa-phone primary fa-2x float-left"></i>
                </div>
                <div class="media-body text-right">
				<span>Received Calls</span>
                  <?php
											if(isset($_POST['submit']))
											{
												?><h3><?=$totalcalls?></h3>
        ...
        <div class="card cardnew shadow">
          <div class="card-content">
            <div class="card-body">
              <div class="media d-flex">
                <div class="align-self-top">
                  <i class="fas fa-envelope-open warning fa-2x float-left"></i>
                </div>
                <div class="media-body text-right">
        ...
        <div class="card cardnew shadow">
          <div class="card-content">
            <div class="card-body">
              <div class="media d-flex">
                <div class="align-self-top">
                  <i class="fas fa-redo fa-2x float-left" style="color:<?=$jerobytecolors[$ad];$ad++;?>"></i>
                </div>
                <div class="media-body text-right">
				<span>AMC Customers</span>
                  <h3><?=count($a)?></h3>
        ...
        <div class="card cardnew shadow">
          <div class="card-content">
            <div class="card-body">
              <div class="media d-flex">
                <div class="align-self-top">
                  <i class="fas fa-car-battery fa-2x float-left" style="color:<?=$jerobytecolors[$ad];$ad++;?>"></i>
                </div>
                <div class="media-body text-right">
				<span>Warranty Customers</span>
                  <h3><?=count($a)?></h3>
        ...
        <div class="card cardnew shadow">
          <div class="card-content">
            <div class="card-body">
              <div class="media d-flex">
                <div class="align-self-top">
                  <i class="fas fa-history fa-2x float-left" style="color:<?=$jerobytecolors[$ad];$ad++;?>"></i>
                </div>
                <div class="media-body text-right">
				<span>AMC <br>Maintanence</span>
        ...
        <div class="card cardnew shadow">
          <div class="card-content">
            <div class="card-body">
              <div class="media d-flex">
                <div class="align-self-top">
                  <i class="fas fa-handshake fa-2x float-left" style="color:<?=$jerobytecolors[$ad];$ad++;?>"></i>
                </div>
                <div class="media-body text-right">
				<span>Warranty <br>Maintanence</span>
                  <h3><?=$preventive?></h3>                  
                </div>
              </div>
            </div>
        ...
        <div class="card cardnew shadow">
          <div class="card-content">
            <div class="card-body">
              <div class="media d-flex">
                <div class="align-self-top">
                  <i class="fas fa-pause-circle fa-2x float-left" style="color:<?=$jerobytecolors[$ad];$ad++;?>"></i>
                </div>
                <div class="media-body text-right">
				<span>Waiting <br>for Approval</span>
                  <h3><?=$wcount?></h3>                  
                </div>
              </div>
            </div>
        ...
        <div class="card cardnew shadow">
          <div class="card-content">
            <div class="card-body">
              <div class="media d-flex">
                <div class="align-self-top">
                  <i class="fas fa-hourglass-end fa-2x float-left" style="color:<?=$jerobytecolors[$ad];$ad++;?>"></i>
                </div>
                <div class="media-body text-right">
				<span>AMC <br>Expiry</span>
                  <h3><?=$amcexpire?></h3>                  
                </div>
              </div>
            </div>
        ...
        <div class="card cardnew shadow">
          <div class="card-content">
            <div class="card-body">
              <div class="media d-flex">
                <div class="align-self-top">
                  <i class="fas fa-battery-empty  fa-2x float-left" style="color:<?=$jerobytecolors[$ad];$ad++;?>"></i>
                </div>
                <div class="media-body text-right">
				<span>Warranty <br>Expiry</span>
        ...
        <div class="card cardnew shadow">
          <div class="card-content">
            <div class="card-body">
              <div class="media d-flex">
                <div class="align-self-top">
                  <i class="fas fa-clock  fa-2x float-left" style="color:<?=$jerobytecolors[$ad];$ad++;?>"></i>
                </div>
                <div class="media-body text-right">
				<span>Observation <br>Calls</span>
                  <h3><?=$ocount?></h3>                  
                </div>
              </div>
            </div>
