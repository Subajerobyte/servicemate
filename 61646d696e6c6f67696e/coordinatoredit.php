...
<head>
  ...
  <title><?=$_SESSION['companyname']?> - Jerobyte - Edit Call Co-ordinator Details</title>
...
<div class="d-sm-flex align-items-center justify-content-between mb-1">
            <h1 class="h4 mb-2 mt-2 text-gray-800">Edit Call Co-ordinator Details</h1>
...
?>
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Edit Call Co-ordinator Details</h6>
            </div>
<div class="card-body">
<?php
if(isset($_GET['id']))
...
$id=mysqli_real_escape_string($connection,$_GET['id']);
				  $sqlselect = "SELECT * From jrccoordinator where id='".$id."' order by username asc";
        ...
        if($rowCountselect > 0) 
		{
			...
			{
			?>
<form action="coordinatoredits.php" onsubmit="return checkvalidate()" method="post" enctype="multipart/form-data">
<input type="hidden" name="id" id="id" value="<?=$id?>">
<div class="row">
<div class="col-lg-6">
  <div class="form-group">
    <label for="coordinatorname">Call Co-ordinator Name</label>
    <input type="text" class="form-control" id="coordinatorname" name="coordinatorname" placeholder="Call Co-ordinator Name" value="<?=$rowselect['coordinatorname']?>">
  </div>
</div>
<div class="col-lg-6">
    <div class="form-group">
