...
?>
          ...
          <div class="card shadow mb-4">
            <!--div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary"> Add New Followup</h6>
            </div-->
<div class="card-body">
<div class="row" id="myItems">
 ...
 if(isset($_GET['id']))
 {
	$qno=mysqli_real_escape_string($connection,$_GET['id']);
				...
				$sqlcons = "SELECT * From jrcquotation where qno='".$qno."'";
...
<form action="followupadds.php" onsubmit="return checkvalidate()" method="post">
