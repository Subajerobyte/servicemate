...
<body id="page-top" onLoad="checkcarry(); checkdiagnosis(); checkengineer(); checkreport();loadDraft()">
  <div id="wrapper">
...
<div class="d-sm-flex align-items-center justify-content-between mb-1">
            <h1 class="h4 mb-2 mt-2 text-gray-800">Add Complaint(New Customer)</h1>
            <a href="calls.php" class="m-2 d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-list fa-sm text-white-50"></i> View All Complaint Details</a>
          </div>
		  <?php
		  }
...
<div class="card-body">
<form action="callnewadds.php" method="post" name="formData" id="formData" >
...
<?php
					  ...
					  {
					  ?>
<label class="mr-2"><input type="radio" name="customernature" value="None"  <?=($infolayoutcall['customernaturereq']=='1')?'required':''?>> None </label>
<?php
					  }
					  ?>
</div>
...
function saveDraft($formData) {
    $_SESSION['draft_data'] = $formData;
}
function loadDraft() {
    return isset($_SESSION['draft_data']) ? $_SESSION['draft_data'] : [];
}
$(document).ready(function() {
