...
<head>
  ...
  <title><?=$_SESSION['companyname']?> - Service Reports</title>
...
$calltids=explode(",",$_POST['ids']);
foreach($calltids as $calltid)
{
	...
	$_SESSION['calltid']=$calltid;
        ...
        if($rowCountselect > 0) 
		{
			...
			while($rowselect = mysqli_fetch_array($queryselect)) 
			{
				...
				$sqlengselect = "SELECT id, compprefix, compno, engineername, signature From jrcengineer where enabled='0' and id='".$rowselect['engineerid']."' order by id desc";   
	...
	{		
		...
		<?php 
					 ...
					 <?php 
					  ...
					  <tr>
					  <td align="left" width="40%" rowspan="5"><p><strong><?=$rowxl['consigneename']?></strong><br>
					   <?php 
					  ...
					  {
					  ?> 
					  <td width="20%">Make</td><td width="30%"><?=$infocon4['make']?></td>
					  <?php 
					  $pi++;
					  if(($pi%2)==0)
					  {
					  ...
					  {
					  ?> 
					  <td width="20%">Battery Make</td><td width="30%"><?=$infocon4['batterymake']?></td>
					  <?php 
					  $pi++;
					  if(($pi%2)==0)
					  {
					  ...
					  {
					  ?> 
					  <td width="20%">Capacity</td><td width="30%"><?=$infocon4['capacity']?></td>
					  <?php 
					  $pi++;
					  if(($pi%2)==0)
					  {
					  ...
					  {
					  ?> 
					  <td width="20%">Battery AH</td><td width="30%"><?=$infocon4['batteryah']?></td>
					  <?php 
					  $pi++;
					  if(($pi%2)==0)
					  {
					  ...
					  {
					  ?> 
					  <td width="20%">MFG Code</td><td width="30%"><?=$infocon4['mfgcode']?></td>
					  <?php 
					  $pi++;
					  if(($pi%2)==0)
					  {
					  ...
					  {
					  ?> 
					  <td width="20%">No.of Battery</td><td width="30%"><?=$infocon4['noofbattery']?></td>
					  <?php 
					  $pi++;
					  if(($pi%2)==0)
					  {
					  ...
					  {
					  ?> 
					  <td width="20%">Sl.No</td><td width="30%"><?=$rowselect['serial']?></td>
					  <?php 
					  $pi++;
					  if(($pi%2)==0)
					  {
					  ...
					  {
					  ?> 
					  <td width="20%">No.of Set</td><td width="30%"><?=$infocon4['noofset']?></td>
					  <?php 
					  $pi++;
					  if(($pi%2)==0)
					  {
...
?>
					 ...
					 <table border="1" style="border:1px solid #bbbbbb">
					  ...
					  <td align="left" width="25%" class="<?=($infocon4['callstatus']=='Completed')?'font-weight-bold text-primary ':''?>"> <span class="float-left"><i class="far fa-<?=($infocon4['callstatus']=='Completed')?'check-square':'square'?>"></i></span> &nbsp;Completed <?=($infocon4['callstatus']=='Completed')?'on '.(($infocon4['editedon']!="")?date('d/m/Y h:i:s a', strtotime($infocon4['editedon'])):date('d/m/Y h:i:s a', strtotime($infocon4['createdon']))):''?></td>
