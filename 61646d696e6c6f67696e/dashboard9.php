...
<div class="col-lg-<?=(($liveplan=="GOLD")||($liveplan=="DIAMOND"))?'4':'6'?> mb-3">
			<div class="card shadow" role="button" >
				<div class="card-header py-2">
				  <h6 style="color:#6e707e" class="m-0   text-center">Call Reports</h6>
				</div>
          ...
          <div class="card-content">
            <div class="card-body">
              <div class="media d-flex">
                ...
                <div class="media-body text-center">
                  <a href="calls.php?status=0"><span  class="font-weight-bold" style="color:<?=$jerobytecolors[$ad];?>; font-size:1.0rem; line-height:1; text-decoration:underline;">Open<br>Calls</span></a>
				  
				   <h3 class="mb-2"><?=$totalopen?></h3>
				   <span style="font-size:1.1em;">SC : <?=$totalaopen?> | OC : <?=$totaloopen?></span><br>					
					...
					<span style="font-size:0.75em;">( Old - SC : <?=$oldaopen?> | OC : <?=$oldoopen?> )</span><br>
					...
					<span style="font-size:0.75em;">( Today - SC : <?=$itodayaopen?> | OC : <?=$itodayoopen?> )</span><br>
					<span style="font-size:0.75em;">( Old - SC : <?=$ioldaopen?> | OC : <?=$ioldoopen?> )</span><br>
					...
					<span style="font-size:0.75em;">( Today - SC : <?=$otodayaopen?> | OC : <?=$otodayoopen?> )</span><br>
					<span style="font-size:0.75em;">( Old - SC : <?=$ooldaopen?> | OC : <?=$ooldoopen?> )</span><br>
					<?php
												}
												?>
                </div>
          ...
          <div class="card-content">
            <div class="card-body">
              <div class="media d-flex">
                ...
                <div class="media-body text-center">
                  <a href="calls.php?status=1"><span  class="font-weight-bold" style="color:<?=$jerobytecolors[$ad];?>; font-size:1.0rem; line-height:1; text-decoration:underline;">Pending<br>Calls</span></a>
				  <h3 class="mb-2"><?=$totaltodaypending?></h3>
                  <span style="font-size:1.1em;">SC : <?=$totaltodayapending?> | OC : <?=$totaltodayopending?></span> <br> 
                                            
					<span style="font-size:0.75em;">(Today - SC : <?=$todayapending?> | OC : <?=$todayopending?> )</span><br>
					<span style="font-size:0.75em;">(Old - SC : <?=$oldapending?> | OC : <?=$oldopending?> )</span>
					<?php
												if(($liveplan=='GOLD')||($liveplan=='DIAMOND'))
												{
													?>
					...
					<span style="font-size:0.75em;">(Today - SC : <?=$itodayapending?> | OC : <?=$itodayopending?> )</span><br>
					<span style="font-size:0.75em;">(Old - SC : <?=$ioldapending?> | OC : <?=$ioldopending?> )</span>
					
					
					<h6 class="text-primary mt-3 mb-1" style="text-decoration:underline">On-Site</h6> 
					<span style="font-size:1em;">SC : <?=$ototaltodayapending?> | OC : <?=$ototaltodayopending?></span> <br> 
					<span style="font-size:0.75em;">(Today - SC : <?=$otodayapending?> | OC : <?=$otodayopending?> )</span><br>
					<span style="font-size:0.75em;">(Old - SC : <?=$ooldapending?> | OC : <?=$ooldopending?> )</span>
					<?php
												}
												?>
          ...
          <div class="card-content">
            <div class="card-body">
              <div class="media d-flex">
                ...
                <div class="media-body text-center">
                   <a href="calls.php?status=2"><span  class="font-weight-bold" style="color:<?=$jerobytecolors[$ad];?>; font-size:1.0rem; line-height:1; text-decoration:underline;">Completed<br>Calls</span></a>
											...
											{
												?>	
												 <h3 class="mb-2"><?=$totalcomplete?></h3>
                                                <span style="font-size:1.1em;">SC : <?=$totalacomplete?> | OC : <?=$totalocomplete?></span>
                                          	<?php
											}
											else
											{
												?> <h3 class="mb-2"><?=$totaltodaycomplete?></h3>
                                            <span style="font-size:1.1em;">SC : <?=$totaltodayacomplete?> | OC : <?=$totaltodayocomplete?></span><br>
                                            
											<span style="font-size:0.7em;">(Today Rec - SC : <?=$todayacomplete?> | OC : <?=$todayocomplete?> )</span><br>
											<span style="font-size:0.75em;">(Old Rec - SC : <?=$oldacomplete?> | OC : <?=$oldocomplete?> )</span><br>
												<?php
												if(($liveplan=='GOLD')||($liveplan=='DIAMOND'))
												{
													?>
											...
											<span style="font-size:0.7em;">(Today Rec - SC : <?=$itodayacomplete?> | OC : <?=$itodayocomplete?> )</span><br>
											<span style="font-size:0.75em;">(Old Rec - SC : <?=$ioldacomplete?> | OC : <?=$ioldocomplete?> )</span><br>
											
											<h6 class="text-primary mt-3 mb-1" style="text-decoration:underline">On-Site</h6> 
											<span style="font-size:1em;">SC : <?=$ototaltodayacomplete?> | OC : <?=$ototaltodayocomplete?></span><br>
											<span style="font-size:0.7em;">(Today Rec - SC : <?=$otodayacomplete?> | OC : <?=$otodayocomplete?> )</span><br>
											<span style="font-size:0.75em;">(Old Rec - SC : <?=$ooldacomplete?> | OC : <?=$ooldocomplete?> )</span><br>
											<?php
												}
												?>
												<?php
...
<div class="col-lg-<?=(($liveplan=="GOLD")||($liveplan=="DIAMOND"))?'4':'6'?>">
			<div class="card shadow" role="button" >
				<div class="card-header py-2">
				  <h6 style="color:#6e707e" class="m-0   text-center">Call Reports</h6>
				</div>
            ...
            <div class="card-body">
              <div class="media d-flex">
				...
				<a href="callstatus.php?dashfromdate=<?=$dashfromdate?>&dashtodate=<?=$dashtodate?>&submit=submit"><span  class="font-weight-bold" style="color:<?=$jerobytecolors[$ad];?>; font-size:1.0rem; line-height:1; text-decoration:underline;">Opening Status</span></a>
                                               ...
                                               <h3 class="mb-2">Open : <?=$originaloldbalance?> <br> Pending :
              ...
              <div class="media d-flex">
                ...
                <div class="media-body text-center">
                  <a href="callstatus.php?dashfromdate=<?=$dashfromdate?>&dashtodate=<?=$dashtodate?>&submit=submit"><span  class="font-weight-bold" style="color:<?=$jerobytecolors[$ad];?>; font-size:1.0rem; line-height:1; text-decoration:underline;">During Period</span></a>
				   ...
				   <h3 class="mb-2">Received : <?=$sumtodaycalls?><br> Pending : <?=$sumtodaypending?></h3>
          ...
          <div class="card-content">
            <div class="card-body">
              <div class="media d-flex">
                ...
                <div class="media-body text-center">
                  <a href="callstatus.php?dashfromdate=<?=$dashfromdate?>&dashtodate=<?=$dashtodate?>&submit=submit"><span  class="font-weight-bold" style="color:<?=$jerobytecolors[$ad];?>; font-size:1.0rem; line-height:1; text-decoration:underline;">Completed<br>Calls</span></a>
				  <h3 class="mb-2"><?=$sumtodaycompleted?></h3>
          ...
          <div class="card-content">
            <div class="card-body">
              <div class="media d-flex">
				...
				<h3 class="mb-2">Open : <?=$oldbalance?> <br> Pending : <?=$oldpendingbalance?></h3>
				   <br>
...
if(($amcmanagement=="1")||($warrantymanagement=="1"))
{
	...
	<div class="col-lg-2">
			<div class="card shadow" role="button" >
				<div class="card-header py-2">
				  <h6 style="color:#6e707e" class="m-0   text-center">AMC & WTY</h6>
				</div>
				<div class="card-statistic-3 p-3" style="padding-bottom:0px !important">		
				<div class="row">
				<?php
            ...
            <div class="card-body">
              <div class="media d-flex">
				...
				<a href="amccustomers.php"><span class="font-weight-bold" style="color:<?=$jerobytecolors[$ad];?>; font-size:1.0rem; line-height:1; text-decoration:underline;">AMC Customers</span></a>
                  <h3 class="mb-2"><?=count($a)?></h3>
                  <span style="font-size:1em;">Products : <?=$totalamc?></span>
            ...
            <div class="card-body">
              <div class="media d-flex">
				...
				<a href="warrantycustomers.php"><span class="font-weight-bold" style="color:<?=$jerobytecolors[$ad];?>; font-size:0.95rem; line-height:1; text-decoration:underline;">Warranty Customers</span></a>
                  <h3 class="mb-2"><?=count($a)?></h3>
                  <span style="font-size:1em;">Products : <?=$totalwarranty?></span>
...
?>													
		<div class="col-lg-6">
			<div class="card shadow" role="button" >
				<div class="card-header py-2">
				  <h6 style="color:#6e707e" class="m-0   text-center">Business Alerts</h6>
				</div>
				<div class="card-statistic-3 p-3" style="padding-bottom:0px !important">		
				<div class="row">		
...
?> 
					...
					<div class="col-lg-6">
                            <div class="card shadow mb-4">
                                <div class="card-header py-2">
                                    <h6 style="color:#6e707e" class="m-0  ">Monthwise Service Revenue <span
...
<?php
        ...
        <div class="col-lg-4">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-2">
                    <h6 style="color:#6e707e" class="m-0  ">Reminders<a href="reminder.php" class="float-right">Go
                            to Reminder</a></h6>
                </div>
                <div class="card-body">
        ...
        <div class="col-lg-4">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-2">
                    <h6 style="color:#6e707e" class="m-0  ">Updates/Announcements<a href="updates.php" class="float-right">Go to Updates</a></h6>
                </div>
                <div class="card-body">
                    <marquee width="100%" direction="up" height="226px" scrollamount="3" onmouseover="this.stop();"
                        onMouseOut="this.start();">
        ...
        <div class="col-lg-<?=(($liveplan=="GOLD")||($liveplan=="DIAMOND"))?'4':'6'?>">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-2">
                    <h6 style="color:#6e707e" class="m-0   text-center">Engineers Calls</h6>
                </div>
                <div class="card-body">
