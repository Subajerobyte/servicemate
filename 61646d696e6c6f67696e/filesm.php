...
<?php
$y=$_GET['y'];
	  if (isset($_GET['t']) && $_GET['t'] == 'Expense' && $_GET['y'] == $y) 
  {
	    $sqlselect = "SELECT LPAD(MONTH(edate), 2, '0') AS edate FROM jrciexpense WHERE expensedoc!='' ORDER BY edate ASC";
					...
					else
		{
			$rowselect=array();
			   ...
			   $uniqueArray = array_map('unserialize', array_unique(array_map('serialize', $rowselect)));
                ...
                ?>
				<a href="filesy.php?t=Expense&y=<?=$y?>" class="btn btn-primary">Back</a>
				<div class="row">
                <?php
		   ...
		   <a href="filesd.php?t=Expense&y=<?=$y?>&m=<?=$row['edate']?>"><?=$y?>/<?=$row['edate']?></a>
		   </div>
		   <?php
	   }
	   }
...
$y=$_GET['y'];
	  if (isset($_GET['t']) && $_GET['t'] == 'Calls' && $_GET['y'] == $y) 
  {
		$sqlselect1 = "SELECT LPAD(MONTH(callon), 2, '0') AS callon From jrccalls WHERE diagnosisimg!='' or diagnosissignature!='' order by callon asc";
				...
				else
		{
			$rowcalls=array();
			   ...
			   $uniqueArray = array_map('unserialize', array_unique(array_map('serialize', $rowcalls)));
                ...
                $uniqueArray = array_values($uniqueArray);
           ?>
		   <a href="filesy.php?t=Calls&y=<?=$y?>" class="btn btn-primary">Back</a>
				<div class="row">
                <?php
	            foreach($uniqueArray as $row)
	             {
		   ...
		   ?>
		    <div class="col-lg-1 text-center">
		   <img src="img/Folder.jpg" style="width:100px;height:100px;"></img>
		    <a href="filesd.php?t=Calls&y=<?=$y?>&m=<?=$row['callon']?>"><?=$y?>/<?=$row['callon']?></a>
			</div>
		   <?php
...
$y=$_GET['y'];	 
 if (isset($_GET['t']) && $_GET['t'] == 'attendance' && $_GET['y'] == $y) 
  {  	  
	  $sqlselect5 = "SELECT LPAD(MONTH(attdate), 2, '0') AS attdate From jrcengroute WHERE tickets!='' order by attdate asc";
	   ...
	   $uniqueArray = array_map('unserialize', array_unique(array_map('serialize', $roweng)));
                ...
                $uniqueArray = array_values($uniqueArray);
          ?>
		     <a href="filesy.php?t=attendance&y=<?=$y?>" class="btn btn-primary">Back</a>
				<div class="row">
                <?php
	            foreach($uniqueArray as $row)
	             {
		   ...
		   ?>
		    <div class="col-lg-1 text-center">
		    <img src="img/Folder.jpg" style="width:100px;height:100px;"></img>
		    <a href="filesd.php?t=attendance&y=<?=$y?>&m=<?=$row['attdate']?>"><?=$y?>/<?=$row['attdate']?></a>
			</div>
		   <?php
...
$y=$_GET['y'];	 
 if (isset($_GET['t']) && $_GET['t'] == 'complaint' && $_GET['y'] == $y) 
  {
	   $sqlselect8 = "SELECT LPAD(MONTH(addedon), 2, '0') AS addedon From jrccalldetails WHERE imguploads!='' or imgbefuploads!='' order by addedon asc";   
		...
		else
		{
	      ...
	      $uniqueArray = array_map('unserialize', array_unique(array_map('serialize', $rowdetails)));
                ...
                $uniqueArray = array_values($uniqueArray);
              ?>
			    <a href="filesy.php?t=complaint&y=<?=$y?>" class="btn btn-primary">Back</a>
				<div class="row">
                <?php
	            foreach($uniqueArray as $row)
	             {
		   ...
		   <div class="col-lg-1 text-center">
		   <img src="img/Folder.jpg" style="width:100px;height:100px;"></img>
		    <a href="filesd.php?t=complaint&y=<?=$y?>&m=<?=$row['addedon']?>"><?=$y?>/<?=$row['addedon']?></a>
			</div>
		   <?php
