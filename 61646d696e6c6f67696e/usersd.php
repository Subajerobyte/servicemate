...
<head>
    ...
    <title><?=$_SESSION['companyname']?> - Jerobyte - Disabled User Details</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
					 ...
					 <div class="row">
  <div class="col">
    <h1 class="h4 mb-2 mt-2 text-black-800 text-center"><b>Disabled User Details</b></h1>
  </div>
</div>
...
<ul class="nav nav-tabs" id="myTab" role="tablist">
  ...
  <li class="nav-item" role="presentation">
    <button class="nav-link" id="engineer-tab" data-toggle="tab" data-target="#engineer" type="button" role="tab" aria-controls="engineer" aria-selected="true">Engineer</button>
  </li>
  <li class="nav-item" role="presentation">
...
<div class="tab-pane fade show active" id="administrators" role="tabpanel" aria-labelledby="administrators-tab">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary" style="text-align:center">Disabled Administrators</h6>
                        </div>
                        <div class="card-body">
                            <?php 
					if($secsystem=='1')
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered font-13" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        <?php 
          	$count=1;
				  $sqlselect = "SELECT adminusername, designation, username, password, id, enabled  From jrcadminuser where enabled='1'  order by username asc";
...
<div class="tab-pane fade" id="engineer" role="tabpanel" aria-labelledby="engineer-tab">
   <div class="card shadow mb-4">
       <div class="card-header py-3">
             <h6 class="m-0 font-weight-bold text-primary" style="text-align:center">Disabled Service Engineers</h6>
                </div>
                  <div class="card-body">
					<div class="table-responsive">
                                <table class="table table-bordered font-13" id="dataTable1" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
<?php 
    $sqlselect = "SELECT engineername, designation, username, password, id, enabled From jrcengineer where enabled='1' order by username asc";
...
<div class="tab-pane fade" id="sales" role="tabpanel" aria-labelledby="sales-tab">	
						  <div class="card shadow mb-4">
       <div class="card-header py-3">
             <h6 class="m-0 font-weight-bold text-primary" style="text-align:center">Disabled Sales Representatives</h6>
                </div>
                  <div class="card-body">
...
<div class="table-responsive">
                                <table class="table table-bordered font-13" id="dataTable1" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
<?php 
    $sqlselect = "SELECT salesrepname, designation, username, password, id, enabled From jrcsalesrep where enabled='1' order by username asc";
