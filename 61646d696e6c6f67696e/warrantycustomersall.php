...
<head>
  ...
  <title>All Warranty Customers | Jerobyte - All Warranty Customers</title>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
		  ...
		  <div class="row">
  <div class="col">
    <h1 class="h4 mb-2 mt-2 text-gray-800 text-center">All Warranty Customers</h1>
  </div>
</div>
...
<div class="col-lg-3 text-left">
  <div class="form-group">
    <label for="datefrom">Warranty Date From(From)</label>
    <input type="date" class="form-control" id="datefrom" name="datefrom" placeholder="Warranty Date From" value="<?=(isset($_POST['datefrom']))?$_POST['datefrom']:''?>" >
  </div>
</div>
 <?php
}
...
<div class="col-lg-3 text-left">
  <div class="form-group">
    <label for="dateto">Warranty Date From(To)</label>
    <input type="date" class="form-control" id="dateto" name="dateto" placeholder="Warranty Date To" value="<?=(isset($_POST['dateto']))?$_POST['dateto']:''?>">
  </div>
</div>
 <?php
}
...
$staqu="";
                if(($_POST['datefrom'])&&($_POST['dateto']))
				{
					if($staqu!="")
					{
						$staqu.=" and warrantydate BETWEEN '".$_POST['datefrom']."' AND '".$_POST['dateto']."'";
					}
					else
					{
						$staqu.=" where warrantydate BETWEEN '".$_POST['datefrom']."' AND '".$_POST['dateto']."'";
					}
				}
...
<?php
	    ...
	    $sqlselect = "SELECT maincategory, subcategory, department, consigneename, address1, address2, area, district, pincode, contact, phone, mobile, email, installedby, stockmaincategory, stocksubcategory, overallwarranty, typeofproduct, componenttype, componentname, make, capacity, installedon, invoicedate, warranty, qty, consigneeid, id, serialnumber, departments, stockitem, invoiceno From jrcxl ".$staqu." group by invoiceno, invoicedate, stockitem, typeofproduct, componenttype, componentname, serialnumber  order by warrantydate asc";
        $queryselect = mysqli_query($connection, $sqlselect);
        $rowCountselect = mysqli_num_rows($queryselect);
...
else
{
	echo '<span class="text-success"><strong>('.$effectiveDate1.')</strong></span>';
					  ...
					  <br>
					  <?php
				  $sqlamc = "SELECT amcduration, datefrom, dateto, amctype From jrcamc where sourceid='".$rowselect['id']."'";
...
else
{
	...
	<?php
		...
		?>
					  ...
					  <td><?=$rowselect['qty']?></td>
					  <td><a href="serialnumberedit.php?consigneeid=<?=$rowselect['consigneeid']?>&xlid=<?=$rowselect['id']?>">Edit Serials</a><?php
					  ...
					  ?><br><a href="callsadd.php?id=<?=$rowselect['id']?>&t=wm" class="btn btn-danger btn-sm">Take A Warranty Call</a></td>
                    </tr>
					<?php
