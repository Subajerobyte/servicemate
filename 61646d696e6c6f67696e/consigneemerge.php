...
<head>
  ...
  <title><?=$_SESSION['companyname']?> - Jerobyte - Merge Customer Details</title>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
		  ...
		  <div class="row">
  <div class="col">
    <h1 class="h4 mb-2 mt-2 text-black-800 text-center"><b>Merge Customer Details</b></h1>
  </div>
  <div class="col-auto">
	...
	?>
          ...
          <div class="card shadow mb-4">
            <!--<div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Merge Customer Details</h6>
            </div>-->
            <div class="card-body">
...
?>	
 ...
 <div class="card shadow mb-4">
            <div class="card-body">
<form action="consigneemerges.php" method="post" onsubmit="return checkvalidate()">
              <div class="table-responsive">
                <table class="table table-bordered font-13" width="100%" cellspacing="0">
                  ...
                  <tbody>
				  <?php
				  $sqlselect = "SELECT address1, phone, mobile, email, id, maincategory, subcategory, consigneename, department, address2, area, district, pincode, contact From jrcconsignee ".$staqu." order by consigneename asc";
				...
				if(($infocompany1['encsystem']=='1')||($infocompany1['encsystem']=='2'))
{
	...
	{		
		...
		$rowselect['email']=jbsdecrypt($_SESSION['encpass'], $rowselect['email']);
			...
			?>
                    <tr>
                      <td><?=$count?> <input type="checkbox" name="ids[]" value="<?=$rowselect['id']?>"></td>
					  ...
					  <td><a href="consigneeedit.php?id=<?=$rowselect['id']?>">Edit</a></td>
                    </tr>
					<?php
					$count++;
			}
			...
			<td colspan="8">
  <div class="form-group">
    <label for="mobile">New Customer </label>
	...
	if((isset($new_array))&&(is_array($new_array)))
	{
			...
			{
				?>
			<option value="<?=$val['consigneeid']?>" ><?=$val['consigneename']?> | <?=$val['maincategory']?> | <?=$val['subcategory']?> | <?=$val['department']?> | <?=$val['address1']?> | <?=$val['district']?> | <?=$val['pincode']?></option>
				<?php
			}
	}
	?>
