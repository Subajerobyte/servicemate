...
<div class="d-sm-flex align-items-center justify-content-between mb-1">
            <h1 class="h4 mb-2 mt-2 text-gray-800">Add New Customer</h1>
...
<div class="card-body">
<form action="consigneeadds.php" method="post">
<div class="row">
<?php
...
<div class="col-lg-3">
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="latlong" name="latlong" <?=($infolayoutcustomers['latlongreq']=='1')?'required':''?> onKeyup="cleartext()">
  </div>
   </div>
<?php
}
...
<div class="col-lg-3">
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="gstno" name="gstno" <?=($infolayoutcustomers['gstnoreq']=='1')?'required':''?>>
  </div>
   </div>
<?php
}
